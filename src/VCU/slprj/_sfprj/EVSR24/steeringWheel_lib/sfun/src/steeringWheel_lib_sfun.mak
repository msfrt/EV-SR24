...
MODEL     = steeringWheel_lib
TARGET      = sfun
MODULE_SRCS   = c3_steeringWheel_lib.cu half_type.cpp
MODEL_SRC  = steeringWheel_lib_sfun.cu
MODEL_REG = 
MAKEFILE    = steeringWheel_lib_sfun.mak
...
USER_INCLUDES   =  /I "C:\eagle_evsr24\slprj\_sfprj\EVSR24\steeringwheel_lib\sfun\src" /I "C:\eagle_evsr24"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\eagle_EVSR24\slprj\_sfprj\EVSR24\steeringWheel_lib\sfun\src" 
...
OBJLIST_FILE = steeringWheel_lib_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
