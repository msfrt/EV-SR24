 ...
 * $Domain____:SDOM$
 * $User______:INTECKEN$
 * $Date______:02.07.2010$
 * $Class_____:SWHDR$
 * $Name______:ltca2_1793$
 * $Variant___:1.12.0$
 * $Revision__:1$
 * $Type______:H$
 ...
 * $History
 * 
 * 1.12.0; 1     02.07.2010 INTECKEN
 *   TC1793 LTCA2 has double number of LTC (0-63), implemented additional 
 *   register elements
 * 
...
#ifndef _LTCA2_1793_H
#define _LTCA2_1793_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module LTCA2 on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 SRSC3;               // [0xF0002828] : LTCA2 Service Request State Clear Register 3
    volatile uint32 SRSS3;               // [0xF000282C] : LTCA2 Service Request State Set Register 3
    volatile uint32 RESERVED1[2];        // [0xF0002830...0xF0002837] : reserved space
    ...
    LTCA2_LTC_t     LTC[64];             // [0xF0002A00...0xF0002BFF] : LTCA2 Local Timer Cells
    volatile uint32 RESERVED3[240];      // [0xF0002C00...0xF0002FBF] : reserved space
    volatile uint32 SRC15;               // [0xF0002FC0] : LTCA2 Interrupt Service Request Control Register 15
    volatile uint32 SRC14;               // [0xF0002FC4] : LTCA2 Interrupt Service Request Control Register 14
    volatile uint32 SRC13;               // [0xF0002FC8] : LTCA2 Interrupt Service Request Control Register 13
    volatile uint32 SRC12;               // [0xF0002FCC] : LTCA2 Interrupt Service Request Control Register 12
    volatile uint32 SRC11;               // [0xF0002FD0] : LTCA2 Interrupt Service Request Control Register 11
    volatile uint32 SRC10;               // [0xF0002FD4] : LTCA2 Interrupt Service Request Control Register 10
    volatile uint32 SRC09;               // [0xF0002FD8] : LTCA2 Interrupt Service Request Control Register 09
    volatile uint32 SRC08;               // [0xF0002FDC] : LTCA2 Interrupt Service Request Control Register 08
