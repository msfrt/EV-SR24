...
*********************************************************************************/
#ifndef _DEVLIB_MSG_H
#define _DEVLIB_MSG_H
/* --------------extern Declaration of Original Messages--------------------*/


#ifndef __DEVLIB_STPWRSTGENACOND_EXT__
#define __DEVLIB_STPWRSTGENACOND_EXT__
extern uint16 DevLib_stPwrStgEnaCond;
#endif /* __DEVLIB_STPWRSTGENACOND_EXT__ */
