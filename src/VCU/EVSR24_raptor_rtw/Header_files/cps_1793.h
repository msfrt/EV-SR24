 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CPS on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CPU_SBSRC;           // [0xF7E0FFBC] : Central Processing Unit Software Breakpoint Service Request Control Register 0
    volatile uint32 RESERVED0[12];       // [0xF7E0FFC0...0xF7E0FFEF] : reserved space
...
/* CPS_CPU_SBSRC_RES (r) */
#define CPS_CPU_SBSRC_RES_POS                _CPS_UL(8)
#define CPS_CPU_SBSRC_RES_LEN                _CPS_UL(2)

/* CPS_CPU_SBSRC_TOS (rw) */
#define CPS_CPU_SBSRC_TOS_POS                _CPS_UL(10)
#define CPS_CPU_SBSRC_TOS_LEN                _CPS_UL(2)
...
/* CPS_CPU_SRC3_RES (r) */
#define CPS_CPU_SRC3_RES_POS                 _CPS_UL(8)
#define CPS_CPU_SRC3_RES_LEN                 _CPS_UL(2)
...
/* CPS_CPU_SRC2_RES (r) */
#define CPS_CPU_SRC2_RES_POS                 _CPS_UL(8)
#define CPS_CPU_SRC2_RES_LEN                 _CPS_UL(2)
...
/* CPS_CPU_SRC1_RES (r) */
#define CPS_CPU_SRC1_RES_POS                 _CPS_UL(8)
#define CPS_CPU_SRC1_RES_LEN                 _CPS_UL(2)
...
/* CPS_CPU_SRC0_RES (r) */
#define CPS_CPU_SRC0_RES_POS                 _CPS_UL(8)
#define CPS_CPU_SRC0_RES_LEN                 _CPS_UL(2)
