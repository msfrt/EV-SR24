...
#ifndef _GPTA0_1793_H
#define _GPTA0_1793_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module GPTA0 on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 ID;                  // [0xF0001808] : GPTA0 Identification Register
    volatile uint32 FDR;                 // [0xF000180C] : GPTA Fractional Divider Register
    volatile uint32 SRSC0;               // [0xF0001810] : GPTA0 Service Request State Clear Register 0
    volatile uint32 SRSS0;               // [0xF0001814] : GPTA0 Service Request State Set Register 0
    volatile uint32 SRSC1;               // [0xF0001818] : GPTA0 Service Request State Clear Register 1
    volatile uint32 SRSS1;               // [0xF000181C] : GPTA0 Service Request State Set Register 1
    volatile uint32 SRSC2;               // [0xF0001820] : GPTA0 Service Request State Clear Register 2
    volatile uint32 SRSS2;               // [0xF0001824] : GPTA0 Service Request State Set Register 2
    volatile uint32 SRSC3;               // [0xF0001828] : GPTA0 Service Request State Clear Register 3
    volatile uint32 SRSS3;               // [0xF000182C] : GPTA0 Service Request State Set Register 3
    volatile uint32 SRNR;                // [0xF0001830] : GPTA0 Service Request Node Redirection Register
    volatile uint32 RESERVED0[1];        // [0xF0001834...0xF0001837] : reserved space
    volatile uint32 MRACTL;              // [0xF0001838] : GPTA0 Multiplexer Register Array Control Register
    volatile uint32 MRADIN;              // [0xF000183C] : GPTA0 Multiplexer Register Array Data In Register
    volatile uint32 MRADOUT;             // [0xF0001840] : GPTA0 Multiplexer Register Array Data Out Register
    volatile uint32 FPCSTAT;             // [0xF0001844] : GPTA0 Filter and Prescaler Cell Status Register
    volatile uint32 FPCCTR0;             // [0xF0001848] : GPTA0 Filter and Prescaler Cell Control Register 0
    volatile uint32 FPCTIM0;             // [0xF000184C] : GPTA0 Filter and Prescaler Cell Timer Register 0
    volatile uint32 FPCCTR1;             // [0xF0001850] : GPTA0 Filter and Prescaler Cell Control Register 1
    volatile uint32 FPCTIM1;             // [0xF0001854] : GPTA0 Filter and Prescaler Cell Timer Register 1
    volatile uint32 FPCCTR2;             // [0xF0001858] : GPTA0 Filter and Prescaler Cell Control Register 2
    volatile uint32 FPCTIM2;             // [0xF000185C] : GPTA0 Filter and Prescaler Cell Timer Register 2
    volatile uint32 FPCCTR3;             // [0xF0001860] : GPTA0 Filter and Prescaler Cell Control Register 3
    volatile uint32 FPCTIM3;             // [0xF0001864] : GPTA0 Filter and Prescaler Cell Timer Register 3
    volatile uint32 FPCCTR4;             // [0xF0001868] : GPTA0 Filter and Prescaler Cell Control Register 4
    volatile uint32 FPCTIM4;             // [0xF000186C] : GPTA0 Filter and Prescaler Cell Timer Register 4
    volatile uint32 FPCCTR5;             // [0xF0001870] : GPTA0 Filter and Prescaler Cell Control Register 5
    volatile uint32 FPCTIM5;             // [0xF0001874] : GPTA0 Filter and Prescaler Cell Timer Register 5
    volatile uint32 PDLCTR;              // [0xF0001878] : GPTA0 Phase Discrimination Logic Control Register
    volatile uint32 RESERVED1[1];        // [0xF000187C...0xF000187F] : reserved space
    volatile uint32 DCMCTR0;             // [0xF0001880] : GPTA0 Duty Cycle Measurement Control Register 0
    volatile uint32 DCMTIM0;             // [0xF0001884] : GPTA0 Duty Cycle Measurement Timer Register 0
    volatile uint32 DCMCAV0;             // [0xF0001888] : GPTA0 Duty Cycle Measurement Capture Register 0
    volatile uint32 DCMCOV0;             // [0xF000188C] : GPTA0 Duty Cycle Measurement Capture/Compare Register 0
    volatile uint32 DCMCTR1;             // [0xF0001890] : GPTA0 Duty Cycle Measurement Control Register 1
    volatile uint32 DCMTIM1;             // [0xF0001894] : GPTA0 Duty Cycle Measurement Timer Register 1
    volatile uint32 DCMCAV1;             // [0xF0001898] : GPTA0 Duty Cycle Measurement Capture Register 1
    volatile uint32 DCMCOV1;             // [0xF000189C] : GPTA0 Duty Cycle Measurement Capture/Compare Register 1
    volatile uint32 DCMCTR2;             // [0xF00018A0] : GPTA0 Duty Cycle Measurement Control Register 2
    volatile uint32 DCMTIM2;             // [0xF00018A4] : GPTA0 Duty Cycle Measurement Timer Register 2
    volatile uint32 DCMCAV2;             // [0xF00018A8] : GPTA0 Duty Cycle Measurement Capture Register 2
    volatile uint32 DCMCOV2;             // [0xF00018AC] : GPTA0 Duty Cycle Measurement Capture/Compare Register 2
    volatile uint32 DCMCTR3;             // [0xF00018B0] : GPTA0 Duty Cycle Measurement Control Register 3
    volatile uint32 DCMTIM3;             // [0xF00018B4] : GPTA0 Duty Cycle Measurement Timer Register 3
    volatile uint32 DCMCAV3;             // [0xF00018B8] : GPTA0 Duty Cycle Measurement Capture Register 3
    volatile uint32 DCMCOV3;             // [0xF00018BC] : GPTA0 Duty Cycle Measurement Capture/Compare Register 3
    volatile uint32 PLLCTR;              // [0xF00018C0] : GPTA0 Phase Locked Loop Control Register
    volatile uint32 PLLMTI;              // [0xF00018C4] : GPTA0 Phase Locked Loop Microtick Register
    volatile uint32 PLLCNT;              // [0xF00018C8] : GPTA0 Phase Locked Loop Counter Register
    volatile uint32 PLLSTP;              // [0xF00018CC] : GPTA0 Phase Locked Loop Step Register
    volatile uint32 PLLREV;              // [0xF00018D0] : GPTA0 Phase Locked Loop Reload Register
    volatile uint32 PLLDTR;              // [0xF00018D4] : GPTA0 Phase Locked Loop Delta Register
    volatile uint32 CKBCTR;              // [0xF00018D8] : GPTA0 Clock Bus Control Register
    volatile uint32 RESERVED2[1];        // [0xF00018DC...0xF00018DF] : reserved space
    volatile uint32 GTCTR0;              // [0xF00018E0] : GPTA0 Global Timer Control Register 0
    volatile uint32 GTREV0;              // [0xF00018E4] : GPTA0 Global Timer Reload Value Register 0
    volatile uint32 GTTIM0;              // [0xF00018E8] : GPTA0 Global Timer Register 0
    volatile uint32 RESERVED3[1];        // [0xF00018EC...0xF00018EF] : reserved space
    volatile uint32 GTCTR1;              // [0xF00018F0] : GPTA0 Global Timer Control Register 1
    volatile uint32 GTREV1;              // [0xF00018F4] : GPTA0 Global Timer Reload Value Register 1
    volatile uint32 GTTIM1;              // [0xF00018F8] : GPTA0 Global Timer Register 1
    volatile uint32 RESERVED4[1];        // [0xF00018FC...0xF00018FF] : reserved space
    GPTA0_GTC_t     GTC[32];             // [0xF0001900...0xF00019FF] : GPTA0 Global Timer Cell Control Register [Capture Mode]
    GPTA0_LTC_t     LTC[64];             // [0xF0001A00...0xF0001BFF] : Local Timer Cell Control Register [Timer Mode]
    volatile uint32 EDCTR;               // [0xF0001C00] : GPTA Clock Enable/Disable Control Register
    volatile uint32 RESERVED5[191];      // [0xF0001C04...0xF0001EFF] : reserved space
    volatile uint32 MMXCTR00;            // [0xF0001F00] : GPTA-to-MSC Multiplexer Control Register 00
    volatile uint32 MMXCTR01;            // [0xF0001F04] : GPTA-to-MSC Multiplexer Control Register 01
    volatile uint32 MMXCTR10;            // [0xF0001F08] : GPTA-to-MSC Multiplexer Control Register 10
    volatile uint32 MMXCTR11;            // [0xF0001F0C] : GPTA-to-MSC Multiplexer Control Register 11
    volatile uint32 RESERVED6[22];       // [0xF0001F10...0xF0001F67] : reserved space
    volatile uint32 SRC37;               // [0xF0001F68] : GPTA0 Interrupt Service Request Control Register 37
    volatile uint32 SRC36;               // [0xF0001F6C] : GPTA0 Interrupt Service Request Control Register 36
    volatile uint32 SRC35;               // [0xF0001F70] : GPTA0 Interrupt Service Request Control Register 35
    volatile uint32 SRC34;               // [0xF0001F74] : GPTA0 Interrupt Service Request Control Register 34
    volatile uint32 SRC33;               // [0xF0001F78] : GPTA0 Interrupt Service Request Control Register 33
    volatile uint32 SRC32;               // [0xF0001F7C] : GPTA0 Interrupt Service Request Control Register 32
    volatile uint32 SRC31;               // [0xF0001F80] : GPTA0 Interrupt Service Request Control Register 31
    volatile uint32 SRC30;               // [0xF0001F84] : GPTA0 Interrupt Service Request Control Register 30
    volatile uint32 SRC29;               // [0xF0001F88] : GPTA0 Interrupt Service Request Control Register 29
    volatile uint32 SRC28;               // [0xF0001F8C] : GPTA0 Interrupt Service Request Control Register 28
    volatile uint32 SRC27;               // [0xF0001F90] : GPTA0 Interrupt Service Request Control Register 27
    volatile uint32 SRC26;               // [0xF0001F94] : GPTA0 Interrupt Service Request Control Register 26
    volatile uint32 SRC25;               // [0xF0001F98] : GPTA0 Interrupt Service Request Control Register 25
    volatile uint32 SRC24;               // [0xF0001F9C] : GPTA0 Interrupt Service Request Control Register 24
    volatile uint32 SRC23;               // [0xF0001FA0] : GPTA0 Interrupt Service Request Control Register 23
    volatile uint32 SRC22;               // [0xF0001FA4] : GPTA0 Interrupt Service Request Control Register 22
    volatile uint32 SRC21;               // [0xF0001FA8] : GPTA0 Interrupt Service Request Control Register 21
    volatile uint32 SRC20;               // [0xF0001FAC] : GPTA0 Interrupt Service Request Control Register 20
    volatile uint32 SRC19;               // [0xF0001FB0] : GPTA0 Interrupt Service Request Control Register 19
    volatile uint32 SRC18;               // [0xF0001FB4] : GPTA0 Interrupt Service Request Control Register 18
    volatile uint32 SRC17;               // [0xF0001FB8] : GPTA0 Interrupt Service Request Control Register 17
    volatile uint32 SRC16;               // [0xF0001FBC] : GPTA0 Interrupt Service Request Control Register 16
    volatile uint32 SRC15;               // [0xF0001FC0] : GPTA0 Interrupt Service Request Control Register 15
    volatile uint32 SRC14;               // [0xF0001FC4] : GPTA0 Interrupt Service Request Control Register 14
    volatile uint32 SRC13;               // [0xF0001FC8] : GPTA0 Interrupt Service Request Control Register 13
    volatile uint32 SRC12;               // [0xF0001FCC] : GPTA0 Interrupt Service Request Control Register 12
    volatile uint32 SRC11;               // [0xF0001FD0] : GPTA0 Interrupt Service Request Control Register 11
    volatile uint32 SRC10;               // [0xF0001FD4] : GPTA0 Interrupt Service Request Control Register 10
    volatile uint32 SRC09;               // [0xF0001FD8] : GPTA0 Interrupt Service Request Control Register 09
    volatile uint32 SRC08;               // [0xF0001FDC] : GPTA0 Interrupt Service Request Control Register 08
    volatile uint32 SRC07;               // [0xF0001FE0] : GPTA0 Interrupt Service Request Control Register 07
    volatile uint32 SRC06;               // [0xF0001FE4] : GPTA0 Interrupt Service Request Control Register 06
    volatile uint32 SRC05;               // [0xF0001FE8] : GPTA0 Interrupt Service Request Control Register 05
    volatile uint32 SRC04;               // [0xF0001FEC] : GPTA0 Interrupt Service Request Control Register 04
    volatile uint32 SRC03;               // [0xF0001FF0] : GPTA0 Interrupt Service Request Control Register 03
    volatile uint32 SRC02;               // [0xF0001FF4] : GPTA0 Interrupt Service Request Control Register 02
    volatile uint32 SRC01;               // [0xF0001FF8] : GPTA0 Interrupt Service Request Control Register 01
    volatile uint32 SRC00;               // [0xF0001FFC] : GPTA0 Interrupt Service Request Control Register 00
} GPTA0_RegMap_t;
...
/* GPTA0_FDR_FDIS (rw) */
#define GPTA0_FDR_FDIS_POS                   _GPTA0_UL(10)
#define GPTA0_FDR_FDIS_LEN                   _GPTA0_UL(1)
