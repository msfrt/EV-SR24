...
#ifndef _GPTA0_1767_H
#define _GPTA0_1767_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module GPTA0 on TC1767
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED6[191];      // [0xF0001C04...0xF0001EFF] : reserved space
    ...
    volatile uint32 RESERVED7[24];       // [0xF0001F08...0xF0001F67] : reserved space
