 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P11 on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 PDR;                 // [0xF0001740] : Port 11 Pad Driver Mode Register
} P11_RegMap_t;
...
/* P11_PDR_PD0 (rw) */
#define P11_PDR_PD0_POS                      _P11_UL(0)
#define P11_PDR_PD0_LEN                      _P11_UL(3)

/* P11_PDR_PD1 (rw) */
#define P11_PDR_PD1_POS                      _P11_UL(4)
#define P11_PDR_PD1_LEN                      _P11_UL(3)

/* P11_PDR_PD2 (rw) */
#define P11_PDR_PD2_POS                      _P11_UL(8)
#define P11_PDR_PD2_LEN                      _P11_UL(3)

/* P11_PDR_PD3 (rw) */
#define P11_PDR_PD3_POS                      _P11_UL(12)
#define P11_PDR_PD3_LEN                      _P11_UL(3)
