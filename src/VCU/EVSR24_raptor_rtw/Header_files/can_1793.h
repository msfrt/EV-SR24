 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CAN on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    Can_NodeCtrl_t  NODE[4];             // [0xF0004200...0xF00045FF] : Node Control register
    volatile uint32 RESERVED6[640];      // [0xF0004600...0xF0004FFF] : reserved space
    Can_MsgObj_t    MO[128];             // [0xF0005000...0xF0005FFF] : Message object register
    volatile uint32 RESERVED7[2047];     // [0xF0006000...0xF0007FFB] : reserved space
    volatile uint32 STPTR0;              // [0xF0007FFC] : Scheduler Start Pointer Node 0 Register
} CAN_RegMap_t;
...
/* CAN_FDR_FDIS (rw) */
#define CAN_FDR_FDIS_POS                     _CAN_UL(10)
#define CAN_FDR_FDIS_LEN                     _CAN_UL(1)
...
/* CAN_TURR_LTCS (rw) */
#define CAN_TURR_LTCS_POS                    _CAN_UL(17)
#define CAN_TURR_LTCS_LEN                    _CAN_UL(1)

/* CAN_TURR_LTDIV (rw) */
#define CAN_TURR_LTDIV_POS                   _CAN_UL(18)
#define CAN_TURR_LTDIV_LEN                   _CAN_UL(3)
...
/* CAN_TTFMR_ETREVR (w) */
#define CAN_TTFMR_ETREVR_POS                 _CAN_UL(5)
#define CAN_TTFMR_ETREVR_LEN                 _CAN_UL(1)
