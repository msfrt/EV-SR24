 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P5 on TC1782
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* P5_PDR_ERAYA (rw) */
#define P5_PDR_ERAYA_POS                     _P5_UL(8)
#define P5_PDR_ERAYA_LEN                     _P5_UL(3)

/* P5_PDR_ERAYB (rw) */
#define P5_PDR_ERAYB_POS                     _P5_UL(12)
#define P5_PDR_ERAYB_LEN                     _P5_UL(3)
