 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SSC on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CLC;                 // [0xF0310000] : SSC0_Clock Control Register
    volatile uint32 PISEL;               // [0xF0310004] : Port Input Select Register
    volatile uint32 ID;                  // [0xF0310008] : Module Identification Register
    volatile uint32 FDR;                 // [0xF031000C] : SSC0 Fractional Divider Register
    volatile uint32 CON;                 // [0xF0310010] : Control Register
    volatile uint32 BR;                  // [0xF0310014] : Baud Rate Timer Reload Register
    volatile uint32 SSOC;                // [0xF0310018] : Slave Select Output Control Register
    volatile uint32 SSOTC;               // [0xF031001C] : Slave Select Output Timing Control Register
    volatile uint32 TB;                  // [0xF0310020] : Transmit Buffer Register
    volatile uint32 RB;                  // [0xF0310024] : Receive Buffer Register
    volatile uint32 STAT;                // [0xF0310028] : Status Register
    volatile uint32 EFM;                 // [0xF031002C] : Error Flag Modification Register
    volatile uint32 RESERVED0[49];       // [0xF0310030...0xF03100F3] : reserved space
    volatile uint32 TSRC;                // [0xF03100F4] : Transmit Interrupt Service Request Control Register
    volatile uint32 RSRC;                // [0xF03100F8] : Receive Interrupt Service Request Control Register
    volatile uint32 ESRC;                // [0xF03100FC] : Error Interrupt Service Request Control Register
} SSC_RegMap_t;
...
extern SSC_RegMap_t SSC2 __attribute__ ((asection (".bss.label_only")));
extern SSC_RegMap_t SSC3 __attribute__ ((asection (".bss.label_only")));
extern SSC_RegMap_t SSC[4] __attribute__ ((asection (".bss.label_only")));
...
/* SSC2_ID_MOD_NUMBER (r) */
#define SSC2_ID_MOD_NUMBER_POS               _SSC_UL(16)
#define SSC2_ID_MOD_NUMBER_LEN               _SSC_UL(16)

/* SSC2_ID_MOD_REV (r) */
#define SSC2_ID_MOD_REV_POS                  _SSC_UL(0)
#define SSC2_ID_MOD_REV_LEN                  _SSC_UL(8)

/* SSC2_ID_MOD_TYPE (r) */
#define SSC2_ID_MOD_TYPE_POS                 _SSC_UL(8)
#define SSC2_ID_MOD_TYPE_LEN                 _SSC_UL(8)

/* SSC3_ID_MOD_NUMBER (r) */
#define SSC3_ID_MOD_NUMBER_POS               _SSC_UL(16)
#define SSC3_ID_MOD_NUMBER_LEN               _SSC_UL(16)

/* SSC3_ID_MOD_REV (r) */
#define SSC3_ID_MOD_REV_POS                  _SSC_UL(0)
#define SSC3_ID_MOD_REV_LEN                  _SSC_UL(8)

/* SSC3_ID_MOD_TYPE (r) */
#define SSC3_ID_MOD_TYPE_POS                 _SSC_UL(8)
#define SSC3_ID_MOD_TYPE_LEN                 _SSC_UL(8)
...
/* SSC_FDR_FDIS (rw) */
#define SSC_FDR_FDIS_POS                     _SSC_UL(10)
#define SSC_FDR_FDIS_LEN                     _SSC_UL(1)
...
/* SSC_CON_PARTEN (rw) */
#define SSC_CON_PARTEN_POS                   _SSC_UL(16)
#define SSC_CON_PARTEN_LEN                   _SSC_UL(1)

/* SSC_CON_PARREN (rw) */
#define SSC_CON_PARREN_POS                   _SSC_UL(17)
#define SSC_CON_PARREN_LEN                   _SSC_UL(1)

/* SSC_CON_PARTYP (rw) */
#define SSC_CON_PARTYP_POS                   _SSC_UL(18)
#define SSC_CON_PARTYP_LEN                   _SSC_UL(1)

/* SSC_CON_PAREEN (rw) */
#define SSC_CON_PAREEN_POS                   _SSC_UL(19)
#define SSC_CON_PAREEN_LEN                   _SSC_UL(1)
...
/* SSC_SSOTC_SLSO7MOD (rw) */
#define SSC_SSOTC_SLSO7MOD_POS               _SSC_UL(8)
#define SSC_SSOTC_SLSO7MOD_LEN               _SSC_UL(1)

/* SSC_SSOTC_QSMEN (w) */
#define SSC_SSOTC_QSMEN_POS                  _SSC_UL(14)
#define SSC_SSOTC_QSMEN_LEN                  _SSC_UL(1)

/* SSC_SSOTC_EN (rw) */
#define SSC_SSOTC_EN_POS                     _SSC_UL(15)
#define SSC_SSOTC_EN_LEN                     _SSC_UL(1)
...
/* SSC_STAT_PARE (rh) */
#define SSC_STAT_PARE_POS                    _SSC_UL(4)
#define SSC_STAT_PARE_LEN                    _SSC_UL(1)

/* SSC_STAT_PARTVAL (rh) */
#define SSC_STAT_PARTVAL_POS                 _SSC_UL(5)
#define SSC_STAT_PARTVAL_LEN                 _SSC_UL(1)

/* SSC_STAT_PARRVAL (rh) */
#define SSC_STAT_PARRVAL_POS                 _SSC_UL(6)
#define SSC_STAT_PARRVAL_LEN                 _SSC_UL(1)
...
/* SSC_EFM_CLRPARE (w) */
#define SSC_EFM_CLRPARE_POS                  _SSC_UL(0)
#define SSC_EFM_CLRPARE_LEN                  _SSC_UL(1)

/* SSC_EFM_SETPARE (w) */
#define SSC_EFM_SETPARE_POS                  _SSC_UL(4)
#define SSC_EFM_SETPARE_LEN                  _SSC_UL(1)
...
/* SSC0_FDR_FDIS (rw) */
#define SSC0_FDR_FDIS_POS                    _SSC_UL(10)
#define SSC0_FDR_FDIS_LEN                    _SSC_UL(1)
...
/* SSC0_CON_PARTEN (rw) */
#define SSC0_CON_PARTEN_POS                  _SSC_UL(16)
#define SSC0_CON_PARTEN_LEN                  _SSC_UL(1)

/* SSC0_CON_PARREN (rw) */
#define SSC0_CON_PARREN_POS                  _SSC_UL(17)
#define SSC0_CON_PARREN_LEN                  _SSC_UL(1)

/* SSC0_CON_PARTYP (rw) */
#define SSC0_CON_PARTYP_POS                  _SSC_UL(18)
#define SSC0_CON_PARTYP_LEN                  _SSC_UL(1)

/* SSC0_CON_PAREEN (rw) */
#define SSC0_CON_PAREEN_POS                  _SSC_UL(19)
#define SSC0_CON_PAREEN_LEN                  _SSC_UL(1)
...
/* SSC0_SSOTC_QSMEN (w) */
#define SSC0_SSOTC_QSMEN_POS                 _SSC_UL(14)
#define SSC0_SSOTC_QSMEN_LEN                 _SSC_UL(1)

/* SSC0_SSOTC_EN (rw) */
#define SSC0_SSOTC_EN_POS                    _SSC_UL(15)
#define SSC0_SSOTC_EN_LEN                    _SSC_UL(1)
...
/* SSC0_STAT_PARE (rh) */
#define SSC0_STAT_PARE_POS                   _SSC_UL(4)
#define SSC0_STAT_PARE_LEN                   _SSC_UL(1)

/* SSC0_STAT_PARTVAL (rh) */
#define SSC0_STAT_PARTVAL_POS                _SSC_UL(5)
#define SSC0_STAT_PARTVAL_LEN                _SSC_UL(1)

/* SSC0_STAT_PARRVAL (rh) */
#define SSC0_STAT_PARRVAL_POS                _SSC_UL(6)
#define SSC0_STAT_PARRVAL_LEN                _SSC_UL(1)
...
/* SSC0_EFM_CLRPARE (w) */
#define SSC0_EFM_CLRPARE_POS                 _SSC_UL(0)
#define SSC0_EFM_CLRPARE_LEN                 _SSC_UL(1)

/* SSC0_EFM_SETPARE (w) */
#define SSC0_EFM_SETPARE_POS                 _SSC_UL(4)
#define SSC0_EFM_SETPARE_LEN                 _SSC_UL(1)
...
/* SSC1_FDR_FDIS (rw) */
#define SSC1_FDR_FDIS_POS                    _SSC_UL(10)
#define SSC1_FDR_FDIS_LEN                    _SSC_UL(1)
...
/* SSC1_CON_PARTEN (rw) */
#define SSC1_CON_PARTEN_POS                  _SSC_UL(16)
#define SSC1_CON_PARTEN_LEN                  _SSC_UL(1)

/* SSC1_CON_PARREN (rw) */
#define SSC1_CON_PARREN_POS                  _SSC_UL(17)
#define SSC1_CON_PARREN_LEN                  _SSC_UL(1)

/* SSC1_CON_PARTYP (rw) */
#define SSC1_CON_PARTYP_POS                  _SSC_UL(18)
#define SSC1_CON_PARTYP_LEN                  _SSC_UL(1)

/* SSC1_CON_PAREEN (rw) */
#define SSC1_CON_PAREEN_POS                  _SSC_UL(19)
#define SSC1_CON_PAREEN_LEN                  _SSC_UL(1)
...
/* SSC1_SSOTC_QSMEN (w) */
#define SSC1_SSOTC_QSMEN_POS                 _SSC_UL(14)
#define SSC1_SSOTC_QSMEN_LEN                 _SSC_UL(1)

/* SSC1_SSOTC_EN (rw) */
#define SSC1_SSOTC_EN_POS                    _SSC_UL(15)
#define SSC1_SSOTC_EN_LEN                    _SSC_UL(1)
...
/* SSC1_STAT_PARE (rh) */
#define SSC1_STAT_PARE_POS                   _SSC_UL(4)
#define SSC1_STAT_PARE_LEN                   _SSC_UL(1)

/* SSC1_STAT_PARTVAL (rh) */
#define SSC1_STAT_PARTVAL_POS                _SSC_UL(5)
#define SSC1_STAT_PARTVAL_LEN                _SSC_UL(1)

/* SSC1_STAT_PARRVAL (rh) */
#define SSC1_STAT_PARRVAL_POS                _SSC_UL(6)
#define SSC1_STAT_PARRVAL_LEN                _SSC_UL(1)
...
/* SSC1_EFM_CLRPARE (w) */
#define SSC1_EFM_CLRPARE_POS                 _SSC_UL(0)
#define SSC1_EFM_CLRPARE_LEN                 _SSC_UL(1)

/* SSC1_EFM_SETPARE (w) */
#define SSC1_EFM_SETPARE_POS                 _SSC_UL(4)
#define SSC1_EFM_SETPARE_LEN                 _SSC_UL(1)
...
/* SSC2_CLC_DISR (rw) */
#define SSC2_CLC_DISR_POS                    _SSC_UL(0)
#define SSC2_CLC_DISR_LEN                    _SSC_UL(1)

/* SSC2_CLC_DISS (r) */
#define SSC2_CLC_DISS_POS                    _SSC_UL(1)
#define SSC2_CLC_DISS_LEN                    _SSC_UL(1)

/* SSC2_CLC_SPEN (rw) */
#define SSC2_CLC_SPEN_POS                    _SSC_UL(2)
#define SSC2_CLC_SPEN_LEN                    _SSC_UL(1)

/* SSC2_CLC_EDIS (rw) */
#define SSC2_CLC_EDIS_POS                    _SSC_UL(3)
#define SSC2_CLC_EDIS_LEN                    _SSC_UL(1)

/* SSC2_CLC_SBWE (w) */
#define SSC2_CLC_SBWE_POS                    _SSC_UL(4)
#define SSC2_CLC_SBWE_LEN                    _SSC_UL(1)

/* SSC2_CLC_FSOE (rw) */
#define SSC2_CLC_FSOE_POS                    _SSC_UL(5)
#define SSC2_CLC_FSOE_LEN                    _SSC_UL(1)

/* SSC2_PISEL_MRIS (rw) */
#define SSC2_PISEL_MRIS_POS                  _SSC_UL(0)
#define SSC2_PISEL_MRIS_LEN                  _SSC_UL(1)

/* SSC2_PISEL_SRIS (rw) */
#define SSC2_PISEL_SRIS_POS                  _SSC_UL(1)
#define SSC2_PISEL_SRIS_LEN                  _SSC_UL(1)

/* SSC2_PISEL_SCIS (rw) */
#define SSC2_PISEL_SCIS_POS                  _SSC_UL(2)
#define SSC2_PISEL_SCIS_LEN                  _SSC_UL(1)

/* SSC2_PISEL_SLSIS (rw) */
#define SSC2_PISEL_SLSIS_POS                 _SSC_UL(3)
#define SSC2_PISEL_SLSIS_LEN                 _SSC_UL(3)

/* SSC2_PISEL_STIP (rw) */
#define SSC2_PISEL_STIP_POS                  _SSC_UL(8)
#define SSC2_PISEL_STIP_LEN                  _SSC_UL(1)

/* SSC2_ID_MODREV (r) */
#define SSC2_ID_MODREV_POS                   _SSC_UL(0)
#define SSC2_ID_MODREV_LEN                   _SSC_UL(8)

/* SSC2_ID_MODNUM (r) */
#define SSC2_ID_MODNUM_POS                   _SSC_UL(8)
#define SSC2_ID_MODNUM_LEN                   _SSC_UL(8)

/* SSC2_FDR_STEP (rw) */
#define SSC2_FDR_STEP_POS                    _SSC_UL(0)
#define SSC2_FDR_STEP_LEN                    _SSC_UL(10)

/* SSC2_FDR_FDIS (rw) */
#define SSC2_FDR_FDIS_POS                    _SSC_UL(10)
#define SSC2_FDR_FDIS_LEN                    _SSC_UL(1)

/* SSC2_FDR_SM (rw) */
#define SSC2_FDR_SM_POS                      _SSC_UL(11)
#define SSC2_FDR_SM_LEN                      _SSC_UL(1)

/* SSC2_FDR_SC (rw) */
#define SSC2_FDR_SC_POS                      _SSC_UL(12)
#define SSC2_FDR_SC_LEN                      _SSC_UL(2)

/* SSC2_FDR_DM (rw) */
#define SSC2_FDR_DM_POS                      _SSC_UL(14)
#define SSC2_FDR_DM_LEN                      _SSC_UL(2)

/* SSC2_FDR_RESULT (rh) */
#define SSC2_FDR_RESULT_POS                  _SSC_UL(16)
#define SSC2_FDR_RESULT_LEN                  _SSC_UL(10)

/* SSC2_FDR_SUSACK (rh) */
#define SSC2_FDR_SUSACK_POS                  _SSC_UL(28)
#define SSC2_FDR_SUSACK_LEN                  _SSC_UL(1)

/* SSC2_FDR_SUSREQ (rh) */
#define SSC2_FDR_SUSREQ_POS                  _SSC_UL(29)
#define SSC2_FDR_SUSREQ_LEN                  _SSC_UL(1)

/* SSC2_FDR_ENHW (rw) */
#define SSC2_FDR_ENHW_POS                    _SSC_UL(30)
#define SSC2_FDR_ENHW_LEN                    _SSC_UL(1)

/* SSC2_FDR_DISCLK (rwh) */
#define SSC2_FDR_DISCLK_POS                  _SSC_UL(31)
#define SSC2_FDR_DISCLK_LEN                  _SSC_UL(1)

/* SSC2_CON_BM (rw) */
#define SSC2_CON_BM_POS                      _SSC_UL(0)
#define SSC2_CON_BM_LEN                      _SSC_UL(4)

/* SSC2_CON_HB (rw) */
#define SSC2_CON_HB_POS                      _SSC_UL(4)
#define SSC2_CON_HB_LEN                      _SSC_UL(1)

/* SSC2_CON_PH (rw) */
#define SSC2_CON_PH_POS                      _SSC_UL(5)
#define SSC2_CON_PH_LEN                      _SSC_UL(1)

/* SSC2_CON_PO (rw) */
#define SSC2_CON_PO_POS                      _SSC_UL(6)
#define SSC2_CON_PO_LEN                      _SSC_UL(1)

/* SSC2_CON_LB (rw) */
#define SSC2_CON_LB_POS                      _SSC_UL(7)
#define SSC2_CON_LB_LEN                      _SSC_UL(1)

/* SSC2_CON_TEN (rw) */
#define SSC2_CON_TEN_POS                     _SSC_UL(8)
#define SSC2_CON_TEN_LEN                     _SSC_UL(1)

/* SSC2_CON_REN (rw) */
#define SSC2_CON_REN_POS                     _SSC_UL(9)
#define SSC2_CON_REN_LEN                     _SSC_UL(1)

/* SSC2_CON_PEN (rw) */
#define SSC2_CON_PEN_POS                     _SSC_UL(10)
#define SSC2_CON_PEN_LEN                     _SSC_UL(1)

/* SSC2_CON_BEN (rw) */
#define SSC2_CON_BEN_POS                     _SSC_UL(11)
#define SSC2_CON_BEN_LEN                     _SSC_UL(1)

/* SSC2_CON_AREN (rw) */
#define SSC2_CON_AREN_POS                    _SSC_UL(12)
#define SSC2_CON_AREN_LEN                    _SSC_UL(1)

/* SSC2_CON_MS (rw) */
#define SSC2_CON_MS_POS                      _SSC_UL(14)
#define SSC2_CON_MS_LEN                      _SSC_UL(1)

/* SSC2_CON_EN (rw) */
#define SSC2_CON_EN_POS                      _SSC_UL(15)
#define SSC2_CON_EN_LEN                      _SSC_UL(1)

/* SSC2_CON_PARTEN (rw) */
#define SSC2_CON_PARTEN_POS                  _SSC_UL(16)
#define SSC2_CON_PARTEN_LEN                  _SSC_UL(1)

/* SSC2_CON_PARREN (rw) */
#define SSC2_CON_PARREN_POS                  _SSC_UL(17)
#define SSC2_CON_PARREN_LEN                  _SSC_UL(1)

/* SSC2_CON_PARTYP (rw) */
#define SSC2_CON_PARTYP_POS                  _SSC_UL(18)
#define SSC2_CON_PARTYP_LEN                  _SSC_UL(1)

/* SSC2_CON_PAREEN (rw) */
#define SSC2_CON_PAREEN_POS                  _SSC_UL(19)
#define SSC2_CON_PAREEN_LEN                  _SSC_UL(1)

/* SSC2_BR_BR_VALUE (rw) */
#define SSC2_BR_BR_VALUE_POS                 _SSC_UL(0)
#define SSC2_BR_BR_VALUE_LEN                 _SSC_UL(16)

/* SSC2_SSOC_AOL0 (rw) */
#define SSC2_SSOC_AOL0_POS                   _SSC_UL(0)
#define SSC2_SSOC_AOL0_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL1 (rw) */
#define SSC2_SSOC_AOL1_POS                   _SSC_UL(1)
#define SSC2_SSOC_AOL1_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL2 (rw) */
#define SSC2_SSOC_AOL2_POS                   _SSC_UL(2)
#define SSC2_SSOC_AOL2_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL3 (rw) */
#define SSC2_SSOC_AOL3_POS                   _SSC_UL(3)
#define SSC2_SSOC_AOL3_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL4 (rw) */
#define SSC2_SSOC_AOL4_POS                   _SSC_UL(4)
#define SSC2_SSOC_AOL4_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL5 (rw) */
#define SSC2_SSOC_AOL5_POS                   _SSC_UL(5)
#define SSC2_SSOC_AOL5_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL6 (rw) */
#define SSC2_SSOC_AOL6_POS                   _SSC_UL(6)
#define SSC2_SSOC_AOL6_LEN                   _SSC_UL(1)

/* SSC2_SSOC_AOL7 (rw) */
#define SSC2_SSOC_AOL7_POS                   _SSC_UL(7)
#define SSC2_SSOC_AOL7_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN0 (rw) */
#define SSC2_SSOC_OEN0_POS                   _SSC_UL(8)
#define SSC2_SSOC_OEN0_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN1 (rw) */
#define SSC2_SSOC_OEN1_POS                   _SSC_UL(9)
#define SSC2_SSOC_OEN1_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN2 (rw) */
#define SSC2_SSOC_OEN2_POS                   _SSC_UL(10)
#define SSC2_SSOC_OEN2_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN3 (rw) */
#define SSC2_SSOC_OEN3_POS                   _SSC_UL(11)
#define SSC2_SSOC_OEN3_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN4 (rw) */
#define SSC2_SSOC_OEN4_POS                   _SSC_UL(12)
#define SSC2_SSOC_OEN4_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN5 (rw) */
#define SSC2_SSOC_OEN5_POS                   _SSC_UL(13)
#define SSC2_SSOC_OEN5_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN6 (rw) */
#define SSC2_SSOC_OEN6_POS                   _SSC_UL(14)
#define SSC2_SSOC_OEN6_LEN                   _SSC_UL(1)

/* SSC2_SSOC_OEN7 (rw) */
#define SSC2_SSOC_OEN7_POS                   _SSC_UL(15)
#define SSC2_SSOC_OEN7_LEN                   _SSC_UL(1)

/* SSC2_SSOTC_LEAD (rw) */
#define SSC2_SSOTC_LEAD_POS                  _SSC_UL(0)
#define SSC2_SSOTC_LEAD_LEN                  _SSC_UL(2)

/* SSC2_SSOTC_TRAIL (rw) */
#define SSC2_SSOTC_TRAIL_POS                 _SSC_UL(2)
#define SSC2_SSOTC_TRAIL_LEN                 _SSC_UL(2)

/* SSC2_SSOTC_INACT (rw) */
#define SSC2_SSOTC_INACT_POS                 _SSC_UL(4)
#define SSC2_SSOTC_INACT_LEN                 _SSC_UL(2)

/* SSC2_SSOTC_SLSO7MOD (rw) */
#define SSC2_SSOTC_SLSO7MOD_POS              _SSC_UL(8)
#define SSC2_SSOTC_SLSO7MOD_LEN              _SSC_UL(1)

/* SSC2_SSOTC_QSMEN (w) */
#define SSC2_SSOTC_QSMEN_POS                 _SSC_UL(14)
#define SSC2_SSOTC_QSMEN_LEN                 _SSC_UL(1)

/* SSC2_SSOTC_EN (rw) */
#define SSC2_SSOTC_EN_POS                    _SSC_UL(15)
#define SSC2_SSOTC_EN_LEN                    _SSC_UL(1)

/* SSC2_TB_TB_VALUE (rw) */
#define SSC2_TB_TB_VALUE_POS                 _SSC_UL(0)
#define SSC2_TB_TB_VALUE_LEN                 _SSC_UL(16)

/* SSC2_RB_RB_VALUE (rh) */
#define SSC2_RB_RB_VALUE_POS                 _SSC_UL(0)
#define SSC2_RB_RB_VALUE_LEN                 _SSC_UL(16)

/* SSC2_STAT_BC (rh) */
#define SSC2_STAT_BC_POS                     _SSC_UL(0)
#define SSC2_STAT_BC_LEN                     _SSC_UL(4)

/* SSC2_STAT_PARE (rh) */
#define SSC2_STAT_PARE_POS                   _SSC_UL(4)
#define SSC2_STAT_PARE_LEN                   _SSC_UL(1)

/* SSC2_STAT_PARTVAL (rh) */
#define SSC2_STAT_PARTVAL_POS                _SSC_UL(5)
#define SSC2_STAT_PARTVAL_LEN                _SSC_UL(1)

/* SSC2_STAT_PARRVAL (rh) */
#define SSC2_STAT_PARRVAL_POS                _SSC_UL(6)
#define SSC2_STAT_PARRVAL_LEN                _SSC_UL(1)

/* SSC2_STAT_TE (rh) */
#define SSC2_STAT_TE_POS                     _SSC_UL(8)
#define SSC2_STAT_TE_LEN                     _SSC_UL(1)

/* SSC2_STAT_RE (rh) */
#define SSC2_STAT_RE_POS                     _SSC_UL(9)
#define SSC2_STAT_RE_LEN                     _SSC_UL(1)

/* SSC2_STAT_PE (rh) */
#define SSC2_STAT_PE_POS                     _SSC_UL(10)
#define SSC2_STAT_PE_LEN                     _SSC_UL(1)

/* SSC2_STAT_BE (rh) */
#define SSC2_STAT_BE_POS                     _SSC_UL(11)
#define SSC2_STAT_BE_LEN                     _SSC_UL(1)

/* SSC2_STAT_BSY (rh) */
#define SSC2_STAT_BSY_POS                    _SSC_UL(12)
#define SSC2_STAT_BSY_LEN                    _SSC_UL(1)

/* SSC2_EFM_CLRPARE (w) */
#define SSC2_EFM_CLRPARE_POS                 _SSC_UL(0)
#define SSC2_EFM_CLRPARE_LEN                 _SSC_UL(1)

/* SSC2_EFM_SETPARE (w) */
#define SSC2_EFM_SETPARE_POS                 _SSC_UL(4)
#define SSC2_EFM_SETPARE_LEN                 _SSC_UL(1)

/* SSC2_EFM_CLRTE (w) */
#define SSC2_EFM_CLRTE_POS                   _SSC_UL(8)
#define SSC2_EFM_CLRTE_LEN                   _SSC_UL(1)

/* SSC2_EFM_CLRRE (w) */
#define SSC2_EFM_CLRRE_POS                   _SSC_UL(9)
#define SSC2_EFM_CLRRE_LEN                   _SSC_UL(1)

/* SSC2_EFM_CLRPE (w) */
#define SSC2_EFM_CLRPE_POS                   _SSC_UL(10)
#define SSC2_EFM_CLRPE_LEN                   _SSC_UL(1)

/* SSC2_EFM_CLRBE (w) */
#define SSC2_EFM_CLRBE_POS                   _SSC_UL(11)
#define SSC2_EFM_CLRBE_LEN                   _SSC_UL(1)

/* SSC2_EFM_SETTE (w) */
#define SSC2_EFM_SETTE_POS                   _SSC_UL(12)
#define SSC2_EFM_SETTE_LEN                   _SSC_UL(1)

/* SSC2_EFM_SETRE (w) */
#define SSC2_EFM_SETRE_POS                   _SSC_UL(13)
#define SSC2_EFM_SETRE_LEN                   _SSC_UL(1)

/* SSC2_EFM_SETPE (w) */
#define SSC2_EFM_SETPE_POS                   _SSC_UL(14)
#define SSC2_EFM_SETPE_LEN                   _SSC_UL(1)

/* SSC2_EFM_SETBE (w) */
#define SSC2_EFM_SETBE_POS                   _SSC_UL(15)
#define SSC2_EFM_SETBE_LEN                   _SSC_UL(1)

/* SSC2_TSRC_SRPN (rw) */
#define SSC2_TSRC_SRPN_POS                   _SSC_UL(0)
#define SSC2_TSRC_SRPN_LEN                   _SSC_UL(8)

/* SSC2_TSRC_TOS (rw) */
#define SSC2_TSRC_TOS_POS                    _SSC_UL(10)
#define SSC2_TSRC_TOS_LEN                    _SSC_UL(1)

/* SSC2_TSRC_SRE (rw) */
#define SSC2_TSRC_SRE_POS                    _SSC_UL(12)
#define SSC2_TSRC_SRE_LEN                    _SSC_UL(1)

/* SSC2_TSRC_SRR (rh) */
#define SSC2_TSRC_SRR_POS                    _SSC_UL(13)
#define SSC2_TSRC_SRR_LEN                    _SSC_UL(1)

/* SSC2_TSRC_CLRR (w) */
#define SSC2_TSRC_CLRR_POS                   _SSC_UL(14)
#define SSC2_TSRC_CLRR_LEN                   _SSC_UL(1)

/* SSC2_TSRC_SETR (w) */
#define SSC2_TSRC_SETR_POS                   _SSC_UL(15)
#define SSC2_TSRC_SETR_LEN                   _SSC_UL(1)

/* SSC2_RSRC_SRPN (rw) */
#define SSC2_RSRC_SRPN_POS                   _SSC_UL(0)
#define SSC2_RSRC_SRPN_LEN                   _SSC_UL(8)

/* SSC2_RSRC_TOS (rw) */
#define SSC2_RSRC_TOS_POS                    _SSC_UL(10)
#define SSC2_RSRC_TOS_LEN                    _SSC_UL(1)

/* SSC2_RSRC_SRE (rw) */
#define SSC2_RSRC_SRE_POS                    _SSC_UL(12)
#define SSC2_RSRC_SRE_LEN                    _SSC_UL(1)

/* SSC2_RSRC_SRR (rh) */
#define SSC2_RSRC_SRR_POS                    _SSC_UL(13)
#define SSC2_RSRC_SRR_LEN                    _SSC_UL(1)

/* SSC2_RSRC_CLRR (w) */
#define SSC2_RSRC_CLRR_POS                   _SSC_UL(14)
#define SSC2_RSRC_CLRR_LEN                   _SSC_UL(1)

/* SSC2_RSRC_SETR (w) */
#define SSC2_RSRC_SETR_POS                   _SSC_UL(15)
#define SSC2_RSRC_SETR_LEN                   _SSC_UL(1)

/* SSC2_ESRC_SRPN (rw) */
#define SSC2_ESRC_SRPN_POS                   _SSC_UL(0)
#define SSC2_ESRC_SRPN_LEN                   _SSC_UL(8)

/* SSC2_ESRC_TOS (rw) */
#define SSC2_ESRC_TOS_POS                    _SSC_UL(10)
#define SSC2_ESRC_TOS_LEN                    _SSC_UL(1)

/* SSC2_ESRC_SRE (rw) */
#define SSC2_ESRC_SRE_POS                    _SSC_UL(12)
#define SSC2_ESRC_SRE_LEN                    _SSC_UL(1)

/* SSC2_ESRC_SRR (rh) */
#define SSC2_ESRC_SRR_POS                    _SSC_UL(13)
#define SSC2_ESRC_SRR_LEN                    _SSC_UL(1)

/* SSC2_ESRC_CLRR (w) */
#define SSC2_ESRC_CLRR_POS                   _SSC_UL(14)
#define SSC2_ESRC_CLRR_LEN                   _SSC_UL(1)

/* SSC2_ESRC_SETR (w) */
#define SSC2_ESRC_SETR_POS                   _SSC_UL(15)
#define SSC2_ESRC_SETR_LEN                   _SSC_UL(1)

/* SSC3_CLC_DISR (rw) */
#define SSC3_CLC_DISR_POS                    _SSC_UL(0)
#define SSC3_CLC_DISR_LEN                    _SSC_UL(1)

/* SSC3_CLC_DISS (r) */
#define SSC3_CLC_DISS_POS                    _SSC_UL(1)
#define SSC3_CLC_DISS_LEN                    _SSC_UL(1)

/* SSC3_CLC_SPEN (rw) */
#define SSC3_CLC_SPEN_POS                    _SSC_UL(2)
#define SSC3_CLC_SPEN_LEN                    _SSC_UL(1)

/* SSC3_CLC_EDIS (rw) */
#define SSC3_CLC_EDIS_POS                    _SSC_UL(3)
#define SSC3_CLC_EDIS_LEN                    _SSC_UL(1)

/* SSC3_CLC_SBWE (w) */
#define SSC3_CLC_SBWE_POS                    _SSC_UL(4)
#define SSC3_CLC_SBWE_LEN                    _SSC_UL(1)

/* SSC3_CLC_FSOE (rw) */
#define SSC3_CLC_FSOE_POS                    _SSC_UL(5)
#define SSC3_CLC_FSOE_LEN                    _SSC_UL(1)

/* SSC3_PISEL_MRIS (rw) */
#define SSC3_PISEL_MRIS_POS                  _SSC_UL(0)
#define SSC3_PISEL_MRIS_LEN                  _SSC_UL(1)

/* SSC3_PISEL_SRIS (rw) */
#define SSC3_PISEL_SRIS_POS                  _SSC_UL(1)
#define SSC3_PISEL_SRIS_LEN                  _SSC_UL(1)

/* SSC3_PISEL_SCIS (rw) */
#define SSC3_PISEL_SCIS_POS                  _SSC_UL(2)
#define SSC3_PISEL_SCIS_LEN                  _SSC_UL(1)

/* SSC3_PISEL_SLSIS (rw) */
#define SSC3_PISEL_SLSIS_POS                 _SSC_UL(3)
#define SSC3_PISEL_SLSIS_LEN                 _SSC_UL(3)

/* SSC3_PISEL_STIP (rw) */
#define SSC3_PISEL_STIP_POS                  _SSC_UL(8)
#define SSC3_PISEL_STIP_LEN                  _SSC_UL(1)

/* SSC3_ID_MODREV (r) */
#define SSC3_ID_MODREV_POS                   _SSC_UL(0)
#define SSC3_ID_MODREV_LEN                   _SSC_UL(8)

/* SSC3_ID_MODNUM (r) */
#define SSC3_ID_MODNUM_POS                   _SSC_UL(8)
#define SSC3_ID_MODNUM_LEN                   _SSC_UL(8)

/* SSC3_FDR_STEP (rw) */
#define SSC3_FDR_STEP_POS                    _SSC_UL(0)
#define SSC3_FDR_STEP_LEN                    _SSC_UL(10)

/* SSC3_FDR_FDIS (rw) */
#define SSC3_FDR_FDIS_POS                    _SSC_UL(10)
#define SSC3_FDR_FDIS_LEN                    _SSC_UL(1)

/* SSC3_FDR_SM (rw) */
#define SSC3_FDR_SM_POS                      _SSC_UL(11)
#define SSC3_FDR_SM_LEN                      _SSC_UL(1)

/* SSC3_FDR_SC (rw) */
#define SSC3_FDR_SC_POS                      _SSC_UL(12)
#define SSC3_FDR_SC_LEN                      _SSC_UL(2)

/* SSC3_FDR_DM (rw) */
#define SSC3_FDR_DM_POS                      _SSC_UL(14)
#define SSC3_FDR_DM_LEN                      _SSC_UL(2)

/* SSC3_FDR_RESULT (rh) */
#define SSC3_FDR_RESULT_POS                  _SSC_UL(16)
#define SSC3_FDR_RESULT_LEN                  _SSC_UL(10)

/* SSC3_FDR_SUSACK (rh) */
#define SSC3_FDR_SUSACK_POS                  _SSC_UL(28)
#define SSC3_FDR_SUSACK_LEN                  _SSC_UL(1)

/* SSC3_FDR_SUSREQ (rh) */
#define SSC3_FDR_SUSREQ_POS                  _SSC_UL(29)
#define SSC3_FDR_SUSREQ_LEN                  _SSC_UL(1)

/* SSC3_FDR_ENHW (rw) */
#define SSC3_FDR_ENHW_POS                    _SSC_UL(30)
#define SSC3_FDR_ENHW_LEN                    _SSC_UL(1)

/* SSC3_FDR_DISCLK (rwh) */
#define SSC3_FDR_DISCLK_POS                  _SSC_UL(31)
#define SSC3_FDR_DISCLK_LEN                  _SSC_UL(1)

/* SSC3_CON_BM (rw) */
#define SSC3_CON_BM_POS                      _SSC_UL(0)
#define SSC3_CON_BM_LEN                      _SSC_UL(4)

/* SSC3_CON_HB (rw) */
#define SSC3_CON_HB_POS                      _SSC_UL(4)
#define SSC3_CON_HB_LEN                      _SSC_UL(1)

/* SSC3_CON_PH (rw) */
#define SSC3_CON_PH_POS                      _SSC_UL(5)
#define SSC3_CON_PH_LEN                      _SSC_UL(1)

/* SSC3_CON_PO (rw) */
#define SSC3_CON_PO_POS                      _SSC_UL(6)
#define SSC3_CON_PO_LEN                      _SSC_UL(1)

/* SSC3_CON_LB (rw) */
#define SSC3_CON_LB_POS                      _SSC_UL(7)
#define SSC3_CON_LB_LEN                      _SSC_UL(1)

/* SSC3_CON_TEN (rw) */
#define SSC3_CON_TEN_POS                     _SSC_UL(8)
#define SSC3_CON_TEN_LEN                     _SSC_UL(1)

/* SSC3_CON_REN (rw) */
#define SSC3_CON_REN_POS                     _SSC_UL(9)
#define SSC3_CON_REN_LEN                     _SSC_UL(1)

/* SSC3_CON_PEN (rw) */
#define SSC3_CON_PEN_POS                     _SSC_UL(10)
#define SSC3_CON_PEN_LEN                     _SSC_UL(1)

/* SSC3_CON_BEN (rw) */
#define SSC3_CON_BEN_POS                     _SSC_UL(11)
#define SSC3_CON_BEN_LEN                     _SSC_UL(1)

/* SSC3_CON_AREN (rw) */
#define SSC3_CON_AREN_POS                    _SSC_UL(12)
#define SSC3_CON_AREN_LEN                    _SSC_UL(1)

/* SSC3_CON_MS (rw) */
#define SSC3_CON_MS_POS                      _SSC_UL(14)
#define SSC3_CON_MS_LEN                      _SSC_UL(1)

/* SSC3_CON_EN (rw) */
#define SSC3_CON_EN_POS                      _SSC_UL(15)
#define SSC3_CON_EN_LEN                      _SSC_UL(1)

/* SSC3_CON_PARTEN (rw) */
#define SSC3_CON_PARTEN_POS                  _SSC_UL(16)
#define SSC3_CON_PARTEN_LEN                  _SSC_UL(1)

/* SSC3_CON_PARREN (rw) */
#define SSC3_CON_PARREN_POS                  _SSC_UL(17)
#define SSC3_CON_PARREN_LEN                  _SSC_UL(1)

/* SSC3_CON_PARTYP (rw) */
#define SSC3_CON_PARTYP_POS                  _SSC_UL(18)
#define SSC3_CON_PARTYP_LEN                  _SSC_UL(1)

/* SSC3_CON_PAREEN (rw) */
#define SSC3_CON_PAREEN_POS                  _SSC_UL(19)
#define SSC3_CON_PAREEN_LEN                  _SSC_UL(1)

/* SSC3_BR_BR_VALUE (rw) */
#define SSC3_BR_BR_VALUE_POS                 _SSC_UL(0)
#define SSC3_BR_BR_VALUE_LEN                 _SSC_UL(16)

/* SSC3_SSOC_AOL0 (rw) */
#define SSC3_SSOC_AOL0_POS                   _SSC_UL(0)
#define SSC3_SSOC_AOL0_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL1 (rw) */
#define SSC3_SSOC_AOL1_POS                   _SSC_UL(1)
#define SSC3_SSOC_AOL1_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL2 (rw) */
#define SSC3_SSOC_AOL2_POS                   _SSC_UL(2)
#define SSC3_SSOC_AOL2_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL3 (rw) */
#define SSC3_SSOC_AOL3_POS                   _SSC_UL(3)
#define SSC3_SSOC_AOL3_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL4 (rw) */
#define SSC3_SSOC_AOL4_POS                   _SSC_UL(4)
#define SSC3_SSOC_AOL4_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL5 (rw) */
#define SSC3_SSOC_AOL5_POS                   _SSC_UL(5)
#define SSC3_SSOC_AOL5_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL6 (rw) */
#define SSC3_SSOC_AOL6_POS                   _SSC_UL(6)
#define SSC3_SSOC_AOL6_LEN                   _SSC_UL(1)

/* SSC3_SSOC_AOL7 (rw) */
#define SSC3_SSOC_AOL7_POS                   _SSC_UL(7)
#define SSC3_SSOC_AOL7_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN0 (rw) */
#define SSC3_SSOC_OEN0_POS                   _SSC_UL(8)
#define SSC3_SSOC_OEN0_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN1 (rw) */
#define SSC3_SSOC_OEN1_POS                   _SSC_UL(9)
#define SSC3_SSOC_OEN1_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN2 (rw) */
#define SSC3_SSOC_OEN2_POS                   _SSC_UL(10)
#define SSC3_SSOC_OEN2_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN3 (rw) */
#define SSC3_SSOC_OEN3_POS                   _SSC_UL(11)
#define SSC3_SSOC_OEN3_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN4 (rw) */
#define SSC3_SSOC_OEN4_POS                   _SSC_UL(12)
#define SSC3_SSOC_OEN4_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN5 (rw) */
#define SSC3_SSOC_OEN5_POS                   _SSC_UL(13)
#define SSC3_SSOC_OEN5_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN6 (rw) */
#define SSC3_SSOC_OEN6_POS                   _SSC_UL(14)
#define SSC3_SSOC_OEN6_LEN                   _SSC_UL(1)

/* SSC3_SSOC_OEN7 (rw) */
#define SSC3_SSOC_OEN7_POS                   _SSC_UL(15)
#define SSC3_SSOC_OEN7_LEN                   _SSC_UL(1)

/* SSC3_SSOTC_LEAD (rw) */
#define SSC3_SSOTC_LEAD_POS                  _SSC_UL(0)
#define SSC3_SSOTC_LEAD_LEN                  _SSC_UL(2)

/* SSC3_SSOTC_TRAIL (rw) */
#define SSC3_SSOTC_TRAIL_POS                 _SSC_UL(2)
#define SSC3_SSOTC_TRAIL_LEN                 _SSC_UL(2)

/* SSC3_SSOTC_INACT (rw) */
#define SSC3_SSOTC_INACT_POS                 _SSC_UL(4)
#define SSC3_SSOTC_INACT_LEN                 _SSC_UL(2)

/* SSC3_SSOTC_SLSO7MOD (rw) */
#define SSC3_SSOTC_SLSO7MOD_POS              _SSC_UL(8)
#define SSC3_SSOTC_SLSO7MOD_LEN              _SSC_UL(1)

/* SSC3_SSOTC_QSMEN (w) */
#define SSC3_SSOTC_QSMEN_POS                 _SSC_UL(14)
#define SSC3_SSOTC_QSMEN_LEN                 _SSC_UL(1)

/* SSC3_SSOTC_EN (rw) */
#define SSC3_SSOTC_EN_POS                    _SSC_UL(15)
#define SSC3_SSOTC_EN_LEN                    _SSC_UL(1)

/* SSC3_TB_TB_VALUE (rw) */
#define SSC3_TB_TB_VALUE_POS                 _SSC_UL(0)
#define SSC3_TB_TB_VALUE_LEN                 _SSC_UL(16)

/* SSC3_RB_RB_VALUE (rh) */
#define SSC3_RB_RB_VALUE_POS                 _SSC_UL(0)
#define SSC3_RB_RB_VALUE_LEN                 _SSC_UL(16)

/* SSC3_STAT_BC (rh) */
#define SSC3_STAT_BC_POS                     _SSC_UL(0)
#define SSC3_STAT_BC_LEN                     _SSC_UL(4)

/* SSC3_STAT_PARE (rh) */
#define SSC3_STAT_PARE_POS                   _SSC_UL(4)
#define SSC3_STAT_PARE_LEN                   _SSC_UL(1)

/* SSC3_STAT_PARTVAL (rh) */
#define SSC3_STAT_PARTVAL_POS                _SSC_UL(5)
#define SSC3_STAT_PARTVAL_LEN                _SSC_UL(1)

/* SSC3_STAT_PARRVAL (rh) */
#define SSC3_STAT_PARRVAL_POS                _SSC_UL(6)
#define SSC3_STAT_PARRVAL_LEN                _SSC_UL(1)

/* SSC3_STAT_TE (rh) */
#define SSC3_STAT_TE_POS                     _SSC_UL(8)
#define SSC3_STAT_TE_LEN                     _SSC_UL(1)

/* SSC3_STAT_RE (rh) */
#define SSC3_STAT_RE_POS                     _SSC_UL(9)
#define SSC3_STAT_RE_LEN                     _SSC_UL(1)

/* SSC3_STAT_PE (rh) */
#define SSC3_STAT_PE_POS                     _SSC_UL(10)
#define SSC3_STAT_PE_LEN                     _SSC_UL(1)

/* SSC3_STAT_BE (rh) */
#define SSC3_STAT_BE_POS                     _SSC_UL(11)
#define SSC3_STAT_BE_LEN                     _SSC_UL(1)

/* SSC3_STAT_BSY (rh) */
#define SSC3_STAT_BSY_POS                    _SSC_UL(12)
#define SSC3_STAT_BSY_LEN                    _SSC_UL(1)

/* SSC3_EFM_CLRPARE (w) */
#define SSC3_EFM_CLRPARE_POS                 _SSC_UL(0)
#define SSC3_EFM_CLRPARE_LEN                 _SSC_UL(1)

/* SSC3_EFM_SETPARE (w) */
#define SSC3_EFM_SETPARE_POS                 _SSC_UL(4)
#define SSC3_EFM_SETPARE_LEN                 _SSC_UL(1)

/* SSC3_EFM_CLRTE (w) */
#define SSC3_EFM_CLRTE_POS                   _SSC_UL(8)
#define SSC3_EFM_CLRTE_LEN                   _SSC_UL(1)

/* SSC3_EFM_CLRRE (w) */
#define SSC3_EFM_CLRRE_POS                   _SSC_UL(9)
#define SSC3_EFM_CLRRE_LEN                   _SSC_UL(1)

/* SSC3_EFM_CLRPE (w) */
#define SSC3_EFM_CLRPE_POS                   _SSC_UL(10)
#define SSC3_EFM_CLRPE_LEN                   _SSC_UL(1)

/* SSC3_EFM_CLRBE (w) */
#define SSC3_EFM_CLRBE_POS                   _SSC_UL(11)
#define SSC3_EFM_CLRBE_LEN                   _SSC_UL(1)

/* SSC3_EFM_SETTE (w) */
#define SSC3_EFM_SETTE_POS                   _SSC_UL(12)
#define SSC3_EFM_SETTE_LEN                   _SSC_UL(1)

/* SSC3_EFM_SETRE (w) */
#define SSC3_EFM_SETRE_POS                   _SSC_UL(13)
#define SSC3_EFM_SETRE_LEN                   _SSC_UL(1)

/* SSC3_EFM_SETPE (w) */
#define SSC3_EFM_SETPE_POS                   _SSC_UL(14)
#define SSC3_EFM_SETPE_LEN                   _SSC_UL(1)

/* SSC3_EFM_SETBE (w) */
#define SSC3_EFM_SETBE_POS                   _SSC_UL(15)
#define SSC3_EFM_SETBE_LEN                   _SSC_UL(1)

/* SSC3_TSRC_SRPN (rw) */
#define SSC3_TSRC_SRPN_POS                   _SSC_UL(0)
#define SSC3_TSRC_SRPN_LEN                   _SSC_UL(8)

/* SSC3_TSRC_TOS (rw) */
#define SSC3_TSRC_TOS_POS                    _SSC_UL(10)
#define SSC3_TSRC_TOS_LEN                    _SSC_UL(1)

/* SSC3_TSRC_SRE (rw) */
#define SSC3_TSRC_SRE_POS                    _SSC_UL(12)
#define SSC3_TSRC_SRE_LEN                    _SSC_UL(1)

/* SSC3_TSRC_SRR (rh) */
#define SSC3_TSRC_SRR_POS                    _SSC_UL(13)
#define SSC3_TSRC_SRR_LEN                    _SSC_UL(1)

/* SSC3_TSRC_CLRR (w) */
#define SSC3_TSRC_CLRR_POS                   _SSC_UL(14)
#define SSC3_TSRC_CLRR_LEN                   _SSC_UL(1)

/* SSC3_TSRC_SETR (w) */
#define SSC3_TSRC_SETR_POS                   _SSC_UL(15)
#define SSC3_TSRC_SETR_LEN                   _SSC_UL(1)

/* SSC3_RSRC_SRPN (rw) */
#define SSC3_RSRC_SRPN_POS                   _SSC_UL(0)
#define SSC3_RSRC_SRPN_LEN                   _SSC_UL(8)

/* SSC3_RSRC_TOS (rw) */
#define SSC3_RSRC_TOS_POS                    _SSC_UL(10)
#define SSC3_RSRC_TOS_LEN                    _SSC_UL(1)

/* SSC3_RSRC_SRE (rw) */
#define SSC3_RSRC_SRE_POS                    _SSC_UL(12)
#define SSC3_RSRC_SRE_LEN                    _SSC_UL(1)

/* SSC3_RSRC_SRR (rh) */
#define SSC3_RSRC_SRR_POS                    _SSC_UL(13)
#define SSC3_RSRC_SRR_LEN                    _SSC_UL(1)

/* SSC3_RSRC_CLRR (w) */
#define SSC3_RSRC_CLRR_POS                   _SSC_UL(14)
#define SSC3_RSRC_CLRR_LEN                   _SSC_UL(1)

/* SSC3_RSRC_SETR (w) */
#define SSC3_RSRC_SETR_POS                   _SSC_UL(15)
#define SSC3_RSRC_SETR_LEN                   _SSC_UL(1)

/* SSC3_ESRC_SRPN (rw) */
#define SSC3_ESRC_SRPN_POS                   _SSC_UL(0)
#define SSC3_ESRC_SRPN_LEN                   _SSC_UL(8)

/* SSC3_ESRC_TOS (rw) */
#define SSC3_ESRC_TOS_POS                    _SSC_UL(10)
#define SSC3_ESRC_TOS_LEN                    _SSC_UL(1)

/* SSC3_ESRC_SRE (rw) */
#define SSC3_ESRC_SRE_POS                    _SSC_UL(12)
#define SSC3_ESRC_SRE_LEN                    _SSC_UL(1)

/* SSC3_ESRC_SRR (rh) */
#define SSC3_ESRC_SRR_POS                    _SSC_UL(13)
#define SSC3_ESRC_SRR_LEN                    _SSC_UL(1)

/* SSC3_ESRC_CLRR (w) */
#define SSC3_ESRC_CLRR_POS                   _SSC_UL(14)
#define SSC3_ESRC_CLRR_LEN                   _SSC_UL(1)

/* SSC3_ESRC_SETR (w) */
#define SSC3_ESRC_SETR_POS                   _SSC_UL(15)
#define SSC3_ESRC_SETR_LEN                   _SSC_UL(1)
