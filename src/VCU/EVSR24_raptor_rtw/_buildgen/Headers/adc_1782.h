 ...
 * 
 * 1.11.0; 1     11.05.2010 RAT1COB
 *   The below declaration removed
 *   #define QBUR0 QINR0 
 *   #define QBUR2 QINR2 
 *   #define QBUR4 QINR4 
 *   
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ADC on TC1782
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED9[111];      // [0xF010122C...0xF01013E7] : reserved space
