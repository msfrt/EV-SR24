...
/********************
   ...
   Generated by Raptor Tue Oct 17 21:06:40 2023
 ********************
   XCP1 Protocol Parameters
   CAN BUS 	: CAN1
   BCID		: 0x100
   BCID TYPE	: Standard
   RXID 		: 0x200
...
extern "C" void XcpApp_CanTransmit( XcpCan_MsgObjId_t msgObjId, uint32_T msgId,
...
extern "C" void XcpApp_CanTransmit_XCP1( XcpCan_MsgObjId_t msgObjId, uint32_T
  msgId, uint8_T numBytes, Xcp_StatePtr8 pBytes );

#else

extern void XcpApp_CanTransmit_XCP1( XcpCan_MsgObjId_t msgObjId, uint32_T msgId,
  uint8_T numBytes, Xcp_StatePtr8 pBytes );
...
#define XCP1_CAN_NUM_CHANNELS          5
#define XCP1_CAN_BROADCAST_MSGID       0x100
#define XCP1_CAN_RX_MSGID              0x200
#define XCP1_CAN_TX_MSGID              0x300
#define XCP1_CAN_DYNDAQ_MSGID          0x300
 ...
 *
 ******************************************************************************/
#define XCP_NUM_STATIC_DAQ             0
#define XCP_NUM_DYN_DAQ                2
#define XCP_NUM_ALL_DAQ                ( XCP_NUM_STATIC_DAQ + XCP_NUM_DYN_DAQ )
#define XCP_NUM_ODT_ENTRIES_DYNDAQ     7
#define XCP_NUM_ODT_DYNDAQ             20                        /* Max ODT per DAQ list */
#define XCP_FIRST_PID_DYNDAQ0          0
#define XCP_DYNDAQ0_START              0
#define XCP_DYNDAQ0_END                139
#define XCP_CAN_DYNDAQ0_NUMBUF         20
#define XCP_CAN_DYNDAQ0_START          6
#define XCP_CAN_DYNDAQ0_END            25
#define XCP_FIRST_PID_DYNDAQ1          20
#define XCP_DYNDAQ1_START              140
#define XCP_DYNDAQ1_END                279
#define XCP_CAN_DYNDAQ1_NUMBUF         20
#define XCP_CAN_DYNDAQ1_START          26
#define XCP_CAN_DYNDAQ1_END            45
#define XCP_CAN_QUEUEALL_NUMBUF        46
#define XCP_ODT_LIST_SIZE              280
 ...
 *
 ******************************************************************************/
#define XCP_DAQ_NVRAM_SIZE             ( 0 + 3 * ( sizeof_Xcp_NvDaqState_t + sizeof_Xcp_DaqDynConfig_t + XCP_NUM_ODT_ENTRIES_DYNDAQ * XCP_NUM_ODT_DYNDAQ * ( sizeof( Xcp_OdtEntryAddr_t ) + sizeof_Xcp_OdtEntryCfg_t ) ) + 3 * 4 )
#define XCP_INVALID_NV_IDX             ( (uint32_T)0xffffffff )
#define XCP_NV_START_IDX               0
#define XCP_NV_REGION_SIZE             ( XCP_NV_START_IDX + sizeof_Xcp_NvSession_t + XCP_DAQ_NVRAM_SIZE )
