 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P7 on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 PDR0;                // [0xF0001340] : Port 7 Pad Driver Mode 0 Register
} P7_RegMap_t;
...
/* P7_PDR0_PD0 (rw) */
#define P7_PDR0_PD0_POS                      _P7_UL(0)
#define P7_PDR0_PD0_LEN                      _P7_UL(3)

/* P7_PDR0_PD1 (rw) */
#define P7_PDR0_PD1_POS                      _P7_UL(4)
#define P7_PDR0_PD1_LEN                      _P7_UL(3)

/* P7_PDR0_PD2 (rw) */
#define P7_PDR0_PD2_POS                      _P7_UL(8)
#define P7_PDR0_PD2_LEN                      _P7_UL(3)

/* P7_PDR0_PD3 (rw) */
#define P7_PDR0_PD3_POS                      _P7_UL(12)
#define P7_PDR0_PD3_LEN                      _P7_UL(3)

/* P7_PDR0_PD4 (rw) */
#define P7_PDR0_PD4_POS                      _P7_UL(16)
#define P7_PDR0_PD4_LEN                      _P7_UL(3)

/* P7_PDR0_PD5 (rw) */
#define P7_PDR0_PD5_POS                      _P7_UL(20)
#define P7_PDR0_PD5_LEN                      _P7_UL(3)

/* P7_PDR0_PD6 (rw) */
#define P7_PDR0_PD6_POS                      _P7_UL(24)
#define P7_PDR0_PD6_LEN                      _P7_UL(3)

/* P7_PDR0_PD7 (rw) */
#define P7_PDR0_PD7_POS                      _P7_UL(28)
#define P7_PDR0_PD7_LEN                      _P7_UL(3)
