 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CPU on TC1782
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* CPU_DIETR_RES (r) */
#define CPU_DIETR_RES_POS                    _CPU_UL(10)
#define CPU_DIETR_RES_LEN                    _CPU_UL(22)
...
/* CPU_MIECON_RES (r) */
#define CPU_MIECON_RES_POS                   _CPU_UL(1)
#define CPU_MIECON_RES_LEN                   _CPU_UL(7)
...
/* CPU_MIECON2_RES (r) */
#define CPU_MIECON2_RES_POS                  _CPU_UL(1)
#define CPU_MIECON2_RES_LEN                  _CPU_UL(7)
