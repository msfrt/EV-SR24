 ...
 * $History
 * 
 * 1.6.0; 1     11.05.2010 RAT1COB
 *   The PETCR register included
 * 
 * 1.6.0; 0     31.07.2008 NESTORADMINSDOM
 *   Initial import from Clearcase.
 *      File name: scu_1767.h
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SCU on TC1767
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED1[4];        // [0xF0000520...0xF000052F] : reserved space
