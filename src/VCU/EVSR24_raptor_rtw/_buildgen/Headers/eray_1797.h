 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ERAY on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* ERAY_TEST2_WRPB (rw) */
#define ERAY_TEST2_WRPB_POS                  _ERAY_UL(14)
#define ERAY_TEST2_WRPB_LEN                  _ERAY_UL(1)

/* ERAY_TEST2_RDPB (rh) */
#define ERAY_TEST2_RDPB_POS                  _ERAY_UL(15)
#define ERAY_TEST2_RDPB_LEN                  _ERAY_UL(1)
...
/* ERAY_EIR_PERR (rh) */
#define ERAY_EIR_PERR_POS                    _ERAY_UL(6)
#define ERAY_EIR_PERR_LEN                    _ERAY_UL(1)
...
/* ERAY_EILS_PERRL (rw) */
#define ERAY_EILS_PERRL_POS                  _ERAY_UL(6)
#define ERAY_EILS_PERRL_LEN                  _ERAY_UL(1)
...
/* ERAY_EIES_PERRE (rwh) */
#define ERAY_EIES_PERRE_POS                  _ERAY_UL(6)
#define ERAY_EIES_PERRE_LEN                  _ERAY_UL(1)
...
/* ERAY_EIER_PERRE (rw) */
#define ERAY_EIER_PERRE_POS                  _ERAY_UL(6)
#define ERAY_EIER_PERRE_LEN                  _ERAY_UL(1)
...
/* ERAY_MHDS_PIBF (rwh) */
#define ERAY_MHDS_PIBF_POS                   _ERAY_UL(0)
#define ERAY_MHDS_PIBF_LEN                   _ERAY_UL(1)

/* ERAY_MHDS_POBF (rwh) */
#define ERAY_MHDS_POBF_POS                   _ERAY_UL(1)
#define ERAY_MHDS_POBF_LEN                   _ERAY_UL(1)

/* ERAY_MHDS_PMR (rwh) */
#define ERAY_MHDS_PMR_POS                    _ERAY_UL(2)
#define ERAY_MHDS_PMR_LEN                    _ERAY_UL(1)

/* ERAY_MHDS_PTBF1 (rwh) */
#define ERAY_MHDS_PTBF1_POS                  _ERAY_UL(3)
#define ERAY_MHDS_PTBF1_LEN                  _ERAY_UL(1)

/* ERAY_MHDS_PTBF2 (rwh) */
#define ERAY_MHDS_PTBF2_POS                  _ERAY_UL(4)
#define ERAY_MHDS_PTBF2_LEN                  _ERAY_UL(1)
...
/* removed RDDS, NDAT, MBSC, MSIC, NDIC, NDIP, TXRQ, WRDS */
