 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module MSC on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 SRC1;                // [0xF00008F8] : Service Request Control Register 1
    volatile uint32 SRC0;                // [0xF00008FC] : Service Request Control Register 0
} MSC_RegMap_t;
...
/* MSC1_FDR_FDIS (rw) */
#define MSC1_FDR_FDIS_POS                    _MSC_UL(10)
#define MSC1_FDR_FDIS_LEN                    _MSC_UL(1)
