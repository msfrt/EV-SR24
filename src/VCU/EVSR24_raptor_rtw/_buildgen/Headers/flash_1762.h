...
#ifndef _FLASH_1762_H
#define _FLASH_1762_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module FLASH on TC1762
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED2[53];       // [0xF000202C...0xF00020FF] : reserved space
...
/* FLASH_CFTEST_FSRAME (w) */
#define FLASH_CFTEST_FSRAME_POS        _FLASH_UL(9)
...
/* FLASH_FCON_SLEEPFSD (rw) */
#define FLASH_FCON_SLEEPFSD_POS        _FLASH_UL(15)
#define FLASH_FCON_SLEEPFSD_LEN        _FLASH_UL(1)
