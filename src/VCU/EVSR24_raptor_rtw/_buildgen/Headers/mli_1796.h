 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module MLI0 on Metis
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 RESERVED0[2];        // [0xF010x000...0xF010x007] : reserved space
    volatile uint32 ID;                  // [0xF010x008] : MLI Module Identification Register
    volatile uint32 FDR;                 // [0xF010x00C] : MLI Fractional Divider Register
    volatile uint32 TCR;                 // [0xF010x010] : Transmitter Control Register
    volatile uint32 TSTATR;              // [0xF010x014] : Transmitter Status Register
    volatile uint32 TP0STATR;            // [0xF010x018] : Transmitter Pipe 0 Status Register
    volatile uint32 TP1STATR;            // [0xF010x01C] : Transmitter Pipe 1 Status Register
    volatile uint32 TP2STATR;            // [0xF010x020] : Transmitter Pipe 2 Status Register
    volatile uint32 TP3STATR;            // [0xF010x024] : Transmitter Pipe 3 Status Register
    volatile uint32 TCMDR;               // [0xF010x028] : Transmitter Command Register
    volatile uint32 TRSTATR;             // [0xF010x02C] : Transmitter Registers Status Register
    volatile uint32 TP0AOFR;             // [0xF010x030] : Trasmitter Pipe 0 Address Offset Register
    volatile uint32 TP1AOFR;             // [0xF010x034] : Trasmitter Pipe 1 Address Offset Register
    volatile uint32 TP2AOFR;             // [0xF010x038] : Trasmitter Pipe 2 Address Offset Register
    volatile uint32 TP3AOFR;             // [0xF010x03C] : Trasmitter Pipe 3 Address Offset Register
    volatile uint32 TP0DATAR;            // [0xF010x040] : Transmitter Pipe 0 Data Register
    volatile uint32 TP1DATAR;            // [0xF010x044] : Transmitter Pipe 1 Data Register
    volatile uint32 TP2DATAR;            // [0xF010x048] : Transmitter Pipe 2 Data Register
    volatile uint32 TP3DATAR;            // [0xF010x04C] : Transmitter Pipe 3 Data Register
    volatile uint32 TDRAR;               // [0xF010x050] : Transmitter Data Read Answer Register
    volatile uint32 TP0BAR;              // [0xF010x054] : Transmitter Pipe 0 Base Address
    volatile uint32 TP1BAR;              // [0xF010x058] : Transmitter Pipe 1 Base Address
    volatile uint32 TP2BAR;              // [0xF010x05C] : Transmitter Pipe 2 Base Address
    volatile uint32 TP3BAR;              // [0xF010x060] : Transmitter Pipe 3 Base Address
    volatile uint32 TCBAR;               // [0xF010x064] : Transmitter Copy Base Address
    volatile uint32 RCR;                 // [0xF010x068] : Receiver Control Register
    volatile uint32 RP0BAR;              // [0xF010x06C] : Receiver Pipe 0 Base Address Register
    volatile uint32 RP1BAR;              // [0xF010x070] : Receiver Pipe 1 Base Address Register
    volatile uint32 RP2BAR;              // [0xF010x074] : Receiver Pipe 2 Base Address Register
    volatile uint32 RP3BAR;              // [0xF010x078] : Receiver Pipe 3 Base Address Register
    volatile uint32 RP0STATR;            // [0xF010x07C] : Receiver Pipe 0 Status Register
    volatile uint32 RP1STATR;            // [0xF010x080] : Receiver Pipe 1 Status Register
    volatile uint32 RP2STATR;            // [0xF010x084] : Receiver Pipe 2 Status Register
    volatile uint32 RP3STATR;            // [0xF010x088] : Receiver Pipe 3 Status Register
    volatile uint32 RADRR;               // [0xF010x08C] : Receiver Address Register
    volatile uint32 RDATAR;              // [0xF010x090] : Receiver Data Register
    volatile uint32 SCR;                 // [0xF010x094] : Set Clear Register
    volatile uint32 TIER;                // [0xF010x098] : Transmitter Interrupt Enable Register
    volatile uint32 TISR;                // [0xF010x09C] : Transmitter Interrupt Status Register
    volatile uint32 TINPR;               // [0xF010x0A0] : Transmitter Interrupt Node Pointer Register
    volatile uint32 RIER;                // [0xF010x0A4] : Receiver Interrupt Enable Register
    volatile uint32 RISR;                // [0xF010x0A8] : Receiver Interrupt Status Register
    volatile uint32 RINPR;               // [0xF010x0AC] : Receiver Interrupt Node Pointer Register
    volatile uint32 GINTR;               // [0xF010x0B0] : MLI Global Interrupt Set Register
    volatile uint32 OICR;                // [0xF010x0B4] : Output Input Control Register
    volatile uint32 AER;                 // [0xF010x0B8] : Access Enable Register
    volatile uint32 ARR;                 // [0xF010x0BC] : Access Range Register
} MLI_RegMap_t;
...
/* MLI0_RINPR_DRAIP (rw) */
#define MLI0_RINPR_DRAIP_POS           _MLI_UL(8)
#define MLI0_RINPR_DRAIP_LEN           _MLI_UL(3)

/* MLI0_RINPR_MPPEIP (rw) */
#define MLI0_RINPR_MPPEIP_POS          _MLI_UL(12)
...
/* MLI0_SCR_CBAV (w) */
#define MLI0_SCR_CBAV_POS              _MLI_UL(21)
...
/* MLI1_AER_AEN0 (rw) */
#define MLI1_AER_AEN0_POS              _MLI_UL(0)
#define MLI1_AER_AEN0_LEN              _MLI_UL(1)

/* MLI1_AER_AEN1 (rw) */
#define MLI1_AER_AEN1_POS              _MLI_UL(1)
#define MLI1_AER_AEN1_LEN              _MLI_UL(1)

/* MLI1_AER_AEN10 (rw) */
#define MLI1_AER_AEN10_POS             _MLI_UL(10)
#define MLI1_AER_AEN10_LEN             _MLI_UL(1)

/* MLI1_AER_AEN11 (rw) */
#define MLI1_AER_AEN11_POS             _MLI_UL(11)
#define MLI1_AER_AEN11_LEN             _MLI_UL(1)

/* MLI1_AER_AEN12 (rw) */
#define MLI1_AER_AEN12_POS             _MLI_UL(12)
#define MLI1_AER_AEN12_LEN             _MLI_UL(1)

/* MLI1_AER_AEN13 (rw) */
#define MLI1_AER_AEN13_POS             _MLI_UL(13)
#define MLI1_AER_AEN13_LEN             _MLI_UL(1)

/* MLI1_AER_AEN14 (rw) */
#define MLI1_AER_AEN14_POS             _MLI_UL(14)
#define MLI1_AER_AEN14_LEN             _MLI_UL(1)

/* MLI1_AER_AEN15 (rw) */
#define MLI1_AER_AEN15_POS             _MLI_UL(15)
#define MLI1_AER_AEN15_LEN             _MLI_UL(1)

/* MLI1_AER_AEN16 (rw) */
#define MLI1_AER_AEN16_POS             _MLI_UL(16)
#define MLI1_AER_AEN16_LEN             _MLI_UL(1)

/* MLI1_AER_AEN17 (rw) */
#define MLI1_AER_AEN17_POS             _MLI_UL(17)
#define MLI1_AER_AEN17_LEN             _MLI_UL(1)

/* MLI1_AER_AEN18 (rw) */
#define MLI1_AER_AEN18_POS             _MLI_UL(18)
#define MLI1_AER_AEN18_LEN             _MLI_UL(1)

/* MLI1_AER_AEN19 (rw) */
#define MLI1_AER_AEN19_POS             _MLI_UL(19)
#define MLI1_AER_AEN19_LEN             _MLI_UL(1)

/* MLI1_AER_AEN2 (rw) */
#define MLI1_AER_AEN2_POS              _MLI_UL(2)
#define MLI1_AER_AEN2_LEN              _MLI_UL(1)

/* MLI1_AER_AEN20 (rw) */
#define MLI1_AER_AEN20_POS             _MLI_UL(20)
#define MLI1_AER_AEN20_LEN             _MLI_UL(1)

/* MLI1_AER_AEN21 (rw) */
#define MLI1_AER_AEN21_POS             _MLI_UL(21)
#define MLI1_AER_AEN21_LEN             _MLI_UL(1)

/* MLI1_AER_AEN22 (rw) */
#define MLI1_AER_AEN22_POS             _MLI_UL(22)
#define MLI1_AER_AEN22_LEN             _MLI_UL(1)

/* MLI1_AER_AEN23 (rw) */
#define MLI1_AER_AEN23_POS             _MLI_UL(23)
#define MLI1_AER_AEN23_LEN             _MLI_UL(1)

/* MLI1_AER_AEN24 (rw) */
#define MLI1_AER_AEN24_POS             _MLI_UL(24)
#define MLI1_AER_AEN24_LEN             _MLI_UL(1)

/* MLI1_AER_AEN25 (rw) */
#define MLI1_AER_AEN25_POS             _MLI_UL(25)
#define MLI1_AER_AEN25_LEN             _MLI_UL(1)

/* MLI1_AER_AEN26 (rw) */
#define MLI1_AER_AEN26_POS             _MLI_UL(26)
#define MLI1_AER_AEN26_LEN             _MLI_UL(1)

/* MLI1_AER_AEN27 (rw) */
#define MLI1_AER_AEN27_POS             _MLI_UL(27)
#define MLI1_AER_AEN27_LEN             _MLI_UL(1)

/* MLI1_AER_AEN28 (rw) */
#define MLI1_AER_AEN28_POS             _MLI_UL(28)
#define MLI1_AER_AEN28_LEN             _MLI_UL(1)

/* MLI1_AER_AEN29 (rw) */
#define MLI1_AER_AEN29_POS             _MLI_UL(29)
#define MLI1_AER_AEN29_LEN             _MLI_UL(1)

/* MLI1_AER_AEN3 (rw) */
#define MLI1_AER_AEN3_POS              _MLI_UL(3)
#define MLI1_AER_AEN3_LEN              _MLI_UL(1)

/* MLI1_AER_AEN30 (rw) */
#define MLI1_AER_AEN30_POS             _MLI_UL(30)
#define MLI1_AER_AEN30_LEN             _MLI_UL(1)

/* MLI1_AER_AEN31 (rw) */
#define MLI1_AER_AEN31_POS             _MLI_UL(31)
#define MLI1_AER_AEN31_LEN             _MLI_UL(1)

/* MLI1_AER_AEN4 (rw) */
#define MLI1_AER_AEN4_POS              _MLI_UL(4)
#define MLI1_AER_AEN4_LEN              _MLI_UL(1)

/* MLI1_AER_AEN5 (rw) */
#define MLI1_AER_AEN5_POS              _MLI_UL(5)
#define MLI1_AER_AEN5_LEN              _MLI_UL(1)

/* MLI1_AER_AEN6 (rw) */
#define MLI1_AER_AEN6_POS              _MLI_UL(6)
#define MLI1_AER_AEN6_LEN              _MLI_UL(1)

/* MLI1_AER_AEN7 (rw) */
#define MLI1_AER_AEN7_POS              _MLI_UL(7)
#define MLI1_AER_AEN7_LEN              _MLI_UL(1)

/* MLI1_AER_AEN8 (rw) */
#define MLI1_AER_AEN8_POS              _MLI_UL(8)
#define MLI1_AER_AEN8_LEN              _MLI_UL(1)

/* MLI1_AER_AEN9 (rw) */
#define MLI1_AER_AEN9_POS              _MLI_UL(9)
#define MLI1_AER_AEN9_LEN              _MLI_UL(1)

/* MLI1_ARR_SIZE0 (rw) */
#define MLI1_ARR_SIZE0_POS             _MLI_UL(5)
#define MLI1_ARR_SIZE0_LEN             _MLI_UL(3)

/* MLI1_ARR_SIZE1 (rw) */
#define MLI1_ARR_SIZE1_POS             _MLI_UL(13)
#define MLI1_ARR_SIZE1_LEN             _MLI_UL(3)

/* MLI1_ARR_SIZE2 (rw) */
#define MLI1_ARR_SIZE2_POS             _MLI_UL(21)
#define MLI1_ARR_SIZE2_LEN             _MLI_UL(3)

/* MLI1_ARR_SIZE3 (rw) */
#define MLI1_ARR_SIZE3_POS             _MLI_UL(29)
#define MLI1_ARR_SIZE3_LEN             _MLI_UL(3)

/* MLI1_ARR_SLICE0 (rw) */
#define MLI1_ARR_SLICE0_POS            _MLI_UL(0)
#define MLI1_ARR_SLICE0_LEN            _MLI_UL(5)

/* MLI1_ARR_SLICE1 (rw) */
#define MLI1_ARR_SLICE1_POS            _MLI_UL(8)
#define MLI1_ARR_SLICE1_LEN            _MLI_UL(5)

/* MLI1_ARR_SLICE2 (rw) */
#define MLI1_ARR_SLICE2_POS            _MLI_UL(16)
#define MLI1_ARR_SLICE2_LEN            _MLI_UL(5)

/* MLI1_ARR_SLICE3 (rw) */
#define MLI1_ARR_SLICE3_POS            _MLI_UL(24)
#define MLI1_ARR_SLICE3_LEN            _MLI_UL(5)
...
/* MLI1_RINPR_DRAIP (rw) */
#define MLI1_RINPR_DRAIP_POS           _MLI_UL(8)
#define MLI1_RINPR_DRAIP_LEN           _MLI_UL(3)

/* MLI1_RINPR_MPPEIP (rw) */
#define MLI1_RINPR_MPPEIP_POS          _MLI_UL(12)
...
/* MLI1_RP0BAR_ADDR (rh) */
#define MLI1_RP0BAR_ADDR_POS           _MLI_UL(4)
#define MLI1_RP0BAR_ADDR_LEN           _MLI_UL(28)
...
/* MLI1_RP1BAR_ADDR (rh) */
#define MLI1_RP1BAR_ADDR_POS           _MLI_UL(4)
#define MLI1_RP1BAR_ADDR_LEN           _MLI_UL(28)
...
/* MLI1_RP2BAR_ADDR (rh) */
#define MLI1_RP2BAR_ADDR_POS           _MLI_UL(4)
#define MLI1_RP2BAR_ADDR_LEN           _MLI_UL(28)
...
/* MLI1_RP3BAR_ADDR (rh) */
#define MLI1_RP3BAR_ADDR_POS           _MLI_UL(4)
#define MLI1_RP3BAR_ADDR_LEN           _MLI_UL(28)
...
/* MLI1_SCR_CBAV (w) */
#define MLI1_SCR_CBAV_POS              _MLI_UL(21)
...
/* MLI1_TCR_RTY (rw) */
#define MLI1_TCR_RTY_POS               _MLI_UL(2)
#define MLI1_TCR_RTY_LEN               _MLI_UL(1)
