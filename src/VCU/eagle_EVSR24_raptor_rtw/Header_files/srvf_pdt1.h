...
#define SrvF_PDT1Init(Xi, Yi, State) ((State)->X = (Xi), (State)->Y = (Yi))
...
/** Parameter structure for PDT1 element                                                          */
typedef struct
{
...
typedef struct
{
    real32 T1_C;        /**< Time delay T1                                                        */
                        /**< Proportional factor Kp = 1                                           */
    real32 Kd_C;        /**< Differential factor Kd = Td/T1                                       */
} SrvF_PDT1Param_t;

/*__ASW_NAMES__*/
#endif

/** State structure for PDT1 element                                                              */
typedef struct
{
...
extern real32 SrvF_PDT1(real32 X, const SrvF_PDT1Param_t *Param, SrvF_PDT1State_t *State,
                       real32 Dt);
