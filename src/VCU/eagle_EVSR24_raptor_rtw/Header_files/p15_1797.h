 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P15 on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 PDR;                 // [0xF0300340] : Port 15 Pad Driver Mode Register
} P15_RegMap_t;
...
/* P15_PDR_PD0 (rw) */
#define P15_PDR_PD0_POS                      _P15_UL(0)
#define P15_PDR_PD0_LEN                      _P15_UL(3)

/* P15_PDR_PD1 (rw) */
#define P15_PDR_PD1_POS                      _P15_UL(4)
#define P15_PDR_PD1_LEN                      _P15_UL(3)

/* P15_PDR_PD2 (rw) */
#define P15_PDR_PD2_POS                      _P15_UL(8)
#define P15_PDR_PD2_LEN                      _P15_UL(3)

/* P15_PDR_PD3 (rw) */
#define P15_PDR_PD3_POS                      _P15_UL(12)
#define P15_PDR_PD3_LEN                      _P15_UL(3)
