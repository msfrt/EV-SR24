 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module FPU on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* FPU_TRAP_CON_RES (r) */
#define FPU_TRAP_CON_RES_POS                 _FPU_UL(2)
#define FPU_TRAP_CON_RES_LEN                 _FPU_UL(6)
...
/* FPU_TRAP_OPC_RES (r) */
#define FPU_TRAP_OPC_RES_POS                 _FPU_UL(9)
#define FPU_TRAP_OPC_RES_LEN                 _FPU_UL(7)

/* FPU_TRAP_OPC_DREG (rh) */
#define FPU_TRAP_OPC_DREG_POS                _FPU_UL(16)
#define FPU_TRAP_OPC_DREG_LEN                _FPU_UL(4)

/* FPU_TRAP_SRC1_SRC1 (rh) */
#define FPU_TRAP_SRC1_SRC1_POS               _FPU_UL(0)
#define FPU_TRAP_SRC1_SRC1_LEN               _FPU_UL(32)

/* FPU_TRAP_SRC2_SRC2 (rh) */
#define FPU_TRAP_SRC2_SRC2_POS               _FPU_UL(0)
#define FPU_TRAP_SRC2_SRC2_LEN               _FPU_UL(32)

/* FPU_TRAP_SRC3_SRC3 (rh) */
#define FPU_TRAP_SRC3_SRC3_POS               _FPU_UL(0)
#define FPU_TRAP_SRC3_SRC3_LEN               _FPU_UL(32)
