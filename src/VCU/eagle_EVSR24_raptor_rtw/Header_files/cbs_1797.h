 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CBS on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* CBS_MCDBBS_BSML1 (rw) */
#define CBS_MCDBBS_BSML1_POS                 _CBS_UL(3)
#define CBS_MCDBBS_BSML1_LEN                 _CBS_UL(1)
...
/* CBS_MCDBBSS_BSSML1 (rh) */
#define CBS_MCDBBSS_BSSML1_POS               _CBS_UL(3)
#define CBS_MCDBBSS_BSSML1_LEN               _CBS_UL(1)
...
/* CBS_MCDBBSS_BSCML1 (rh) */
#define CBS_MCDBBSS_BSCML1_POS               _CBS_UL(11)
#define CBS_MCDBBSS_BSCML1_LEN               _CBS_UL(1)
