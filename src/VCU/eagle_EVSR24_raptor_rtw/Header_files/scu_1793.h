 ...
 * $History
 * 
 * 1.18.0; 0     29.07.2013 NAS4COB
 *   .
 * 
 * 1.15.0; 0     03.06.2011 RAT1COB
 *   TC1793 update
 * 
 * 1.12.0; 1     06.05.2011 RAT1COB
 *   scu_1793.h updated
 * 
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SCU on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 PLLCON2;             // [0xF0000520] : PLL Configuration 2 Register
    volatile uint32 PLLERAYSTAT;         // [0xF0000524] : PLL_ERAY Status Register
    volatile uint32 PLLERAYCON0;         // [0xF0000528] : PLL_ERAY Configuration 0 Register
    volatile uint32 PLLERAYCON1;         // [0xF000052C] : PLL_ERAY Configuration 1 Register
    ...
    volatile uint32 CCUCON2;             // [0xF0000544] : CCU Clock Control Register 2
    volatile uint32 RESERVED1[2];        // [0xF0000548...0xF000054F] : reserved space
    ...
    volatile uint32 RESERVED2[3];        // [0xF0000564...0xF000056F] : reserved space
    ...
    volatile uint32 RESERVED3[2];        // [0xF0000578...0xF000057F] : reserved space
    ...
    volatile uint32 RESERVED4[1];        // [0xF000059C...0xF000059F] : reserved space
    ...
    volatile uint32 RESERVED5[3];        // [0xF00005B4...0xF00005BF] : reserved space
    ...
    volatile uint32 RESERVED6[2];        // [0xF00005C8...0xF00005CF] : reserved space
    volatile uint32 ECCCON;              // [0xF00005D0] : ECC Control Register
    volatile uint32 ECCSTAT;             // [0xF00005D4] : ECC Status Register
    volatile uint32 ECCCLR;              // [0xF00005D8] : ECC Clear Register
    volatile uint32 RESERVED7[1];        // [0xF00005DC...0xF00005DF] : reserved space
    ...
    volatile uint32 RESERVED8[2];        // [0xF00005E8...0xF00005EF] : reserved space
    ...
    volatile uint32 RESERVED9[1];        // [0xF00005FC...0xF00005FF] : reserved space
    volatile uint32 EMSR;                // [0xF0000600] : Emergency Stop Register
    volatile uint32 RESERVED10[3];       // [0xF0000604...0xF000060F] : reserved space
    ...
    volatile uint32 RESERVED11[3];       // [0xF0000634...0xF000063F] : reserved space
    ...
    volatile uint32 RTID;                // [0xF0000648] : Redesign Tracing Identification Register
    volatile uint32 RESERVED12[1];       // [0xF000064C...0xF000064F] : reserved space
    volatile uint32 SPARE0;              // [0xF0000650] : Spare Register 0
    volatile uint32 RESERVED13[39];      // [0xF0000654...0xF00006EF] : reserved space
...
/* SCU_PLLSTAT_K2RDY (rh) */
#define SCU_PLLSTAT_K2RDY_POS                _SCU_UL(5)
#define SCU_PLLSTAT_K2RDY_LEN                _SCU_UL(1)

/* SCU_PLLSTAT_MODRUN (rh) */
#define SCU_PLLSTAT_MODRUN_POS               _SCU_UL(7)
#define SCU_PLLSTAT_MODRUN_LEN               _SCU_UL(1)
...
/* SCU_PLLCON0_MODEN (rw) */
#define SCU_PLLCON0_MODEN_POS                _SCU_UL(2)
#define SCU_PLLCON0_MODEN_LEN                _SCU_UL(1)
...
/* SCU_PLLCON2_MODAMP (rw) */
#define SCU_PLLCON2_MODAMP_POS               _SCU_UL(0)
#define SCU_PLLCON2_MODAMP_LEN               _SCU_UL(16)

/* SCU_PLLCON2_MODFREQ (rw) */
#define SCU_PLLCON2_MODFREQ_POS              _SCU_UL(16)
#define SCU_PLLCON2_MODFREQ_LEN              _SCU_UL(16)

/* SCU_PLLERAYSTAT_VCOBYST (rh) */
#define SCU_PLLERAYSTAT_VCOBYST_POS          _SCU_UL(0)
#define SCU_PLLERAYSTAT_VCOBYST_LEN          _SCU_UL(1)

/* SCU_PLLERAYSTAT_PWDSTAT (rh) */
#define SCU_PLLERAYSTAT_PWDSTAT_POS          _SCU_UL(1)
#define SCU_PLLERAYSTAT_PWDSTAT_LEN          _SCU_UL(1)

/* SCU_PLLERAYSTAT_VCOLOCK (rh) */
#define SCU_PLLERAYSTAT_VCOLOCK_POS          _SCU_UL(2)
#define SCU_PLLERAYSTAT_VCOLOCK_LEN          _SCU_UL(1)

/* SCU_PLLERAYSTAT_FINDIS (rh) */
#define SCU_PLLERAYSTAT_FINDIS_POS           _SCU_UL(3)
#define SCU_PLLERAYSTAT_FINDIS_LEN           _SCU_UL(1)

/* SCU_PLLERAYSTAT_K1RDY (rh) */
#define SCU_PLLERAYSTAT_K1RDY_POS            _SCU_UL(4)
#define SCU_PLLERAYSTAT_K1RDY_LEN            _SCU_UL(1)

/* SCU_PLLERAYSTAT_K2RDY (rh) */
#define SCU_PLLERAYSTAT_K2RDY_POS            _SCU_UL(5)
#define SCU_PLLERAYSTAT_K2RDY_LEN            _SCU_UL(1)

/* SCU_PLLERAYCON0_VCOBYP (rw) */
#define SCU_PLLERAYCON0_VCOBYP_POS           _SCU_UL(0)
#define SCU_PLLERAYCON0_VCOBYP_LEN           _SCU_UL(1)

/* SCU_PLLERAYCON0_VCOPWD (rw) */
#define SCU_PLLERAYCON0_VCOPWD_POS           _SCU_UL(1)
#define SCU_PLLERAYCON0_VCOPWD_LEN           _SCU_UL(1)

/* SCU_PLLERAYCON0_SETFINDIS (w) */
#define SCU_PLLERAYCON0_SETFINDIS_POS        _SCU_UL(4)
#define SCU_PLLERAYCON0_SETFINDIS_LEN        _SCU_UL(1)

/* SCU_PLLERAYCON0_CLRFINDIS (w) */
#define SCU_PLLERAYCON0_CLRFINDIS_POS        _SCU_UL(5)
#define SCU_PLLERAYCON0_CLRFINDIS_LEN        _SCU_UL(1)

/* SCU_PLLERAYCON0_OSCDISCDIS (rw) */
#define SCU_PLLERAYCON0_OSCDISCDIS_POS       _SCU_UL(6)
#define SCU_PLLERAYCON0_OSCDISCDIS_LEN       _SCU_UL(1)

/* SCU_PLLERAYCON0_NDIV (rw) */
#define SCU_PLLERAYCON0_NDIV_POS             _SCU_UL(9)
#define SCU_PLLERAYCON0_NDIV_LEN             _SCU_UL(5)

/* SCU_PLLERAYCON0_RESLD (w) */
#define SCU_PLLERAYCON0_RESLD_POS            _SCU_UL(18)
#define SCU_PLLERAYCON0_RESLD_LEN            _SCU_UL(1)

/* SCU_PLLERAYCON1_K2DIV (rw) */
#define SCU_PLLERAYCON1_K2DIV_POS            _SCU_UL(0)
#define SCU_PLLERAYCON1_K2DIV_LEN            _SCU_UL(7)

/* SCU_PLLERAYCON1_K1DIV (rw) */
#define SCU_PLLERAYCON1_K1DIV_POS            _SCU_UL(16)
#define SCU_PLLERAYCON1_K1DIV_LEN            _SCU_UL(7)

/* SCU_CCUCON0_FPIDIV (rw) */
#define SCU_CCUCON0_FPIDIV_POS               _SCU_UL(0)
#define SCU_CCUCON0_FPIDIV_LEN               _SCU_UL(4)

/* SCU_CCUCON0_SRIDIV (rw) */
#define SCU_CCUCON0_SRIDIV_POS               _SCU_UL(8)
#define SCU_CCUCON0_SRIDIV_LEN               _SCU_UL(4)

/* SCU_CCUCON0_FSIDIV (rw) */
#define SCU_CCUCON0_FSIDIV_POS               _SCU_UL(16)
#define SCU_CCUCON0_FSIDIV_LEN               _SCU_UL(4)
...
/* SCU_CCUCON1_EDBBBDIV (rw) */
#define SCU_CCUCON1_EDBBBDIV_POS             _SCU_UL(16)
#define SCU_CCUCON1_EDBBBDIV_LEN             _SCU_UL(4)
...
/* SCU_SYSCON_CCTRIG0 (rw) */
#define SCU_SYSCON_CCTRIG0_POS               _SCU_UL(0)
#define SCU_SYSCON_CCTRIG0_LEN               _SCU_UL(1)

/* SCU_SYSCON_CCTRIG1 (rw) */
#define SCU_SYSCON_CCTRIG1_POS               _SCU_UL(1)
#define SCU_SYSCON_CCTRIG1_LEN               _SCU_UL(1)
...
/* SCU_CCUCON2_ERAYDIV (rw) */
#define SCU_CCUCON2_ERAYDIV_POS              _SCU_UL(0)
#define SCU_CCUCON2_ERAYDIV_LEN              _SCU_UL(4)

/* SCU_CCUCON2_EBUDIV (rw) */
#define SCU_CCUCON2_EBUDIV_POS               _SCU_UL(8)
#define SCU_CCUCON2_EBUDIV_LEN               _SCU_UL(4)

/* SCU_CCUCON2_LCK (rh) */
#define SCU_CCUCON2_LCK_POS                  _SCU_UL(31)
#define SCU_CCUCON2_LCK_LEN                  _SCU_UL(1)
...
/* SCU_IGCR0_ISS0 (rw) */
#define SCU_IGCR0_ISS0_POS                   _SCU_UL(8)
#define SCU_IGCR0_ISS0_LEN                   _SCU_UL(2)
...
/* SCU_IGCR0_ISS1 (rw) */
#define SCU_IGCR0_ISS1_POS                   _SCU_UL(24)
#define SCU_IGCR0_ISS1_LEN                   _SCU_UL(2)
...
/* SCU_IGCR1_ISS2 (rw) */
#define SCU_IGCR1_ISS2_POS                   _SCU_UL(8)
#define SCU_IGCR1_ISS2_LEN                   _SCU_UL(2)
...
/* SCU_IGCR1_ISS3 (rw) */
#define SCU_IGCR1_ISS3_POS                   _SCU_UL(24)
#define SCU_IGCR1_ISS3_LEN                   _SCU_UL(2)
...
/* SCU_STSTAT_SPDEN (rh) */
#define SCU_STSTAT_SPDEN_POS                 _SCU_UL(20)
#define SCU_STSTAT_SPDEN_LEN                 _SCU_UL(1)
...
/* SCU_ECCCON_ECCENDSPR (rw) */
#define SCU_ECCCON_ECCENDSPR_POS             _SCU_UL(0)
#define SCU_ECCCON_ECCENDSPR_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENPSPR (rw) */
#define SCU_ECCCON_ECCENPSPR_POS             _SCU_UL(2)
#define SCU_ECCCON_ECCENPSPR_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENLMU (rw) */
#define SCU_ECCCON_ECCENLMU_POS              _SCU_UL(4)
#define SCU_ECCCON_ECCENLMU_LEN              _SCU_UL(1)

/* SCU_ECCCON_ECCENPRAM (rw) */
#define SCU_ECCCON_ECCENPRAM_POS             _SCU_UL(5)
#define SCU_ECCCON_ECCENPRAM_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENCMEM (rw) */
#define SCU_ECCCON_ECCENCMEM_POS             _SCU_UL(6)
#define SCU_ECCCON_ECCENCMEM_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENCAN (rw) */
#define SCU_ECCCON_ECCENCAN_POS              _SCU_UL(7)
#define SCU_ECCCON_ECCENCAN_LEN              _SCU_UL(1)

/* SCU_ECCCON_ECCENERAY (rw) */
#define SCU_ECCCON_ECCENERAY_POS             _SCU_UL(8)
#define SCU_ECCCON_ECCENERAY_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENSRI (rw) */
#define SCU_ECCCON_ECCENSRI_POS              _SCU_UL(9)
#define SCU_ECCCON_ECCENSRI_LEN              _SCU_UL(1)

/* SCU_ECCCON_ECCENEBU (rw) */
#define SCU_ECCCON_ECCENEBU_POS              _SCU_UL(10)
#define SCU_ECCCON_ECCENEBU_LEN              _SCU_UL(1)

/* SCU_ECCCON_ECCENBMU (rw) */
#define SCU_ECCCON_ECCENBMU_POS              _SCU_UL(11)
#define SCU_ECCCON_ECCENBMU_LEN              _SCU_UL(1)

/* SCU_ECCSTAT_DSPR (rh) */
#define SCU_ECCSTAT_DSPR_POS                 _SCU_UL(0)
#define SCU_ECCSTAT_DSPR_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_PSPR (rh) */
#define SCU_ECCSTAT_PSPR_POS                 _SCU_UL(2)
#define SCU_ECCSTAT_PSPR_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_LMU (rh) */
#define SCU_ECCSTAT_LMU_POS                  _SCU_UL(4)
#define SCU_ECCSTAT_LMU_LEN                  _SCU_UL(1)

/* SCU_ECCSTAT_PRAM (rh) */
#define SCU_ECCSTAT_PRAM_POS                 _SCU_UL(5)
#define SCU_ECCSTAT_PRAM_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_CMEM (rh) */
#define SCU_ECCSTAT_CMEM_POS                 _SCU_UL(6)
#define SCU_ECCSTAT_CMEM_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_CAN (rh) */
#define SCU_ECCSTAT_CAN_POS                  _SCU_UL(7)
#define SCU_ECCSTAT_CAN_LEN                  _SCU_UL(1)

/* SCU_ECCSTAT_ERAY (rh) */
#define SCU_ECCSTAT_ERAY_POS                 _SCU_UL(8)
#define SCU_ECCSTAT_ERAY_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_SRI (rh) */
#define SCU_ECCSTAT_SRI_POS                  _SCU_UL(9)
#define SCU_ECCSTAT_SRI_LEN                  _SCU_UL(1)

/* SCU_ECCSTAT_EBU (rh) */
#define SCU_ECCSTAT_EBU_POS                  _SCU_UL(10)
#define SCU_ECCSTAT_EBU_LEN                  _SCU_UL(1)

/* SCU_ECCSTAT_BMU (rh) */
#define SCU_ECCSTAT_BMU_POS                  _SCU_UL(11)
#define SCU_ECCSTAT_BMU_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_DSPR (w) */
#define SCU_ECCCLR_DSPR_POS                  _SCU_UL(0)
#define SCU_ECCCLR_DSPR_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_PSPR (w) */
#define SCU_ECCCLR_PSPR_POS                  _SCU_UL(2)
#define SCU_ECCCLR_PSPR_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_LMU (w) */
#define SCU_ECCCLR_LMU_POS                   _SCU_UL(4)
#define SCU_ECCCLR_LMU_LEN                   _SCU_UL(1)

/* SCU_ECCCLR_PRAM (w) */
#define SCU_ECCCLR_PRAM_POS                  _SCU_UL(5)
#define SCU_ECCCLR_PRAM_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_CMEM (w) */
#define SCU_ECCCLR_CMEM_POS                  _SCU_UL(6)
#define SCU_ECCCLR_CMEM_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_CAN (w) */
#define SCU_ECCCLR_CAN_POS                   _SCU_UL(7)
#define SCU_ECCCLR_CAN_LEN                   _SCU_UL(1)

/* SCU_ECCCLR_ERAY (w) */
#define SCU_ECCCLR_ERAY_POS                  _SCU_UL(8)
#define SCU_ECCCLR_ERAY_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_SRI (w) */
#define SCU_ECCCLR_SRI_POS                   _SCU_UL(9)
#define SCU_ECCCLR_SRI_LEN                   _SCU_UL(1)

/* SCU_ECCCLR_EBU (w) */
#define SCU_ECCCLR_EBU_POS                   _SCU_UL(10)
#define SCU_ECCCLR_EBU_LEN                   _SCU_UL(1)

/* SCU_ECCCLR_BMU (w) */
#define SCU_ECCCLR_BMU_POS                   _SCU_UL(11)
#define SCU_ECCCLR_BMU_LEN                   _SCU_UL(1)
...
/* SCU_TRAPSTAT_ECCT (rh) */
#define SCU_TRAPSTAT_ECCT_POS                _SCU_UL(4)
#define SCU_TRAPSTAT_ECCT_LEN                _SCU_UL(1)
...
/* SCU_TRAPSET_ECCT (w) */
#define SCU_TRAPSET_ECCT_POS                 _SCU_UL(4)
#define SCU_TRAPSET_ECCT_LEN                 _SCU_UL(1)
...
/* SCU_TRAPCLR_ECCT (w) */
#define SCU_TRAPCLR_ECCT_POS                 _SCU_UL(4)
#define SCU_TRAPCLR_ECCT_LEN                 _SCU_UL(1)
...
/* SCU_TRAPDIS_ECCT (rw) */
#define SCU_TRAPDIS_ECCT_POS                 _SCU_UL(4)
#define SCU_TRAPDIS_ECCT_LEN                 _SCU_UL(1)
...
/* SCU_CHIPID_UCODE (rw) */
#define SCU_CHIPID_UCODE_POS                 _SCU_UL(17)
#define SCU_CHIPID_UCODE_LEN                 _SCU_UL(7)

/* SCU_CHIPID_FSIZE (rw) */
#define SCU_CHIPID_FSIZE_POS                 _SCU_UL(24)
#define SCU_CHIPID_FSIZE_LEN                 _SCU_UL(4)

/* SCU_CHIPID_SP (rw) */
#define SCU_CHIPID_SP_POS                    _SCU_UL(28)
#define SCU_CHIPID_SP_LEN                    _SCU_UL(2)

/* SCU_CHIPID_SHE (rw) */
#define SCU_CHIPID_SHE_POS                   _SCU_UL(30)
#define SCU_CHIPID_SHE_LEN                   _SCU_UL(1)

/* SCU_CHIPID_CUBM (rw) */
#define SCU_CHIPID_CUBM_POS                  _SCU_UL(31)
#define SCU_CHIPID_CUBM_LEN                  _SCU_UL(1)
...
/* SCU_SPARE0_ZERO (rw) */
#define SCU_SPARE0_ZERO_POS                  _SCU_UL(0)
#define SCU_SPARE0_ZERO_LEN                  _SCU_UL(8)

/* SCU_SPARE0_CLIPEN (rw) */
#define SCU_SPARE0_CLIPEN_POS                _SCU_UL(8)
#define SCU_SPARE0_CLIPEN_LEN                _SCU_UL(1)

/* SCU_SPARE0_MODCFG (rw) */
#define SCU_SPARE0_MODCFG_POS                _SCU_UL(9)
#define SCU_SPARE0_MODCFG_LEN                _SCU_UL(6)

/* SCU_SPARE0_STEALEN (rw) */
#define SCU_SPARE0_STEALEN_POS               _SCU_UL(16)
#define SCU_SPARE0_STEALEN_LEN               _SCU_UL(1)

/* SCU_SPARE0_ONE (rw) */
#define SCU_SPARE0_ONE_POS                   _SCU_UL(22)
#define SCU_SPARE0_ONE_LEN                   _SCU_UL(2)
