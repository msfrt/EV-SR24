 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SSC on TC1724
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CLC;                 // [0xF0100100] : SSC0_Clock Control Register
    volatile uint32 PISEL;               // [0xF0100104] : Port Input Select Register
    volatile uint32 ID;                  // [0xF0100108] : Module Identification Register
    volatile uint32 FDR;                 // [0xF010010C] : SSC0 Fractional Divider Register
    volatile uint32 CON;                 // [0xF0100110] : Control Register
    volatile uint32 BR;                  // [0xF0100114] : Baud Rate Timer Reload Register
    volatile uint32 SSOC;                // [0xF0100118] : Slave Select Output Control Register
    volatile uint32 SSOTC;               // [0xF010011C] : Slave Select Output Timing Control Register
    volatile uint32 TB;                  // [0xF0100120] : Transmit Buffer Register
    volatile uint32 RB;                  // [0xF0100124] : Receive Buffer Register
    volatile uint32 STAT;                // [0xF0100128] : Status Register
    volatile uint32 EFM;                 // [0xF010012C] : Error Flag Modification Register
    volatile uint32 RESERVED0[49];       // [0xF0100130...0xF01001F3] : reserved space
    volatile uint32 TSRC;                // [0xF01001F4] : Transmit Interrupt Service Request Control Register
    volatile uint32 RSRC;                // [0xF01001F8] : Receive Interrupt Service Request Control Register
    volatile uint32 ESRC;                // [0xF01001FC] : Error Interrupt Service Request Control Register
} SSC_RegMap_t;
