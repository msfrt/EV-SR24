 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P7 on TC1387
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 OUT;                 // [0xF0001300] : Port 7 Output Register
    ...
    volatile uint32 IOCR0;               // [0xF0001310] : Port 7 Input/Output Control Register 0
    volatile uint32 IOCR4;               // [0xF0001314] : Port 7 Input/Output Control Register 4
    volatile uint32 IOCR8;               // [0xF0001318] : Port 7 Input/Output Control Register 8
    volatile uint32 IOCR12;              // [0xF000131C] : Port 7 Input/Output Control Register 12
    volatile uint32 RESERVED1[1];        // [0xF0001320...0xF0001323] : reserved space
    ...
    volatile uint32 RESERVED3[3];        // [0xF0001344...0xF000134F] : reserved space
    volatile uint32 ESR;                 // [0xF0001350] : Port 7 Emergency Stop Register
} P7_RegMap_t;
...
/* P7_ID_MOD_NUMBER (r) */
#define P7_ID_MOD_NUMBER_POS                _P7_UL(16)
#define P7_ID_MOD_NUMBER_LEN                _P7_UL(16)

/* P7_ID_MOD_REV (r) */
#define P7_ID_MOD_REV_POS                   _P7_UL(0)
#define P7_ID_MOD_REV_LEN                   _P7_UL(8)

/* P7_ID_MOD_TYPE (r) */
#define P7_ID_MOD_TYPE_POS                  _P7_UL(8)
#define P7_ID_MOD_TYPE_LEN                  _P7_UL(8)
...
/* P7_IOCR8_PC8 (rw) */
#define P7_IOCR8_PC8_POS                     _P7_UL(4)
#define P7_IOCR8_PC8_LEN                     _P7_UL(4)

/* P7_IOCR8_PC9 (rw) */
#define P7_IOCR8_PC9_POS                     _P7_UL(12)
#define P7_IOCR8_PC9_LEN                     _P7_UL(4)

/* P7_IOCR8_PC10 (rw) */
#define P7_IOCR8_PC10_POS                    _P7_UL(20)
#define P7_IOCR8_PC10_LEN                    _P7_UL(4)

/* P7_IOCR8_PC11 (rw) */
#define P7_IOCR8_PC11_POS                    _P7_UL(28)
#define P7_IOCR8_PC11_LEN                    _P7_UL(4)

/* P7_IOCR12_PC12 (rw) */
#define P7_IOCR12_PC12_POS                   _P7_UL(4)
#define P7_IOCR12_PC12_LEN                   _P7_UL(4)

/* P7_IOCR12_PC13 (rw) */
#define P7_IOCR12_PC13_POS                   _P7_UL(12)
#define P7_IOCR12_PC13_LEN                   _P7_UL(4)

/* P7_IOCR12_PC14 (rw) */
#define P7_IOCR12_PC14_POS                   _P7_UL(20)
#define P7_IOCR12_PC14_LEN                   _P7_UL(4)

/* P7_IOCR12_PC15 (rw) */
#define P7_IOCR12_PC15_POS                   _P7_UL(28)
#define P7_IOCR12_PC15_LEN                   _P7_UL(4)
...
/* P7_PDR_PD1 (rw) */
#define P7_PDR_PD1_POS                       _P7_UL(4)
#define P7_PDR_PD1_LEN                       _P7_UL(3)

/* P7_PDR_PD2 (rw) */
#define P7_PDR_PD2_POS                       _P7_UL(8)
#define P7_PDR_PD2_LEN                       _P7_UL(3)

/* P7_PDR_PD3 (rw) */
#define P7_PDR_PD3_POS                       _P7_UL(12)
#define P7_PDR_PD3_LEN                       _P7_UL(3)

/* P7_ESR_EN0 (rw) */
#define P7_ESR_EN0_POS                       _P7_UL(0)
#define P7_ESR_EN0_LEN                       _P7_UL(1)

/* P7_ESR_EN1 (rw) */
#define P7_ESR_EN1_POS                       _P7_UL(1)
#define P7_ESR_EN1_LEN                       _P7_UL(1)

/* P7_ESR_EN2 (rw) */
#define P7_ESR_EN2_POS                       _P7_UL(2)
#define P7_ESR_EN2_LEN                       _P7_UL(1)

/* P7_ESR_EN3 (rw) */
#define P7_ESR_EN3_POS                       _P7_UL(3)
#define P7_ESR_EN3_LEN                       _P7_UL(1)

/* P7_ESR_EN4 (rw) */
#define P7_ESR_EN4_POS                       _P7_UL(4)
#define P7_ESR_EN4_LEN                       _P7_UL(1)

/* P7_ESR_EN5 (rw) */
#define P7_ESR_EN5_POS                       _P7_UL(5)
#define P7_ESR_EN5_LEN                       _P7_UL(1)

/* P7_ESR_EN6 (rw) */
#define P7_ESR_EN6_POS                       _P7_UL(6)
#define P7_ESR_EN6_LEN                       _P7_UL(1)

/* P7_ESR_EN7 (rw) */
#define P7_ESR_EN7_POS                       _P7_UL(7)
#define P7_ESR_EN7_LEN                       _P7_UL(1)

/* P7_ESR_EN8 (rw) */
#define P7_ESR_EN8_POS                       _P7_UL(8)
#define P7_ESR_EN8_LEN                       _P7_UL(1)

/* P7_ESR_EN9 (rw) */
#define P7_ESR_EN9_POS                       _P7_UL(9)
#define P7_ESR_EN9_LEN                       _P7_UL(1)

/* P7_ESR_EN10 (rw) */
#define P7_ESR_EN10_POS                      _P7_UL(10)
#define P7_ESR_EN10_LEN                      _P7_UL(1)

/* P7_ESR_EN11 (rw) */
#define P7_ESR_EN11_POS                      _P7_UL(11)
#define P7_ESR_EN11_LEN                      _P7_UL(1)

/* P7_ESR_EN12 (rw) */
#define P7_ESR_EN12_POS                      _P7_UL(12)
#define P7_ESR_EN12_LEN                      _P7_UL(1)

/* P7_ESR_EN13 (rw) */
#define P7_ESR_EN13_POS                      _P7_UL(13)
#define P7_ESR_EN13_LEN                      _P7_UL(1)

/* P7_ESR_EN14 (rw) */
#define P7_ESR_EN14_POS                      _P7_UL(14)
#define P7_ESR_EN14_LEN                      _P7_UL(1)

/* P7_ESR_EN15 (rw) */
#define P7_ESR_EN15_POS                      _P7_UL(15)
#define P7_ESR_EN15_LEN                      _P7_UL(1)
