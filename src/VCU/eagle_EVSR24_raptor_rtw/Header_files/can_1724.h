 ...
 *   Modified for the 64 message objects
 * 
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CAN on TC1724
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    Can_MsgObj_t    MO[64];             // [0xF0005000...0xF00057FF] : Message object register
    volatile uint32 RESERVED7[2559];     // [0xF0005800...0xF0007FFB] : reserved space
...
/* CAN_MCR_CLKSEL (rw) */
#define CAN_MCR_CLKSEL_POS                   _CAN_UL(0)
#define CAN_MCR_CLKSEL_LEN                   _CAN_UL(4)
