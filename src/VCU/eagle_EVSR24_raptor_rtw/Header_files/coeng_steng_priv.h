 ...
 *************************************************************************
 *
 * $Filename__:coeng_steng_priv.h$
 *
 * $Author____:AUF2FE$
 *
 * $Function__:Platform merge of CoEng_StEng and parts of CoEng_StrtCtl$
 *
 *************************************************************************
 * $Domain____:SDOM$
 * $User______:WBB2SI$
...
#ifndef _COENG_STENG_PRIV_H
#define _COENG_STENG_PRIV_H
...
/* method prototypes for BYP_IMPL */
static void BYP_IMPL_calc(void);

/* method prototypes for COENG_STENGS_IMPL */
static void COENG_STENGS_IMPL_trigger(void);
static void COENG_STENGS_IMPL_trigger_Ini(void);
static uint8 COENG_STENGS_IMPL_U_Ready2Cranking(void);
static bit COENG_STENGS_IMPL_U_Running2Ready(void);
