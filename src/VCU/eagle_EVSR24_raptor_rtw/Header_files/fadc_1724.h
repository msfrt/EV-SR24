 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module FADC on TC1724
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 ID;                  // [0xF0100408] : Module Identification Register
    ...
    volatile uint32 CFGR[2];             // [0xF0100420...0xF0100427] : Channel 0 Configuration Register
    volatile uint32 RESERVED1[2];        // [0xF0100428...0xF010042F] : reserved space
    volatile uint32 ACR[2];              // [0xF0100430...0xF0100437] : Channel 0 Analog Control Register
    volatile uint32 RESERVED2[2];        // [0xF0100438...0xF010043F] : reserved space
    volatile uint32 RCH[2];             // [0xF0100440...0xF0100447] : Channel 0 Conversion Result Register
    volatile uint32 RESERVED3[3];        // [0xF0100448...0xF0100453] : reserved space
    volatile uint32 ALR;                 // [0xF0100454] : Alias Register
    volatile uint32 RESERVED4[2];        // [0xF0100458...0xF010045F] : reserved space
    ...
    volatile uint32 RESERVED5[2];        // [0xF0100478...0xF010047F] : reserved space
    ...
    volatile uint32 RESERVED6[2];        // [0xF010048C...0xF0100493] : reserved space
    ...
    volatile uint32 RESERVED7[21];       // [0xF010049C...0xF01004EF] : reserved space
...
/* FADC_FDR_FDIS (rw) */
#define FADC_FDR_FDIS_POS                    _FADC_UL(10)
#define FADC_FDR_FDIS_LEN                    _FADC_UL(1)
...
#define FADC_GCR_CALCH_LEN                   _FADC_UL(1)
...
#define FADC_ALR_ALIAS0_LEN                  _FADC_UL(1)

/* FADC_ALR_ALIAS1 (rw) */
#define FADC_ALR_ALIAS1_POS                  _FADC_UL(2)
#define FADC_ALR_ALIAS1_LEN                  _FADC_UL(1)
...
#define FADC_CRR0_CR_LEN                     _FADC_UL(18)
