 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CPU on TC1767
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED3[114];      // [0xF7E19048...0xF7E1920F] : reserved space
    ...
    volatile uint32 RESERVED4[121];      // [0xF7E1921C...0xF7E193FF] : reserved space
...
/* CPU_COMPAT_PIE (rw) */
#define CPU_COMPAT_PIE_POS                   _CPU_UL(0)
#define CPU_COMPAT_PIE_LEN                   _CPU_UL(1)

/* CPU_COMPAT_DIE (rw) */
#define CPU_COMPAT_DIE_POS                   _CPU_UL(1)
#define CPU_COMPAT_DIE_LEN                   _CPU_UL(1)

/* CPU_COMPAT_BP (rw) */
#define CPU_COMPAT_BP_POS                    _CPU_UL(2)
#define CPU_COMPAT_BP_LEN                    _CPU_UL(1)

/* CPU_COMPAT_RM (rw) */
#define CPU_COMPAT_RM_POS                    _CPU_UL(3)
#define CPU_COMPAT_RM_LEN                    _CPU_UL(1)
