 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module DMA on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 ME1AENR;             // [0xF0003C4C] : DMA Move Engine 1Access Enable Register
    ...
    volatile uint32 RESERVED19[8];       // [0xF0003E80...0xF0003E9F] : reserved space
    ...
    volatile uint32 RESERVED20[2];       // [0xF0003EB0...0xF0003EB7] : reserved space
    ...
    volatile uint32 RESERVED21[8];       // [0xF0003EC0...0xF0003EDF] : reserved space
