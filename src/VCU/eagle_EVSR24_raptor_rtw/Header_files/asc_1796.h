 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ASC0 on Metis
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CLC;                 // [0xF0000x00] : ASC Clock Control Register
    volatile uint32 PISEL;               // [0xF0000x04] : ASC Peripheral Input Select Register
    volatile uint32 ID;                  // [0xF0000x08] : ASC Module Identification Register
    volatile uint32 RESERVED0[1];        // [0xF0000x0C...0xF0000x0F] : reserved space
    volatile uint32 CON;                 // [0xF0000x10] : ASC Control Register
    volatile uint32 BG;                  // [0xF0000x14] : ASC Baudrate Timer Reload Register
    volatile uint32 FDV;                 // [0xF0000x18] : ASC Fractional Divider Register
    volatile uint32 RESERVED1[1];        // [0xF0000x1C...0xF0000x1F] : reserved space
    volatile uint32 TBUF;                // [0xF0000x20] : ASC Transmit Buffer Register
    volatile uint32 RBUF;                // [0xF0000x24] : ASC Receive Buffer Register
    volatile uint32 RESERVED2[10];       // [0xF0000x28...0xF0000x4F] : reserved space
    volatile uint32 WHBCON;              // [0xF0000x50] : ASC Hardware Bits Control Register
    volatile uint32 RESERVED3[39];       // [0xF0000x54...0xF0000xEF] : reserved space
    volatile uint32 TSRC;                // [0xF0000xF0] : ASC Transmit Interrupt Service Request Control Register
    volatile uint32 RSRC;                // [0xF0000xF4] : ASC Receive Interrupt Service Request Control Register
    volatile uint32 ESRC;                // [0xF0000xF8] : ASC Error Interrupt Service Request Control Register
    volatile uint32 TBSRC;               // [0xF0000xFC] : ASC Transmit Buffer Service Request Control Register
} ASC_RegMap_t;
...
/* ASC1_CLC_RMC (rw) */
#define ASC1_CLC_RMC_POS           _ASC_UL(8)
#define ASC1_CLC_RMC_LEN           _ASC_UL(8)
...
#define ASC0_ID_MOD_NUMBER_POS         _ASC_UL(8)
#define ASC0_ID_MOD_NUMBER_LEN         _ASC_UL(8)
...
/* ASC1_CLC_DISR (rw) */
#define ASC1_CLC_DISR_POS              _ASC_UL(0)
#define ASC1_CLC_DISR_LEN              _ASC_UL(1)

/* ASC1_CLC_DISS (r) */
#define ASC1_CLC_DISS_POS              _ASC_UL(1)
#define ASC1_CLC_DISS_LEN              _ASC_UL(1)

/* ASC1_CLC_EDIS (rw) */
#define ASC1_CLC_EDIS_POS              _ASC_UL(3)
#define ASC1_CLC_EDIS_LEN              _ASC_UL(1)

/* ASC1_CLC_FSOE (rw) */
#define ASC1_CLC_FSOE_POS              _ASC_UL(5)
#define ASC1_CLC_FSOE_LEN              _ASC_UL(1)

/* ASC1_CLC_SBWE (w) */
#define ASC1_CLC_SBWE_POS              _ASC_UL(4)
#define ASC1_CLC_SBWE_LEN              _ASC_UL(1)

/* ASC1_CLC_SPEN (rw) */
#define ASC1_CLC_SPEN_POS              _ASC_UL(2)
#define ASC1_CLC_SPEN_LEN              _ASC_UL(1)
...
#define ASC1_ID_MOD_NUMBER_POS         _ASC_UL(8)
#define ASC1_ID_MOD_NUMBER_LEN         _ASC_UL(8)
