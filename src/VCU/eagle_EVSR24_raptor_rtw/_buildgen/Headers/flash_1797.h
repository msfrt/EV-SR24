...
#ifndef _FLASH_1797_H
#define _FLASH_1797_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module FLASH on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* FLASH1_FSR_PFSBER (rh) */
#define FLASH1_FSR_PFSBER_POS                _FLASH_UL(12)
#define FLASH1_FSR_PFSBER_LEN                _FLASH_UL(1)

/* FLASH1_FSR_DFSBER (rh) */
#define FLASH1_FSR_DFSBER_POS                _FLASH_UL(13)
#define FLASH1_FSR_DFSBER_LEN                _FLASH_UL(1)

/* FLASH1_FSR_PFDBER (rh) */
#define FLASH1_FSR_PFDBER_POS                _FLASH_UL(14)
#define FLASH1_FSR_PFDBER_LEN                _FLASH_UL(1)

/* FLASH1_FSR_DFDBER (rh) */
#define FLASH1_FSR_DFDBER_POS                _FLASH_UL(15)
#define FLASH1_FSR_DFDBER_LEN                _FLASH_UL(1)
...
/* FLASH1_FSR_X (rh) */
#define FLASH1_FSR_X_POS                     _FLASH_UL(30)
#define FLASH1_FSR_X_LEN                     _FLASH_UL(1)
...
/* FLASH1_FCON_DFSBERM (rw) */
#define FLASH1_FCON_DFSBERM_POS              _FLASH_UL(28)
#define FLASH1_FCON_DFSBERM_LEN              _FLASH_UL(1)

/* FLASH1_FCON_PFDBERM (rw) */
#define FLASH1_FCON_PFDBERM_POS              _FLASH_UL(29)
#define FLASH1_FCON_PFDBERM_LEN              _FLASH_UL(1)

/* FLASH1_FCON_DFDBERM (rw) */
#define FLASH1_FCON_DFDBERM_POS              _FLASH_UL(30)
#define FLASH1_FCON_DFDBERM_LEN              _FLASH_UL(1)

/* FLASH1_FCON_EOBM (rw) */
#define FLASH1_FCON_EOBM_POS                 _FLASH_UL(31)
#define FLASH1_FCON_EOBM_LEN                 _FLASH_UL(1)

/* FLASH1_MARP_MARGIN0 (rw) */
#define FLASH1_MARP_MARGIN0_POS              _FLASH_UL(0)
#define FLASH1_MARP_MARGIN0_LEN              _FLASH_UL(2)

/* FLASH1_MARP_MARGIN1 (rw) */
#define FLASH1_MARP_MARGIN1_POS              _FLASH_UL(2)
#define FLASH1_MARP_MARGIN1_LEN              _FLASH_UL(2)

/* FLASH1_MARP_TRAPDIS (rw) */
#define FLASH1_MARP_TRAPDIS_POS              _FLASH_UL(15)
#define FLASH1_MARP_TRAPDIS_LEN              _FLASH_UL(1)

/* FLASH1_MARP_NaNTRAPDIS (rw) */
#define FLASH1_MARP_NaNTRAPDIS_POS           _FLASH_UL(15)
#define FLASH1_MARP_NaNTRAPDIS_LEN           _FLASH_UL(1)

/* FLASH1_MARD_MARGIN0 (rw) */
#define FLASH1_MARD_MARGIN0_POS              _FLASH_UL(0)
#define FLASH1_MARD_MARGIN0_LEN              _FLASH_UL(2)

/* FLASH1_MARD_MARGIN1 (rw) */
#define FLASH1_MARD_MARGIN1_POS              _FLASH_UL(2)
#define FLASH1_MARD_MARGIN1_LEN              _FLASH_UL(2)

/* FLASH1_MARD_BNKSEL (rw) */
#define FLASH1_MARD_BNKSEL_POS               _FLASH_UL(4)
#define FLASH1_MARD_BNKSEL_LEN               _FLASH_UL(1)

/* FLASH1_MARD_TRAPDIS (rw) */
#define FLASH1_MARD_TRAPDIS_POS              _FLASH_UL(15)
#define FLASH1_MARD_TRAPDIS_LEN              _FLASH_UL(1)

/* FLASH1_MARD_NaNTRAPDIS (rw) */
#define FLASH1_MARD_NaNTRAPDIS_POS           _FLASH_UL(15)
#define FLASH1_MARD_NaNTRAPDIS_LEN           _FLASH_UL(1)
...
#define FLASH1_PROCON0_DFEXPRO_POS           _FLASH_UL(14)
#define FLASH1_PROCON0_DFEXPRO_LEN           _FLASH_UL(1)

/* FLASH1_PROCON0_RPRO (rh) */
#define FLASH1_PROCON0_RPRO_POS              _FLASH_UL(15)
