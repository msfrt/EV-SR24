#ifndef _IGCPS_GLBDEF_DAT_H
#define _IGCPS_GLBDEF_DAT_H

#ifndef _IGCPS_GLBDEF_GS_HEADER
#define _IGCPS_GLBDEF_GS_HEADER
...
#endif /* _IGCPS_GLBDEF_GS_HEADER */
#endif /* _IGCPS_GLBDEF_DAT_H */
