 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ERAY on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED13[58];      // [0xF0010718...0xF00107FF] : reserved space
    volatile uint32 SECCON;              // [0xF0010800] : SEC Control
    volatile uint32 SEDCON;              // [0xF0010804] : SED Control
...
/* ERAY_CREL_SUBSTEP (r) */
#define ERAY_CREL_SUBSTEP_POS                _ERAY_UL(20)
...
/* ERAY_SECCON_SECMEN (rw) */
#define ERAY_SECCON_SECMEN_POS               _ERAY_UL(0)
#define ERAY_SECCON_SECMEN_LEN               _ERAY_UL(1)

/* ERAY_SECCON_SECT1EN (rw) */
#define ERAY_SECCON_SECT1EN_POS              _ERAY_UL(1)
#define ERAY_SECCON_SECT1EN_LEN              _ERAY_UL(1)

/* ERAY_SECCON_SECT2EN (rw) */
#define ERAY_SECCON_SECT2EN_POS              _ERAY_UL(2)
#define ERAY_SECCON_SECT2EN_LEN              _ERAY_UL(1)

/* ERAY_SECCON_SECO1EN (rw) */
#define ERAY_SECCON_SECO1EN_POS              _ERAY_UL(3)
#define ERAY_SECCON_SECO1EN_LEN              _ERAY_UL(1)

/* ERAY_SECCON_SECO2EN (rw) */
#define ERAY_SECCON_SECO2EN_POS              _ERAY_UL(4)
#define ERAY_SECCON_SECO2EN_LEN              _ERAY_UL(1)

/* ERAY_SECCON_SECI1EN (rw) */
#define ERAY_SECCON_SECI1EN_POS              _ERAY_UL(5)
#define ERAY_SECCON_SECI1EN_LEN              _ERAY_UL(1)

/* ERAY_SECCON_SECI2EN (rw) */
#define ERAY_SECCON_SECI2EN_POS              _ERAY_UL(6)
#define ERAY_SECCON_SECI2EN_LEN              _ERAY_UL(1)

/* ERAY_SEDCON_SEDMEN (rw) */
#define ERAY_SEDCON_SEDMEN_POS               _ERAY_UL(0)
#define ERAY_SEDCON_SEDMEN_LEN               _ERAY_UL(1)

/* ERAY_SEDCON_SEDT1EN (rw) */
#define ERAY_SEDCON_SEDT1EN_POS              _ERAY_UL(1)
#define ERAY_SEDCON_SEDT1EN_LEN              _ERAY_UL(1)

/* ERAY_SEDCON_SEDT2EN (rw) */
#define ERAY_SEDCON_SEDT2EN_POS              _ERAY_UL(2)
#define ERAY_SEDCON_SEDT2EN_LEN              _ERAY_UL(1)

/* ERAY_SEDCON_SEDO1EN (rw) */
#define ERAY_SEDCON_SEDO1EN_POS              _ERAY_UL(3)
#define ERAY_SEDCON_SEDO1EN_LEN              _ERAY_UL(1)

/* ERAY_SEDCON_SEDO2EN (rw) */
#define ERAY_SEDCON_SEDO2EN_POS              _ERAY_UL(4)
#define ERAY_SEDCON_SEDO2EN_LEN              _ERAY_UL(1)

/* ERAY_SEDCON_SEDI1EN (rw) */
#define ERAY_SEDCON_SEDI1EN_POS              _ERAY_UL(5)
#define ERAY_SEDCON_SEDI1EN_LEN              _ERAY_UL(1)

/* ERAY_SEDCON_SEDI2EN (rw) */
#define ERAY_SEDCON_SEDI2EN_POS              _ERAY_UL(6)
#define ERAY_SEDCON_SEDI2EN_LEN              _ERAY_UL(1)
