 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P16 on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED1[3];        // [0xF0300418...0xF0300423] : reserved space
    volatile uint32 IN;                  // [0xF0300424] : Port 16 Input Register
    volatile uint32 RESERVED2[6];        // [0xF0300428...0xF030043F] : reserved space
    volatile uint32 PDR;                 // [0xF0300440] : Port 16 Pad Driver Mode Register
} P16_RegMap_t;
...
/* P16_PDR_PD0 (rw) */
#define P16_PDR_PD0_POS                      _P16_UL(0)
#define P16_PDR_PD0_LEN                      _P16_UL(3)
