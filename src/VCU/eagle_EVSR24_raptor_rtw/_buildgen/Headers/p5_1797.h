 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P5 on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* P5_PDR_PDASC0 (rw) */
#define P5_PDR_PDASC0_POS                    _P5_UL(16)
#define P5_PDR_PDASC0_LEN                    _P5_UL(3)

/* P5_PDR_PDASC1 (rw) */
#define P5_PDR_PDASC1_POS                    _P5_UL(20)
#define P5_PDR_PDASC1_LEN                    _P5_UL(3)

/* P5_PDR_PDMSC0 (rw) */
#define P5_PDR_PDMSC0_POS                    _P5_UL(24)
#define P5_PDR_PDMSC0_LEN                    _P5_UL(3)

/* P5_PDR_PDMSC1 (rw) */
#define P5_PDR_PDMSC1_POS                    _P5_UL(28)
#define P5_PDR_PDMSC1_LEN                    _P5_UL(3)
...
/* P5_PDR_PD3 (rw) */
#define P5_PDR_PD3_POS                       _P5_UL(12)
#define P5_PDR_PD3_LEN                       _P5_UL(3)
