 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P1 on Metis
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 OUT;                 // [0xF0000D00] : Output Register
...
/* P1_PDR_PDMLI0 (rw) */
#define P1_PDR_PDMLI0_POS              _P1_UL(16)
#define P1_PDR_PDMLI0_LEN              _P1_UL(3)

/* P1_PDR_PDSYSCLK (rw) */
#define P1_PDR_PDSYSCLK_POS            _P1_UL(20)
#define P1_PDR_PDSYSCLK_LEN            _P1_UL(3)
