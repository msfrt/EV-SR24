 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module PMU on TC1767
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* PMU_OVRCON_PB0W (rw) */
#define PMU_OVRCON_PB0W_POS                  _PMU_UL(10)
#define PMU_OVRCON_PB0W_LEN                  _PMU_UL(1)

/* PMU_OVRCON_PB1W (rw) */
#define PMU_OVRCON_PB1W_POS                  _PMU_UL(11)
#define PMU_OVRCON_PB1W_LEN                  _PMU_UL(1)

/* PMU_OVRCON_PB0R (rh) */
#define PMU_OVRCON_PB0R_POS                  _PMU_UL(12)
#define PMU_OVRCON_PB0R_LEN                  _PMU_UL(1)

/* PMU_OVRCON_PB1R (rh) */
#define PMU_OVRCON_PB1R_POS                  _PMU_UL(13)
#define PMU_OVRCON_PB1R_LEN                  _PMU_UL(1)

/* PMU_OVRCON_PB0ERR (rwh) */
#define PMU_OVRCON_PB0ERR_POS                _PMU_UL(14)
#define PMU_OVRCON_PB0ERR_LEN                _PMU_UL(1)

/* PMU_OVRCON_PB1ERR (rwh) */
#define PMU_OVRCON_PB1ERR_POS                _PMU_UL(15)
#define PMU_OVRCON_PB1ERR_LEN                _PMU_UL(1)
...
/* PMU0_OVRCON_PB0W (rw) */
#define PMU0_OVRCON_PB0W_POS                 _PMU_UL(10)
#define PMU0_OVRCON_PB0W_LEN                 _PMU_UL(1)

/* PMU0_OVRCON_PB1W (rw) */
#define PMU0_OVRCON_PB1W_POS                 _PMU_UL(11)
#define PMU0_OVRCON_PB1W_LEN                 _PMU_UL(1)

/* PMU0_OVRCON_PB0R (rh) */
#define PMU0_OVRCON_PB0R_POS                 _PMU_UL(12)
#define PMU0_OVRCON_PB0R_LEN                 _PMU_UL(1)

/* PMU0_OVRCON_PB1R (rh) */
#define PMU0_OVRCON_PB1R_POS                 _PMU_UL(13)
#define PMU0_OVRCON_PB1R_LEN                 _PMU_UL(1)

/* PMU0_OVRCON_PB0ERR (rwh) */
#define PMU0_OVRCON_PB0ERR_POS               _PMU_UL(14)
#define PMU0_OVRCON_PB0ERR_LEN               _PMU_UL(1)

/* PMU0_OVRCON_PB1ERR (rwh) */
#define PMU0_OVRCON_PB1ERR_POS               _PMU_UL(15)
#define PMU0_OVRCON_PB1ERR_LEN               _PMU_UL(1)
