 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P9 on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 IOCR12;              // [0xF000151C] : Port 9 Input/Output Control Register 12
    volatile uint32 RESERVED1[1];        // [0xF0001520...0xF0001523] : reserved space
    volatile uint32 IN;                  // [0xF0001524] : Port 9 Input Register
    volatile uint32 RESERVED2[6];        // [0xF0001528...0xF000153F] : reserved space
    volatile uint32 PDR0;                // [0xF0001540] : Port 9 Pad Driver Mode 0 Register
    volatile uint32 PDR1;                // [0xF0001544] : Port 9 Pad Driver Mode 1 Register
    volatile uint32 RESERVED3[2];        // [0xF0001548...0xF000154F] : reserved space
...
/* P9_IOCR12_PC12 (rw) */
#define P9_IOCR12_PC12_POS                   _P9_UL(4)
#define P9_IOCR12_PC12_LEN                   _P9_UL(4)

/* P9_IOCR12_PC13 (rw) */
#define P9_IOCR12_PC13_POS                   _P9_UL(12)
#define P9_IOCR12_PC13_LEN                   _P9_UL(4)

/* P9_IOCR12_PC14 (rw) */
#define P9_IOCR12_PC14_POS                   _P9_UL(20)
#define P9_IOCR12_PC14_LEN                   _P9_UL(4)

/* P9_IOCR12_PC15 (rw) */
#define P9_IOCR12_PC15_POS                   _P9_UL(28)
#define P9_IOCR12_PC15_LEN                   _P9_UL(4)
...
/* P9_PDR0_PD0 (rw) */
#define P9_PDR0_PD0_POS                      _P9_UL(0)
#define P9_PDR0_PD0_LEN                      _P9_UL(3)

/* P9_PDR0_PD1 (rw) */
#define P9_PDR0_PD1_POS                      _P9_UL(4)
#define P9_PDR0_PD1_LEN                      _P9_UL(3)

/* P9_PDR0_PD2 (rw) */
#define P9_PDR0_PD2_POS                      _P9_UL(8)
#define P9_PDR0_PD2_LEN                      _P9_UL(3)

/* P9_PDR0_PD3 (rw) */
#define P9_PDR0_PD3_POS                      _P9_UL(12)
#define P9_PDR0_PD3_LEN                      _P9_UL(3)

/* P9_PDR0_PD4 (rw) */
#define P9_PDR0_PD4_POS                      _P9_UL(16)
#define P9_PDR0_PD4_LEN                      _P9_UL(3)

/* P9_PDR0_PD5 (rw) */
#define P9_PDR0_PD5_POS                      _P9_UL(20)
#define P9_PDR0_PD5_LEN                      _P9_UL(3)

/* P9_PDR0_PD6 (rw) */
#define P9_PDR0_PD6_POS                      _P9_UL(24)
#define P9_PDR0_PD6_LEN                      _P9_UL(3)

/* P9_PDR0_PD7 (rw) */
#define P9_PDR0_PD7_POS                      _P9_UL(28)
#define P9_PDR0_PD7_LEN                      _P9_UL(3)

/* P9_PDR1_PD8 (rw) */
#define P9_PDR1_PD8_POS                      _P9_UL(0)
#define P9_PDR1_PD8_LEN                      _P9_UL(3)

/* P9_PDR1_PD9 (rw) */
#define P9_PDR1_PD9_POS                      _P9_UL(4)
#define P9_PDR1_PD9_LEN                      _P9_UL(3)

/* P9_PDR1_PD10 (rw) */
#define P9_PDR1_PD10_POS                     _P9_UL(8)
#define P9_PDR1_PD10_LEN                     _P9_UL(3)

/* P9_PDR1_PD11 (rw) */
#define P9_PDR1_PD11_POS                     _P9_UL(12)
#define P9_PDR1_PD11_LEN                     _P9_UL(3)

/* P9_PDR1_PD12 (rw) */
#define P9_PDR1_PD12_POS                     _P9_UL(16)
#define P9_PDR1_PD12_LEN                     _P9_UL(3)

/* P9_PDR1_PD13 (rw) */
#define P9_PDR1_PD13_POS                     _P9_UL(20)
#define P9_PDR1_PD13_LEN                     _P9_UL(3)

/* P9_PDR1_PD14 (rw) */
#define P9_PDR1_PD14_POS                     _P9_UL(24)
#define P9_PDR1_PD14_LEN                     _P9_UL(3)

/* P9_PDR1_PD15 (rw) */
#define P9_PDR1_PD15_POS                     _P9_UL(28)
#define P9_PDR1_PD15_LEN                     _P9_UL(3)
