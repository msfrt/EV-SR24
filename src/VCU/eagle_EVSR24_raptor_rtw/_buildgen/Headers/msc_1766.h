 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module MSC0 on TC1766
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CLC;                 // [0xF0000800] : MSC Clock Control Register
    volatile uint32 RESERVED0[1];        // [0xF0000804...0xF0000807] : reserved space
    volatile uint32 ID;                  // [0xF0000808] : MSC Module Identification Register
    volatile uint32 FDR;                 // [0xF000080C] : MSC Fractional Divider Register
    ...
    volatile uint32 DSDSL;               // [0xF0000824] : Downstream Select Data Source Register Low
    volatile uint32 DSDSH;               // [0xF0000828] : Downstream Select Data Source Register High
    volatile uint32 ESR;                 // [0xF000082C] : MSC Emergency Stop Register
    volatile uint32 UD[4];               // [0xF0000830] : Upstream Data Registers
    volatile uint32 ICR;                 // [0xF0000840] : MSC Interrupt Control Register
    volatile uint32 ISR;                 // [0xF0000844] : MSC Interrupt Status Register
    ...
    volatile uint32 SRC1;                // [0xF00008F8] : MSC Service Request Control Register 1
    volatile uint32 SRC0;                // [0xF00008FC] : MSC Service Request Control Register 0
} MSC_RegMap_t;
