 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SCU on TC1724
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED1[1];        // [0xF0000520...0xF0000523] : reserved space
    ...
    volatile uint32 RESERVED3[2];        // [0xF0000564...0xF000056B] : reserved space
    volatile uint32 EVRRSTCON;           // [0xF000056C] : EVR Reset Control Register
    ...
    volatile uint32 RESERVED4[2];        // [0xF0000578...0xF000057F] : reserved space
    ...
    volatile uint32 RESERVED8[5];        // [0xF00005DC...0xF00005EF] : reserved space
    ...
    volatile uint32 RESERVED12[41];      // [0xF000064C...0xF00006EF] : reserved space
...
/* SCU_OSCCON_CAP0EN (rw) */
#define SCU_OSCCON_CAP0EN_POS                _SCU_UL(24)
#define SCU_OSCCON_CAP0EN_LEN                _SCU_UL(1)

/* SCU_OSCCON_CAP1EN (rw) */
#define SCU_OSCCON_CAP1EN_POS                _SCU_UL(25)
#define SCU_OSCCON_CAP1EN_LEN                _SCU_UL(1)

/* SCU_OSCCON_CAP2EN (rw) */
#define SCU_OSCCON_CAP2EN_POS                _SCU_UL(26)
#define SCU_OSCCON_CAP2EN_LEN                _SCU_UL(1)

/* SCU_OSCCON_CAP3EN (rw) */
#define SCU_OSCCON_CAP3EN_POS                _SCU_UL(27)
#define SCU_OSCCON_CAP3EN_LEN                _SCU_UL(1)
...
/* SCU_RSTSTAT_EVR13 (rh) */
#define SCU_RSTSTAT_EVR13_POS                _SCU_UL(23)
#define SCU_RSTSTAT_EVR13_LEN                _SCU_UL(1)

/* SCU_RSTSTAT_EVR33 (rh) */
#define SCU_RSTSTAT_EVR33_POS                _SCU_UL(24)
#define SCU_RSTSTAT_EVR33_LEN                _SCU_UL(1)

/* SCU_RSTSTAT_EVR5 (rh) */
#define SCU_RSTSTAT_EVR5_POS                 _SCU_UL(25)
#define SCU_RSTSTAT_EVR5_LEN                 _SCU_UL(1)
...
/* SCU_EVRRSTCON_RST13TRIM (rw) */
#define SCU_EVRRSTCON_RST13TRIM_POS          _SCU_UL(0)
#define SCU_EVRRSTCON_RST13TRIM_LEN          _SCU_UL(8)

/* SCU_EVRRSTCON_RST33TRIM (rw) */
#define SCU_EVRRSTCON_RST33TRIM_POS          _SCU_UL(8)
#define SCU_EVRRSTCON_RST33TRIM_LEN          _SCU_UL(8)

/* SCU_EVRRSTCON_RST50TRIM (rw) */
#define SCU_EVRRSTCON_RST50TRIM_POS          _SCU_UL(16)
#define SCU_EVRRSTCON_RST50TRIM_LEN          _SCU_UL(8)

/* SCU_EVRRSTCON_RST13OFF (rw) */
#define SCU_EVRRSTCON_RST13OFF_POS           _SCU_UL(24)
#define SCU_EVRRSTCON_RST13OFF_LEN           _SCU_UL(1)

/* SCU_EVRRSTCON_BPRST13OFF (w) */
#define SCU_EVRRSTCON_BPRST13OFF_POS         _SCU_UL(25)
#define SCU_EVRRSTCON_BPRST13OFF_LEN         _SCU_UL(1)

/* SCU_EVRRSTCON_RST33OFF (rw) */
#define SCU_EVRRSTCON_RST33OFF_POS           _SCU_UL(26)
#define SCU_EVRRSTCON_RST33OFF_LEN           _SCU_UL(1)

/* SCU_EVRRSTCON_BPRST33OFF (w) */
#define SCU_EVRRSTCON_BPRST33OFF_POS         _SCU_UL(27)
#define SCU_EVRRSTCON_BPRST33OFF_LEN         _SCU_UL(1)

/* SCU_EVRRSTCON_RST5OFF (rw) */
#define SCU_EVRRSTCON_RST5OFF_POS            _SCU_UL(28)
#define SCU_EVRRSTCON_RST5OFF_LEN            _SCU_UL(1)

/* SCU_EVRRSTCON_BPRST5OFF (w) */
#define SCU_EVRRSTCON_BPRST5OFF_POS          _SCU_UL(29)
#define SCU_EVRRSTCON_BPRST5OFF_LEN          _SCU_UL(1)

/* SCU_EVRRSTCON_LCK (rh) */
#define SCU_EVRRSTCON_LCK_POS                _SCU_UL(31)
#define SCU_EVRRSTCON_LCK_LEN                _SCU_UL(1)
...
/* SCU_ECCCON_ECCENLDRAM (rw) */
#define SCU_ECCCON_ECCENLDRAM_POS            _SCU_UL(0)
#define SCU_ECCCON_ECCENLDRAM_LEN            _SCU_UL(1)

/* SCU_ECCCON_ECCENDTAG (rw) */
#define SCU_ECCCON_ECCENDTAG_POS             _SCU_UL(1)
#define SCU_ECCCON_ECCENDTAG_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENSPRAM (rw) */
#define SCU_ECCCON_ECCENSPRAM_POS            _SCU_UL(2)
#define SCU_ECCCON_ECCENSPRAM_LEN            _SCU_UL(1)

/* SCU_ECCCON_ECCENPTAG (rw) */
#define SCU_ECCCON_ECCENPTAG_POS             _SCU_UL(3)
#define SCU_ECCCON_ECCENPTAG_LEN             _SCU_UL(1)

/* SCU_ECCCON_ECCENPMU (rw) */
#define SCU_ECCCON_ECCENPMU_POS              _SCU_UL(4)
#define SCU_ECCCON_ECCENPMU_LEN              _SCU_UL(1)
...
/* SCU_ECCCON_ECCENLMB (rw) */
#define SCU_ECCCON_ECCENLMB_POS              _SCU_UL(9)
#define SCU_ECCCON_ECCENLMB_LEN              _SCU_UL(1)

/* SCU_ECCCON_ECCENBMU (rw) */
#define SCU_ECCCON_ECCENBMU_POS              _SCU_UL(11)
#define SCU_ECCCON_ECCENBMU_LEN              _SCU_UL(1)

/* SCU_ECCSTAT_LDRAM (rh) */
#define SCU_ECCSTAT_LDRAM_POS                _SCU_UL(0)
#define SCU_ECCSTAT_LDRAM_LEN                _SCU_UL(1)

/* SCU_ECCSTAT_DTAG (rh) */
#define SCU_ECCSTAT_DTAG_POS                 _SCU_UL(1)
#define SCU_ECCSTAT_DTAG_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_SPRAM (rh) */
#define SCU_ECCSTAT_SPRAM_POS                _SCU_UL(2)
#define SCU_ECCSTAT_SPRAM_LEN                _SCU_UL(1)

/* SCU_ECCSTAT_PTAG (rh) */
#define SCU_ECCSTAT_PTAG_POS                 _SCU_UL(3)
#define SCU_ECCSTAT_PTAG_LEN                 _SCU_UL(1)

/* SCU_ECCSTAT_PMU (rh) */
#define SCU_ECCSTAT_PMU_POS                  _SCU_UL(4)
#define SCU_ECCSTAT_PMU_LEN                  _SCU_UL(1)
...
/* SCU_ECCSTAT_LMB (rh) */
#define SCU_ECCSTAT_LMB_POS                  _SCU_UL(9)
#define SCU_ECCSTAT_LMB_LEN                  _SCU_UL(1)
...
/* SCU_ECCCLR_LDRAM (w) */
#define SCU_ECCCLR_LDRAM_POS                 _SCU_UL(0)
#define SCU_ECCCLR_LDRAM_LEN                 _SCU_UL(1)

/* SCU_ECCCLR_DTAG (w) */
#define SCU_ECCCLR_DTAG_POS                  _SCU_UL(1)
#define SCU_ECCCLR_DTAG_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_SPRAM (w) */
#define SCU_ECCCLR_SPRAM_POS                 _SCU_UL(2)
#define SCU_ECCCLR_SPRAM_LEN                 _SCU_UL(1)

/* SCU_ECCCLR_PTAG (w) */
#define SCU_ECCCLR_PTAG_POS                  _SCU_UL(3)
#define SCU_ECCCLR_PTAG_LEN                  _SCU_UL(1)

/* SCU_ECCCLR_PMU (w) */
#define SCU_ECCCLR_PMU_POS                   _SCU_UL(4)
#define SCU_ECCCLR_PMU_LEN                   _SCU_UL(1)
...
/* SCU_ECCCLR_LMB (w) */
#define SCU_ECCCLR_LMB_POS                   _SCU_UL(9)
#define SCU_ECCCLR_LMB_LEN                   _SCU_UL(1)
