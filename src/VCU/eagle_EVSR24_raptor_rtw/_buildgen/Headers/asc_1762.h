 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ASC0 on TC1762
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CLC;                 // [0xF0000A00] : ASC Clock Control Register
    volatile uint32 PISEL;               // [0xF0000A04] : ASC Peripheral Input Select Register
    volatile uint32 ID;                  // [0xF0000A08] : ASC Module Identification Register
    volatile uint32 RESERVED0[1];        // [0xF0000A0C...0xF0000A0F] : reserved space
    volatile uint32 CON;                 // [0xF0000A10] : ASC Control Register
    volatile uint32 BG;                  // [0xF0000A14] : ASC Baudrate Timer Reload Register
    volatile uint32 FDV;                 // [0xF0000A18] : ASC Fractional Divider Register
    volatile uint32 RESERVED1[1];        // [0xF0000A1C...0xF0000A1F] : reserved space
    volatile uint32 TBUF;                // [0xF0000A20] : ASC Transmit Buffer Register
    volatile uint32 RBUF;                // [0xF0000A24] : ASC Receive Buffer Register
    volatile uint32 RESERVED2[10];       // [0xF0000A28...0xF0000A4F] : reserved space
    volatile uint32 WHBCON;              // [0xF0000A50] : ASC Hardware Bits Control Register
    volatile uint32 RESERVED3[39];       // [0xF0000A54...0xF0000AEF] : reserved space
    volatile uint32 TSRC;                // [0xF0000AF0] : ASC Transmit Interrupt Service Request Control Register
    volatile uint32 RSRC;                // [0xF0000AF4] : ASC Receive Interrupt Service Request Control Register
    volatile uint32 ESRC;                // [0xF0000AF8] : ASC Error Interrupt Service Request Control Register
    volatile uint32 TBSRC;               // [0xF0000AFC] : ASC Transmit Buffer Service Request Control Register
} ASC_RegMap_t;

/* 'extern' declaration for the module struct. */
/* The module's base address will be assigned by the linker/locator. */
extern ASC_RegMap_t ASC0 __attribute__ ((section (".zbss")));
extern ASC_RegMap_t ASC1 __attribute__ ((section (".zbss")));
