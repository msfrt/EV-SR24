 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SSC0 on TC1762
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 ID;                  // [0xF0100108] : SSC Module Identification Register
    ...
    volatile uint32 TSRC;                // [0xF01001F4] : SSC Transmit Interrupt Service Request Control Register
    volatile uint32 RSRC;                // [0xF01001F8] : SSC Receive Interrupt Service Request Control Register
    volatile uint32 ESRC;                // [0xF01001FC] : SSC Error Interrupt Service Request Control Register
} SSC_RegMap_t;

/* 'extern' declaration for the module struct. */
/* The module's base address will be assigned by the linker/locator. */
extern SSC_RegMap_t SSC0;
...
/* SSC0_ID_CFG0 (r) */
#define SSC0_ID_CFG0_POS               _SSC_UL(5)
#define SSC0_ID_CFG0_LEN               _SSC_UL(1)

/* SSC0_ID_MOD_REV (r) */
#define SSC0_ID_MOD_REV_POS            _SSC_UL(0)
#define SSC0_ID_MOD_REV_LEN            _SSC_UL(5)
