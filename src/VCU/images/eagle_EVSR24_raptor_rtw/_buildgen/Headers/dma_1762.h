 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module DMA on TC1762
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED9[16];       // [0xF0003EB0...0xF0003EEF] : reserved space
...
/* Due to a lack of up-to-date errata sheets for TC1762, it's assumed that this erratum is   */
/* also valid.                                                                               */
