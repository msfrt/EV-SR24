 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module LBCU on TC1724
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 LEADDED;             // [0xF87FFE34] : LMB Error Address Error Detection Register
    volatile uint32 LEDATED;             // [0xF87FFE38] : LMB Error Data Error Detection Register
    volatile uint32 LERESED;             // [0xF87FFE3C] : LMB Error Response Error Detection Register
    ...
    volatile uint32 RESERVED2[42];       // [0xF87FFE54...0xF87FFEFB] : reserved space
