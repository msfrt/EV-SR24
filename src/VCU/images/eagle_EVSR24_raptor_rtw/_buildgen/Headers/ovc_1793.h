 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module OVC on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED0[1];        // [0xF87FFBE4...0xF87FFBE7] : reserved space
    volatile uint32 OENABLE;             // [0xF87FFBE8] : Overlay Enable Register
} OVC_RegMap_t;
...
/* OVC_RABR0_OBASE (rw) */
#define OVC_RABR0_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR0_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR0_FIXVAL (r) */
#define OVC_RABR0_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR0_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR0_TBASE (rw) */
#define OVC_OTAR0_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR0_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK0_OMASK (rw) */
#define OVC_OMASK0_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK0_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK0_ONE (r) */
#define OVC_OMASK0_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK0_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR1_OBASE (rw) */
#define OVC_RABR1_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR1_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR1_FIXVAL (r) */
#define OVC_RABR1_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR1_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR1_TBASE (rw) */
#define OVC_OTAR1_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR1_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK1_OMASK (rw) */
#define OVC_OMASK1_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK1_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK1_ONE (r) */
#define OVC_OMASK1_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK1_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR2_OBASE (rw) */
#define OVC_RABR2_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR2_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR2_FIXVAL (r) */
#define OVC_RABR2_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR2_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR2_TBASE (rw) */
#define OVC_OTAR2_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR2_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK2_OMASK (rw) */
#define OVC_OMASK2_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK2_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK2_ONE (r) */
#define OVC_OMASK2_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK2_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR3_OBASE (rw) */
#define OVC_RABR3_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR3_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR3_FIXVAL (r) */
#define OVC_RABR3_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR3_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR3_TBASE (rw) */
#define OVC_OTAR3_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR3_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK3_OMASK (rw) */
#define OVC_OMASK3_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK3_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK3_ONE (r) */
#define OVC_OMASK3_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK3_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR4_OBASE (rw) */
#define OVC_RABR4_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR4_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR4_FIXVAL (r) */
#define OVC_RABR4_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR4_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR4_TBASE (rw) */
#define OVC_OTAR4_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR4_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK4_OMASK (rw) */
#define OVC_OMASK4_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK4_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK4_ONE (r) */
#define OVC_OMASK4_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK4_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR5_OBASE (rw) */
#define OVC_RABR5_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR5_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR5_FIXVAL (r) */
#define OVC_RABR5_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR5_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR5_TBASE (rw) */
#define OVC_OTAR5_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR5_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK5_OMASK (rw) */
#define OVC_OMASK5_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK5_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK5_ONE (r) */
#define OVC_OMASK5_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK5_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR6_OBASE (rw) */
#define OVC_RABR6_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR6_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR6_FIXVAL (r) */
#define OVC_RABR6_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR6_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR6_TBASE (rw) */
#define OVC_OTAR6_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR6_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK6_OMASK (rw) */
#define OVC_OMASK6_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK6_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK6_ONE (r) */
#define OVC_OMASK6_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK6_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR7_OBASE (rw) */
#define OVC_RABR7_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR7_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR7_FIXVAL (r) */
#define OVC_RABR7_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR7_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR7_TBASE (rw) */
#define OVC_OTAR7_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR7_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK7_OMASK (rw) */
#define OVC_OMASK7_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK7_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK7_ONE (r) */
#define OVC_OMASK7_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK7_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR8_OBASE (rw) */
#define OVC_RABR8_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR8_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR8_FIXVAL (r) */
#define OVC_RABR8_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR8_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR8_TBASE (rw) */
#define OVC_OTAR8_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR8_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK8_OMASK (rw) */
#define OVC_OMASK8_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK8_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK8_ONE (r) */
#define OVC_OMASK8_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK8_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR9_OBASE (rw) */
#define OVC_RABR9_OBASE_POS                  _OVC_UL(5)
#define OVC_RABR9_OBASE_LEN                  _OVC_UL(18)

/* OVC_RABR9_FIXVAL (r) */
#define OVC_RABR9_FIXVAL_POS                 _OVC_UL(23)
#define OVC_RABR9_FIXVAL_LEN                 _OVC_UL(5)
...
/* OVC_OTAR9_TBASE (rw) */
#define OVC_OTAR9_TBASE_POS                  _OVC_UL(5)
#define OVC_OTAR9_TBASE_LEN                  _OVC_UL(23)
...
/* OVC_OMASK9_OMASK (rw) */
#define OVC_OMASK9_OMASK_POS                 _OVC_UL(5)
#define OVC_OMASK9_OMASK_LEN                 _OVC_UL(12)

/* OVC_OMASK9_ONE (r) */
#define OVC_OMASK9_ONE_POS                   _OVC_UL(17)
#define OVC_OMASK9_ONE_LEN                   _OVC_UL(11)

/* OVC_RABR10_OBASE (rw) */
#define OVC_RABR10_OBASE_POS                 _OVC_UL(5)
#define OVC_RABR10_OBASE_LEN                 _OVC_UL(18)

/* OVC_RABR10_FIXVAL (r) */
#define OVC_RABR10_FIXVAL_POS                _OVC_UL(23)
#define OVC_RABR10_FIXVAL_LEN                _OVC_UL(5)
...
/* OVC_OTAR10_TBASE (rw) */
#define OVC_OTAR10_TBASE_POS                 _OVC_UL(5)
#define OVC_OTAR10_TBASE_LEN                 _OVC_UL(23)
...
#define OVC_OMASK10_OMASK_POS                _OVC_UL(5)
#define OVC_OMASK10_OMASK_LEN                _OVC_UL(12)

/* OVC_OMASK10_ONE (r) */
#define OVC_OMASK10_ONE_POS                  _OVC_UL(17)
#define OVC_OMASK10_ONE_LEN                  _OVC_UL(11)

/* OVC_RABR11_OBASE (rw) */
#define OVC_RABR11_OBASE_POS                 _OVC_UL(5)
#define OVC_RABR11_OBASE_LEN                 _OVC_UL(18)

/* OVC_RABR11_FIXVAL (r) */
#define OVC_RABR11_FIXVAL_POS                _OVC_UL(23)
#define OVC_RABR11_FIXVAL_LEN                _OVC_UL(5)
...
/* OVC_OTAR11_TBASE (rw) */
#define OVC_OTAR11_TBASE_POS                 _OVC_UL(5)
#define OVC_OTAR11_TBASE_LEN                 _OVC_UL(23)
...
#define OVC_OMASK11_OMASK_POS                _OVC_UL(5)
#define OVC_OMASK11_OMASK_LEN                _OVC_UL(12)

/* OVC_OMASK11_ONE (r) */
#define OVC_OMASK11_ONE_POS                  _OVC_UL(17)
#define OVC_OMASK11_ONE_LEN                  _OVC_UL(11)

/* OVC_RABR12_OBASE (rw) */
#define OVC_RABR12_OBASE_POS                 _OVC_UL(5)
#define OVC_RABR12_OBASE_LEN                 _OVC_UL(18)

/* OVC_RABR12_FIXVAL (r) */
#define OVC_RABR12_FIXVAL_POS                _OVC_UL(23)
#define OVC_RABR12_FIXVAL_LEN                _OVC_UL(5)
...
/* OVC_OTAR12_TBASE (rw) */
#define OVC_OTAR12_TBASE_POS                 _OVC_UL(5)
#define OVC_OTAR12_TBASE_LEN                 _OVC_UL(23)
...
#define OVC_OMASK12_OMASK_POS                _OVC_UL(5)
#define OVC_OMASK12_OMASK_LEN                _OVC_UL(12)

/* OVC_OMASK12_ONE (r) */
#define OVC_OMASK12_ONE_POS                  _OVC_UL(17)
#define OVC_OMASK12_ONE_LEN                  _OVC_UL(11)

/* OVC_RABR13_OBASE (rw) */
#define OVC_RABR13_OBASE_POS                 _OVC_UL(5)
#define OVC_RABR13_OBASE_LEN                 _OVC_UL(18)

/* OVC_RABR13_FIXVAL (r) */
#define OVC_RABR13_FIXVAL_POS                _OVC_UL(23)
#define OVC_RABR13_FIXVAL_LEN                _OVC_UL(5)
...
/* OVC_OTAR13_TBASE (rw) */
#define OVC_OTAR13_TBASE_POS                 _OVC_UL(5)
#define OVC_OTAR13_TBASE_LEN                 _OVC_UL(23)
...
#define OVC_OMASK13_OMASK_POS                _OVC_UL(5)
#define OVC_OMASK13_OMASK_LEN                _OVC_UL(12)

/* OVC_OMASK13_ONE (r) */
#define OVC_OMASK13_ONE_POS                  _OVC_UL(17)
#define OVC_OMASK13_ONE_LEN                  _OVC_UL(11)

/* OVC_RABR14_OBASE (rw) */
#define OVC_RABR14_OBASE_POS                 _OVC_UL(5)
#define OVC_RABR14_OBASE_LEN                 _OVC_UL(18)

/* OVC_RABR14_FIXVAL (r) */
#define OVC_RABR14_FIXVAL_POS                _OVC_UL(23)
#define OVC_RABR14_FIXVAL_LEN                _OVC_UL(5)
...
/* OVC_OTAR14_TBASE (rw) */
#define OVC_OTAR14_TBASE_POS                 _OVC_UL(5)
#define OVC_OTAR14_TBASE_LEN                 _OVC_UL(23)
...
#define OVC_OMASK14_OMASK_POS                _OVC_UL(5)
#define OVC_OMASK14_OMASK_LEN                _OVC_UL(12)

/* OVC_OMASK14_ONE (r) */
#define OVC_OMASK14_ONE_POS                  _OVC_UL(17)
#define OVC_OMASK14_ONE_LEN                  _OVC_UL(11)

/* OVC_RABR15_OBASE (rw) */
#define OVC_RABR15_OBASE_POS                 _OVC_UL(5)
#define OVC_RABR15_OBASE_LEN                 _OVC_UL(18)

/* OVC_RABR15_FIXVAL (r) */
#define OVC_RABR15_FIXVAL_POS                _OVC_UL(23)
#define OVC_RABR15_FIXVAL_LEN                _OVC_UL(5)
...
/* OVC_OTAR15_TBASE (rw) */
#define OVC_OTAR15_TBASE_POS                 _OVC_UL(5)
#define OVC_OTAR15_TBASE_LEN                 _OVC_UL(23)
...
#define OVC_OMASK15_OMASK_POS                _OVC_UL(5)
#define OVC_OMASK15_OMASK_LEN                _OVC_UL(12)

/* OVC_OMASK15_ONE (r) */
#define OVC_OMASK15_ONE_POS                  _OVC_UL(17)
#define OVC_OMASK15_ONE_LEN                  _OVC_UL(11)
...
/* OVC_OENABLE_OVEN (rw) */
#define OVC_OENABLE_OVEN_POS                 _OVC_UL(0)
#define OVC_OENABLE_OVEN_LEN                 _OVC_UL(1)
