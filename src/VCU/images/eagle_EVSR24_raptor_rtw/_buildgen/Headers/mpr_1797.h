 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module MPR on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
#define MPR_CPR3_0U_UPPBND_POS               _MPR_UL(0)
#define MPR_CPR3_0U_UPPBND_LEN               _MPR_UL(32)
...
#define MPR_CPR3_1U_UPPBND_POS               _MPR_UL(0)
#define MPR_CPR3_1U_UPPBND_LEN               _MPR_UL(32)
