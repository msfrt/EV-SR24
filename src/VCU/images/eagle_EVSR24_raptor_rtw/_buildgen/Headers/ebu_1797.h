 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module EBU on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED0[1];        // [0xF8000008...0xF800000B] : reserved space
    ...
    volatile uint32 RESERVED1[1];        // [0xF8000014...0xF8000017] : reserved space
    volatile uint32 ADDRSEL[4];          // [0xF8000018...0xF8000027] : EBU Address Select Registers
    volatile EBU_CS_t CS[4];             // [0xF8000028...0xF0000067] : EBU Bus Chipselect Registers
} EBU_RegMap_t;
...
/* EBU_MODCON_GLOBALCS (rw) */
#define EBU_MODCON_GLOBALCS_POS        _EBU_UL(24)
#define EBU_MODCON_GLOBALCS_LEN        _EBU_UL(4)
...
#define EBU_BUSRAP_CMDDELAY_POS        _EBU_UL(25)
#define EBU_BUSRAP_CMDDELAY_LEN        _EBU_UL(3)
