...
#ifndef _GPTA1_1796_H
#define _GPTA1_1796_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module GPTA1 on Metis
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 RESERVED0[2];        // [0xF0002000...0xF0002007] : reserved space
    volatile uint32 ID;                  // [0xF0002008] : GPTA Module Identification Register
    volatile uint32 RESERVED1[1];        // [0xF000200C...0xF000200F] : reserved space
    volatile uint32 SRSC0;               // [0xF0002010] : GPTA Service Request Clear Register 0
    volatile uint32 SRSS0;               // [0xF0002014] : GPTA Service Request Set Register 0
    volatile uint32 SRSC1;               // [0xF0002018] : GPTA Service Request Clear Register 1
    volatile uint32 SRSS1;               // [0xF000201C] : GPTA Service Request Set Register 1
    volatile uint32 SRSC2;               // [0xF0002020] : GPTA Service Request Clear Register 2
    volatile uint32 SRSS2;               // [0xF0002024] : GPTA Service Request Set Register 2
    volatile uint32 SRSC3;               // [0xF0002028] : GPTA Service Request Clear Register 3
    volatile uint32 SRSS3;               // [0xF000202C] : GPTA Service Request Set Register 3
    volatile uint32 SRNR;                // [0xF0002030] : Service Request Node Redirection Register
    volatile uint32 RESERVED2[1];        // [0xF0002034...0xF0002037] : reserved space
    volatile uint32 MRACTL;              // [0xF0002038] : GPTA Multiplexer Register Array Control Register
    volatile uint32 MRADIN;              // [0xF000203C] : GPTA Multiplexer Register Array Data In Register
    volatile uint32 MRADOUT;             // [0xF0002040] : GPTA Multiplexer Register Array Data Out Register
    volatile uint32 FPCSTAT;             // [0xF0002044] : GPTA Filter and Prescaler Cell Status Register
    volatile uint32 FPCCTR0;             // [0xF0002048] : GPTA Filter and Prescaler Cell Control Register 0
    volatile uint32 FPCTIM0;             // [0xF000204C] : GPTA Filter and Prescaler Cell Timer Register 0
    volatile uint32 FPCCTR1;             // [0xF0002050] : GPTA Filter and Prescaler Cell Control Register 1
    volatile uint32 FPCTIM1;             // [0xF0002054] : GPTA Filter and Prescaler Cell Timer Register 1
    volatile uint32 FPCCTR2;             // [0xF0002058] : GPTA Filter and Prescaler Cell Control Register 2
    volatile uint32 FPCTIM2;             // [0xF000205C] : GPTA Filter and Prescaler Cell Timer Register 2
    volatile uint32 FPCCTR3;             // [0xF0002060] : GPTA Filter and Prescaler Cell Control Register 3
    volatile uint32 FPCTIM3;             // [0xF0002064] : GPTA Filter and Prescaler Cell Timer Register 3
    volatile uint32 FPCCTR4;             // [0xF0002068] : GPTA Filter and Prescaler Cell Control Register 4
    volatile uint32 FPCTIM4;             // [0xF000206C] : GPTA Filter and Prescaler Cell Timer Register 4
    volatile uint32 FPCCTR5;             // [0xF0002070] : GPTA Filter and Prescaler Cell Control Register 5
    volatile uint32 FPCTIM5;             // [0xF0002074] : GPTA Filter and Prescaler Cell Timer Register 5
    volatile uint32 PDLCTR;              // [0xF0002078] : GPTA Phase Discrimination Logic Control Register
    volatile uint32 RESERVED3[1];        // [0xF000207C...0xF000207F] : reserved space
    volatile uint32 DCMCTR0;             // [0xF0002080] : GPTA Duty Cycle Measurement Control Register 0
    volatile uint32 DCMTIM0;             // [0xF0002084] : GPTA Duty Cycle Measurement Timer Register 0
    volatile uint32 DCMCAV0;             // [0xF0002088] : GPTA Duty Cycle Measurement Capture Register 0
    volatile uint32 DCMCOV0;             // [0xF000208C] : GPTA Duty Cycle Measurement Capture/Compare Register 0
    volatile uint32 DCMCTR1;             // [0xF0002090] : GPTA Duty Cycle Measurement Control Register 1
    volatile uint32 DCMTIM1;             // [0xF0002094] : GPTA Duty Cycle Measurement Timer Register 1
    volatile uint32 DCMCAV1;             // [0xF0002098] : GPTA Duty Cycle Measurement Capture Register 1
    volatile uint32 DCMCOV1;             // [0xF000209C] : GPTA Duty Cycle Measurement Capture/Compare Register 1
    volatile uint32 DCMCTR2;             // [0xF00020A0] : GPTA Duty Cycle Measurement Control Register 2
    volatile uint32 DCMTIM2;             // [0xF00020A4] : GPTA Duty Cycle Measurement Timer Register 2
    volatile uint32 DCMCAV2;             // [0xF00020A8] : GPTA Duty Cycle Measurement Capture Register 2
    volatile uint32 DCMCOV2;             // [0xF00020AC] : GPTA Duty Cycle Measurement Capture/Compare Register 2
    volatile uint32 DCMCTR3;             // [0xF00020B0] : GPTA Duty Cycle Measurement Control Register 3
    volatile uint32 DCMTIM3;             // [0xF00020B4] : GPTA Duty Cycle Measurement Timer Register 3
    volatile uint32 DCMCAV3;             // [0xF00020B8] : GPTA Duty Cycle Measurement Capture Register 3
    volatile uint32 DCMCOV3;             // [0xF00020BC] : GPTA Duty Cycle Measurement Capture/Compare Register 3
    volatile uint32 PLLCTR;              // [0xF00020C0] : GPTA Phase Locked Loop Control Register
    volatile uint32 PLLMTI;              // [0xF00020C4] : GPTA Phase Locked Loop Micro Tick Register
    volatile uint32 PLLCNT;              // [0xF00020C8] : GPTA Phase Locked Loop Counter Register
    volatile uint32 PLLSTP;              // [0xF00020CC] : GPTA Phase Locked Loop Step Register
    volatile uint32 PLLREV;              // [0xF00020D0] : GPTA Phase Locked Loop Reload Register
    volatile uint32 PLLDTR;              // [0xF00020D4] : GPTA Phase Locked Loop Delta Register
    volatile uint32 CKBCTR;              // [0xF00020D8] : GPTA Clock Bus Control Register
    volatile uint32 RESERVED4[1];        // [0xF00020DC...0xF00020DF] : reserved space
    volatile uint32 GTCTR0;              // [0xF00020E0] : GPTA Global Timer Control Register 0
    volatile uint32 GTREV0;              // [0xF00020E4] : GPTA Global Timer Reload Value Register 0
    volatile uint32 GTTIM0;              // [0xF00020E8] : GPTA Global Timer Register 0
    volatile uint32 RESERVED5[1];        // [0xF00020EC...0xF00020EF] : reserved space
    volatile uint32 GTCTR1;              // [0xF00020F0] : GPTA Global Timer Control Register 1
    volatile uint32 GTREV1;              // [0xF00020F4] : GPTA Global Timer Reload Value Register 1
    volatile uint32 GTTIM1;              // [0xF00020F8] : GPTA Global Timer Register 1
    volatile uint32 RESERVED6[1];        // [0xF00020FC...0xF00020FF] : reserved space
    GPTA1_GTC_t     GTC[32];             // [0xF0002100] : GPTA Global Timer Cells
    GPTA1_LTC_t     LTC[64];             // [0xF0002180] : GPTA Local  Timer Cells
    volatile uint32 RESERVED7[218];      // [0xF0002400...0xF0002767] : reserved space
    volatile uint32 SRC37;               // [0xF0002768] : GPTA Service Request Control Register 37
    volatile uint32 SRC36;               // [0xF000276C] : GPTA Service Request Control Register 36
    volatile uint32 SRC35;               // [0xF0002770] : GPTA Service Request Control Register 35
    volatile uint32 SRC34;               // [0xF0002774] : GPTA Service Request Control Register 34
    volatile uint32 SRC33;               // [0xF0002778] : GPTA Service Request Control Register 33
    volatile uint32 SRC32;               // [0xF000277C] : GPTA Service Request Control Register 32
    volatile uint32 SRC31;               // [0xF0002780] : GPTA Service Request Control Register 31
    volatile uint32 SRC30;               // [0xF0002784] : GPTA Service Request Control Register 30
    volatile uint32 SRC29;               // [0xF0002788] : GPTA Service Request Control Register 29
    volatile uint32 SRC28;               // [0xF000278C] : GPTA Service Request Control Register 28
    volatile uint32 SRC27;               // [0xF0002790] : GPTA Service Request Control Register 27
    volatile uint32 SRC26;               // [0xF0002794] : GPTA Service Request Control Register 26
    volatile uint32 SRC25;               // [0xF0002798] : GPTA Service Request Control Register 25
    volatile uint32 SRC24;               // [0xF000279C] : GPTA Service Request Control Register 24
    volatile uint32 SRC23;               // [0xF00027A0] : GPTA Service Request Control Register 23
    volatile uint32 SRC22;               // [0xF00027A4] : GPTA Service Request Control Register 22
    volatile uint32 SRC21;               // [0xF00027A8] : GPTA Service Request Control Register 21
    volatile uint32 SRC20;               // [0xF00027AC] : GPTA Service Request Control Register 20
    volatile uint32 SRC19;               // [0xF00027B0] : GPTA Service Request Control Register 19
    volatile uint32 SRC18;               // [0xF00027B4] : GPTA Service Request Control Register 18
    volatile uint32 SRC17;               // [0xF00027B8] : GPTA Service Request Control Register 17
    volatile uint32 SRC16;               // [0xF00027BC] : GPTA Service Request Control Register 16
    volatile uint32 SRC15;               // [0xF00027C0] : GPTA Service Request Control Register 15
    volatile uint32 SRC14;               // [0xF00027C4] : GPTA Service Request Control Register 14
    volatile uint32 SRC13;               // [0xF00027C8] : GPTA Service Request Control Register 13
    volatile uint32 SRC12;               // [0xF00027CC] : GPTA Service Request Control Register 12
    volatile uint32 SRC11;               // [0xF00027D0] : GPTA Service Request Control Register 11
    volatile uint32 SRC10;               // [0xF00027D4] : GPTA Service Request Control Register 10
    volatile uint32 SRC09;               // [0xF00027D8] : GPTA Service Request Control Register 09
    volatile uint32 SRC08;               // [0xF00027DC] : GPTA Service Request Control Register 08
    volatile uint32 SRC07;               // [0xF00027E0] : GPTA Service Request Control Register 07
    volatile uint32 SRC06;               // [0xF00027E4] : GPTA Service Request Control Register 06
    volatile uint32 SRC05;               // [0xF00027E8] : GPTA Service Request Control Register 05
    volatile uint32 SRC04;               // [0xF00027EC] : GPTA Service Request Control Register 04
    volatile uint32 SRC03;               // [0xF00027F0] : GPTA Service Request Control Register 03
    volatile uint32 SRC02;               // [0xF00027F4] : GPTA Service Request Control Register 02
    volatile uint32 SRC01;               // [0xF00027F8] : GPTA Service Request Control Register 01
    volatile uint32 SRC00;               // [0xF00027FC] : GPTA Service Request Control Register 00
} GPTA1_RegMap_t;
...
/* GPTA1_LTCCTR_NE (rw) */
#define GPTA1_LTCCTR_NE_POS            _GPTA1_UL(7)
#define GPTA1_LTCCTR_NE_LEN            _GPTA1_UL(1)
...
/* GPTA1_LTCXR_XS (rw) */
#define GPTA1_LTCXR_XS_POS             _GPTA1_UL(16)
#define GPTA1_LTCXR_XS_LEN             _GPTA1_UL(16)
...
#define GPTA1_PLLDTR_DTR_LEN           _GPTA1_UL(24)
...
/* GPTA1_SRSC1_GTC00 (rwh) */
#define GPTA1_SRSC1_GTC00_POS          _GPTA1_UL(0)
#define GPTA1_SRSC1_GTC00_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC01 (rwh) */
#define GPTA1_SRSC1_GTC01_POS          _GPTA1_UL(1)
#define GPTA1_SRSC1_GTC01_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC02 (rwh) */
#define GPTA1_SRSC1_GTC02_POS          _GPTA1_UL(2)
#define GPTA1_SRSC1_GTC02_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC03 (rwh) */
#define GPTA1_SRSC1_GTC03_POS          _GPTA1_UL(3)
#define GPTA1_SRSC1_GTC03_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC04 (rwh) */
#define GPTA1_SRSC1_GTC04_POS          _GPTA1_UL(4)
#define GPTA1_SRSC1_GTC04_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC05 (rwh) */
#define GPTA1_SRSC1_GTC05_POS          _GPTA1_UL(5)
#define GPTA1_SRSC1_GTC05_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC06 (rwh) */
#define GPTA1_SRSC1_GTC06_POS          _GPTA1_UL(6)
#define GPTA1_SRSC1_GTC06_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC07 (rwh) */
#define GPTA1_SRSC1_GTC07_POS          _GPTA1_UL(7)
#define GPTA1_SRSC1_GTC07_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC08 (rwh) */
#define GPTA1_SRSC1_GTC08_POS          _GPTA1_UL(8)
#define GPTA1_SRSC1_GTC08_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC1_GTC09 (rwh) */
#define GPTA1_SRSC1_GTC09_POS          _GPTA1_UL(9)
#define GPTA1_SRSC1_GTC09_LEN          _GPTA1_UL(1)
...
/* GPTA1_SRSC2_LTC00 (rwh) */
#define GPTA1_SRSC2_LTC00_POS          _GPTA1_UL(0)
#define GPTA1_SRSC2_LTC00_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC01 (rwh) */
#define GPTA1_SRSC2_LTC01_POS          _GPTA1_UL(1)
#define GPTA1_SRSC2_LTC01_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC02 (rwh) */
#define GPTA1_SRSC2_LTC02_POS          _GPTA1_UL(2)
#define GPTA1_SRSC2_LTC02_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC03 (rwh) */
#define GPTA1_SRSC2_LTC03_POS          _GPTA1_UL(3)
#define GPTA1_SRSC2_LTC03_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC04 (rwh) */
#define GPTA1_SRSC2_LTC04_POS          _GPTA1_UL(4)
#define GPTA1_SRSC2_LTC04_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC05 (rwh) */
#define GPTA1_SRSC2_LTC05_POS          _GPTA1_UL(5)
#define GPTA1_SRSC2_LTC05_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC06 (rwh) */
#define GPTA1_SRSC2_LTC06_POS          _GPTA1_UL(6)
#define GPTA1_SRSC2_LTC06_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC07 (rwh) */
#define GPTA1_SRSC2_LTC07_POS          _GPTA1_UL(7)
#define GPTA1_SRSC2_LTC07_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC08 (rwh) */
#define GPTA1_SRSC2_LTC08_POS          _GPTA1_UL(8)
#define GPTA1_SRSC2_LTC08_LEN          _GPTA1_UL(1)

/* GPTA1_SRSC2_LTC09 (rwh) */
#define GPTA1_SRSC2_LTC09_POS          _GPTA1_UL(9)
#define GPTA1_SRSC2_LTC09_LEN          _GPTA1_UL(1)
...
/* GPTA1_SRSS1_GTC00 (rwh) */
#define GPTA1_SRSS1_GTC00_POS          _GPTA1_UL(0)
#define GPTA1_SRSS1_GTC00_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC01 (rwh) */
#define GPTA1_SRSS1_GTC01_POS          _GPTA1_UL(1)
#define GPTA1_SRSS1_GTC01_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC02 (rwh) */
#define GPTA1_SRSS1_GTC02_POS          _GPTA1_UL(2)
#define GPTA1_SRSS1_GTC02_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC03 (rwh) */
#define GPTA1_SRSS1_GTC03_POS          _GPTA1_UL(3)
#define GPTA1_SRSS1_GTC03_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC04 (rwh) */
#define GPTA1_SRSS1_GTC04_POS          _GPTA1_UL(4)
#define GPTA1_SRSS1_GTC04_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC05 (rwh) */
#define GPTA1_SRSS1_GTC05_POS          _GPTA1_UL(5)
#define GPTA1_SRSS1_GTC05_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC06 (rwh) */
#define GPTA1_SRSS1_GTC06_POS          _GPTA1_UL(6)
#define GPTA1_SRSS1_GTC06_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC07 (rwh) */
#define GPTA1_SRSS1_GTC07_POS          _GPTA1_UL(7)
#define GPTA1_SRSS1_GTC07_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC08 (rwh) */
#define GPTA1_SRSS1_GTC08_POS          _GPTA1_UL(8)
#define GPTA1_SRSS1_GTC08_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS1_GTC09 (rwh) */
#define GPTA1_SRSS1_GTC09_POS          _GPTA1_UL(9)
#define GPTA1_SRSS1_GTC09_LEN          _GPTA1_UL(1)
...
/* GPTA1_SRSS2_LTC00 (rwh) */
#define GPTA1_SRSS2_LTC00_POS          _GPTA1_UL(0)
#define GPTA1_SRSS2_LTC00_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC01 (rwh) */
#define GPTA1_SRSS2_LTC01_POS          _GPTA1_UL(1)
#define GPTA1_SRSS2_LTC01_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC02 (rwh) */
#define GPTA1_SRSS2_LTC02_POS          _GPTA1_UL(2)
#define GPTA1_SRSS2_LTC02_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC03 (rwh) */
#define GPTA1_SRSS2_LTC03_POS          _GPTA1_UL(3)
#define GPTA1_SRSS2_LTC03_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC04 (rwh) */
#define GPTA1_SRSS2_LTC04_POS          _GPTA1_UL(4)
#define GPTA1_SRSS2_LTC04_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC05 (rwh) */
#define GPTA1_SRSS2_LTC05_POS          _GPTA1_UL(5)
#define GPTA1_SRSS2_LTC05_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC06 (rwh) */
#define GPTA1_SRSS2_LTC06_POS          _GPTA1_UL(6)
#define GPTA1_SRSS2_LTC06_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC07 (rwh) */
#define GPTA1_SRSS2_LTC07_POS          _GPTA1_UL(7)
#define GPTA1_SRSS2_LTC07_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC08 (rwh) */
#define GPTA1_SRSS2_LTC08_POS          _GPTA1_UL(8)
#define GPTA1_SRSS2_LTC08_LEN          _GPTA1_UL(1)

/* GPTA1_SRSS2_LTC09 (rwh) */
#define GPTA1_SRSS2_LTC09_POS          _GPTA1_UL(9)
#define GPTA1_SRSS2_LTC09_LEN          _GPTA1_UL(1)
