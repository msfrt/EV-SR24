 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P4 on TC1387
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* P4_PDR_PDEXTCLK1 (rw) */
#define P4_PDR_PDEXTCLK1_POS                 _P4_UL(4)
#define P4_PDR_PDEXTCLK1_LEN                 _P4_UL(3)

/* P4_PDR_PDEXTCLK0 (rw) */
#define P4_PDR_PDEXTCLK0_POS                 _P4_UL(16)
#define P4_PDR_PDEXTCLK0_LEN                 _P4_UL(3)
