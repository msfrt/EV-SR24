 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CPS on TC1762
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 RESERVED0[2];        // [0xF0E106E0...0xF0E0FF07] : reserved space
    volatile uint32 ID;                  // [0xF7E0FF08] : CPS Module Identification Register
    volatile uint32 RESERVED1[44];       // [0xF0E0FF0C...0xF0E0FFBB] : reserved space
    volatile uint32 CPU_SBSRC;           // [0xF7E0FFBC] : Software Break Service Request Control Register
    volatile uint32 RESERVED2[12];       // [0xF0E0FFC0...0xF0E0FFEF] : reserved space
