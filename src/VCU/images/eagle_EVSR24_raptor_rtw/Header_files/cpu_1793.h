 ...
 *   TC1793 update
 * 
 * 1.12.0; 3     03.11.2010 MZT2FE
 *   Update macros for mxcr access.
 * 
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CPU on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED0[4];        // [0xF7E19010...0xF7E1901F] : reserved space
    ...
    volatile uint32 RESERVED1[6];        // [0xF7E1902C...0xF7E19043] : reserved space
    ...
    volatile uint32 RESERVED2[113];      // [0xF7E1904C...0xF7E1920F] : reserved space
...
/* CPU_SMACON_RES (r) */
#define CPU_SMACON_RES_POS                   _CPU_UL(6)
#define CPU_SMACON_RES_LEN                   _CPU_UL(2)
...
/* CPU_DIETR_E_INFO (rh) */
#define CPU_DIETR_E_INFO_POS                 _CPU_UL(5)
#define CPU_DIETR_E_INFO_LEN                 _CPU_UL(4)

/* CPU_DIETR_RES (r) */
#define CPU_DIETR_RES_POS                    _CPU_UL(9)
#define CPU_DIETR_RES_LEN                    _CPU_UL(2)

/* CPU_DIETR_IE_DUAL (rh) */
#define CPU_DIETR_IE_DUAL_POS                _CPU_UL(11)
#define CPU_DIETR_IE_DUAL_LEN                _CPU_UL(1)
...
/* CPU_CCDIER_RES (r) */
#define CPU_CCDIER_RES_POS                   _CPU_UL(16)
#define CPU_CCDIER_RES_LEN                   _CPU_UL(16)

/* CPU_MIECON_DSMIEE (rw) */
#define CPU_MIECON_DSMIEE_POS                _CPU_UL(0)
#define CPU_MIECON_DSMIEE_LEN                _CPU_UL(1)

/* CPU_MIECON_DCMIEE (rw) */
#define CPU_MIECON_DCMIEE_POS                _CPU_UL(1)
#define CPU_MIECON_DCMIEE_LEN                _CPU_UL(1)

/* CPU_MIECON_RES (r) */
#define CPU_MIECON_RES_POS                   _CPU_UL(2)
#define CPU_MIECON_RES_LEN                   _CPU_UL(6)

/* CPU_MIECON_PSMIEE (rw) */
#define CPU_MIECON_PSMIEE_POS                _CPU_UL(8)
#define CPU_MIECON_PSMIEE_LEN                _CPU_UL(1)

/* CPU_MIECON_PCMIEE (rw) */
#define CPU_MIECON_PCMIEE_POS                _CPU_UL(9)
#define CPU_MIECON_PCMIEE_LEN                _CPU_UL(1)

/* CPU_MIECON_PBMIEE (rw) */
#define CPU_MIECON_PBMIEE_POS                _CPU_UL(10)
#define CPU_MIECON_PBMIEE_LEN                _CPU_UL(1)
...
/* CPU_MIECON2_DSMSECE (rwh) */
#define CPU_MIECON2_DSMSECE_POS              _CPU_UL(0)
#define CPU_MIECON2_DSMSECE_LEN              _CPU_UL(1)

/* CPU_MIECON2_DCMSECE (rwh) */
#define CPU_MIECON2_DCMSECE_POS              _CPU_UL(1)
#define CPU_MIECON2_DCMSECE_LEN              _CPU_UL(1)

/* CPU_MIECON2_RES (r) */
#define CPU_MIECON2_RES_POS                  _CPU_UL(2)
#define CPU_MIECON2_RES_LEN                  _CPU_UL(6)

/* CPU_MIECON2_PSMSECE (rwh) */
#define CPU_MIECON2_PSMSECE_POS              _CPU_UL(8)
#define CPU_MIECON2_PSMSECE_LEN              _CPU_UL(1)

/* CPU_MIECON2_PCMSECE (rw) */
#define CPU_MIECON2_PCMSECE_POS              _CPU_UL(9)
#define CPU_MIECON2_PCMSECE_LEN              _CPU_UL(1)

/* CPU_MIECON2_PBMSECE (rw) */
#define CPU_MIECON2_PBMSECE_POS              _CPU_UL(10)
#define CPU_MIECON2_PBMSECE_LEN              _CPU_UL(1)
...
/* CPU_PIETR_E_INFO (rh) */
#define CPU_PIETR_E_INFO_POS                 _CPU_UL(5)
#define CPU_PIETR_E_INFO_LEN                 _CPU_UL(4)

/* CPU_PIETR_RES (r) */
#define CPU_PIETR_RES_POS                    _CPU_UL(9)
#define CPU_PIETR_RES_LEN                    _CPU_UL(1)

/* CPU_PIETR_IE_ADDR (r) */
#define CPU_PIETR_IE_ADDR_POS                _CPU_UL(10)
#define CPU_PIETR_IE_ADDR_LEN                _CPU_UL(1)

/* CPU_PIETR_IE_DUAL (r) */
#define CPU_PIETR_IE_DUAL_POS                _CPU_UL(11)
#define CPU_PIETR_IE_DUAL_LEN                _CPU_UL(1)
...
/* CPU_CCPIER_RES (r) */
#define CPU_CCPIER_RES_POS                   _CPU_UL(16)
#define CPU_CCPIER_RES_LEN                   _CPU_UL(16)
