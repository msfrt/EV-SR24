 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SCU on TC1766
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED5[1];        // [0xF000005C...0xF000005F] : reserved space
    ...
    volatile uint32 RESERVED6[1];        // [0xF000006C...0xF000006F] : reserved space
    ...
    volatile uint32 RESERVED7[1];        // [0xF000007C...0xF000007F] : reserved space
    ...
    volatile uint32 RESERVED8[2];        // [0xF00000A0...0xF00000A7] : reserved space
    ...
    volatile uint32 RESERVED9[6];        // [0xF00000B8...0xF00000CF] : reserved space
    ...
    volatile uint32 RESERVED10[8];       // [0xF00000DC...0xF00000FB] : reserved space
    volatile uint32 SSOCON;              // [0xF00000FC] : EMI Test Control Register
} SCU_RegMap_t;
...
/* SCU_PLL_CLC_RSV (rw) */
#define SCU_PLL_CLC_RSV_POS            _SCU_UL(2)
#define SCU_PLL_CLC_RSV_LEN            _SCU_UL(1)
...
/* SCU_CON_CUPA (rw) */
#define SCU_CON_CUPA_POS               _SCU_UL(14)
#define SCU_CON_CUPA_LEN               _SCU_UL(2)
...
/* SCU_DMARS_SEL3 (rw) */
#define SCU_DMARS_SEL3_POS             _SCU_UL(3)
#define SCU_DMARS_SEL3_LEN             _SCU_UL(1)
