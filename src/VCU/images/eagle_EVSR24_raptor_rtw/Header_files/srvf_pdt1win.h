...
#ifndef _SRVF_PDT1WIN_H
#define _SRVF_PDT1WIN_H
...
#define SrvF_PDT1Win_Init(Xi, Yi, State) ((State)->X = (Xi), (State)->Y = (Yi))
...
/** Parameter structure for PDT1Win element                                                       */
typedef struct
{
...
/** State structure for PDT1Win element                                                           */
typedef struct
{
...
extern real32 SrvF_PDT1Win(real32 X, const SrvF_PDT1WinParam_t *Param, SrvF_PDT1WinState_t *State,
                           real32 Dt);
