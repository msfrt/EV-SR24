 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ADC0 on TC1766
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 CLC;                 // [0xF0100400] : ADC Clock Control Register
    volatile uint32 RESERVED0[1];        // [0xF0100404...0xF0100407] : reserved space
    volatile uint32 ID;                  // [0xF0100408] : ADC Module Identification Register
    volatile uint32 FDR;                 // [0xF010040C] : ADC Fractional Divider Register
    volatile uint32 CHCON[16];           // [0xF0100410] : ADC Channel Control Registers
    volatile uint32 RESERVED1[13];       // [0xF0100450...0xF0100483] : reserved space
    volatile uint32 AP;                  // [0xF0100484] : ADC Arbitration Participation Register
    volatile uint32 SAL;                 // [0xF0100488] : ADC Source Arbitration Level Register
    volatile uint32 TTC;                 // [0xF010048C] : ADC Timer Trigger Control Register
    volatile uint32 EXTC;                // [0xF0100490] : ADC External Trigger Control Register
    volatile uint32 RESERVED2[1];        // [0xF0100494...0xF0100497] : reserved space
    volatile uint32 SCON;                // [0xF0100498] : ADC Source Control Register
    volatile uint32 RESERVED3[1];        // [0xF010049C...0xF010049F] : reserved space
    volatile uint32 QUEUET[16];          // [0xF01004A0] : ADC Queue Test Registers
    volatile uint32 RESERVED4[8];        // [0xF01004E0...0xF01004FF] : reserved space
    volatile uint32 LCCON[4];            // [0xF0100500] : ADC Limit Check Control Registers
    volatile uint32 RESERVED5[1];        // [0xF0100510...0xF0100513] : reserved space
    volatile uint32 TCON;                // [0xF0100514] : ADC Timer Control Register
    volatile uint32 CHIN;                // [0xF0100518] : ADC Channel Injection Control Register
    volatile uint32 QR;                  // [0xF010051C] : ADC Queue Register
    volatile uint32 CON;                 // [0xF0100520] : ADC Converter Control Register
    volatile uint32 SCN;                 // [0xF0100524] : ADC Auto Scan Control Register
    volatile uint32 REQ0;                // [0xF0100528] : ADC Conversion Request Register SW0
    volatile uint32 RESERVED6[1];        // [0xF010052C...0xF010052F] : reserved space
    volatile uint32 CHSTAT[16];          // [0xF0100530] : ADC Channel Status Registers
    volatile uint32 QUEUE0;              // [0xF0100570] : ADC Queue Status Register
    volatile uint32 RESERVED7[3];        // [0xF0100574...0xF010057F] : reserved space
    volatile uint32 SW0CRP;              // [0xF0100580] : ADC Software SW0 Conversion Request Pending Register
    volatile uint32 RESERVED8[1];        // [0xF0100584...0xF0100587] : reserved space
    volatile uint32 ASCRP;               // [0xF0100588] : ADC Auto Scan Conversion Request Pending Register
    volatile uint32 RESERVED9[5];        // [0xF010058C...0xF010059F] : reserved space
    volatile uint32 BARRACUDAOUT;        // [0xF01005A0] : ADC Barracuda Out Test Register
    volatile uint32 BARRACUDAIN;         // [0xF01005A4] : ADC Barracuda In Test Register
    volatile uint32 RESERVED10[2];       // [0xF01005A8...0xF01005AF] : reserved space
    volatile uint32 TSTAT;               // [0xF01005B0] : ADC Timer Status Register
    volatile uint32 STAT;                // [0xF01005B4] : ADC Converter Status Register
    volatile uint32 TCRP;                // [0xF01005B8] : ADC Timer Conversion Request Pending Register
    volatile uint32 EXCRP;               // [0xF01005BC] : ADC External Event Conversion Request Pending Register
    volatile uint32 TEST;                // [0xF01005C0] : ADC Test Register
    volatile uint32 RESERVED11[3];       // [0xF01005C4...0xF01005CF] : reserved space
    volatile uint32 MSS0;                // [0xF01005D0] : ADC Module Service Request Status Register 0
    volatile uint32 MSS1;                // [0xF01005D4] : ADC Module Service Request Status Register 1
    volatile uint32 RESERVED12[1];       // [0xF01005D8...0xF01005DB] : reserved space
    volatile uint32 SRNP;                // [0xF01005DC] : ADC Service Request Node Pointer Register
    volatile uint32 RESERVED13[4];       // [0xF01005E0...0xF01005EF] : reserved space
    volatile uint32 SRC3;                // [0xF01005F0] : ADC Service Request Control Register 3
    volatile uint32 SRC2;                // [0xF01005F4] : ADC Service Request Control Register 2
    volatile uint32 SRC1;                // [0xF01005F8] : ADC Service Request Control Register 1
    volatile uint32 SRC0;                // [0xF01005FC] : ADC Service Request Control Register 0
} ADC_RegMap_t;

/* 'extern' declaration for the module struct. */
/* The module's base address will be assigned by the linker/locator. */
extern ADC_RegMap_t ADC0 __attribute__ ((asection (".bss.label_only")));
extern ADC_RegMap_t ADC[1] __attribute__ ((asection (".bss.label_only")));
...
/* ADC0_CON_PCDIS (rw) */
#define ADC0_CON_PCDIS_POS             _ADC_UL(27)
#define ADC0_CON_PCDIS_LEN             _ADC_UL(1)
...
/* ADC0_FDR_SM (rw) */
#define ADC0_FDR_SM_POS                _ADC_UL(11)
#define ADC0_FDR_SM_LEN                _ADC_UL(1)
