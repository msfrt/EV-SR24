 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P12 on TC1797
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 PDR;                 // [0xF0300040] : Port 12 Pad Driver Mode Register
} P12_RegMap_t;
...
/* P12_PDR_PD0 (rw) */
#define P12_PDR_PD0_POS                      _P12_UL(0)
#define P12_PDR_PD0_LEN                      _P12_UL(3)

/* P12_PDR_PD1 (rw) */
#define P12_PDR_PD1_POS                      _P12_UL(4)
#define P12_PDR_PD1_LEN                      _P12_UL(3)
