 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CBS on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* CBS_MCDBBS_BSMLI (rw) */
#define CBS_MCDBBS_BSMLI_POS                 _CBS_UL(2)
#define CBS_MCDBBS_BSMLI_LEN                 _CBS_UL(1)

/* CBS_MCDBBS_BSSRI (rw) */
#define CBS_MCDBBS_BSSRI_POS                 _CBS_UL(3)
#define CBS_MCDBBS_BSSRI_LEN                 _CBS_UL(1)
...
/* CBS_MCDBBSS_BSSMLI (rh) */
#define CBS_MCDBBSS_BSSMLI_POS               _CBS_UL(2)
#define CBS_MCDBBSS_BSSMLI_LEN               _CBS_UL(1)

/* CBS_MCDBBSS_BSSSRI (rh) */
#define CBS_MCDBBSS_BSSSRI_POS               _CBS_UL(3)
#define CBS_MCDBBSS_BSSSRI_LEN               _CBS_UL(1)
...
/* CBS_MCDBBSS_BSCMLI (rh) */
#define CBS_MCDBBSS_BSCMLI_POS               _CBS_UL(10)
#define CBS_MCDBBSS_BSCMLI_LEN               _CBS_UL(1)

/* CBS_MCDBBSS_BSCSRI (rh) */
#define CBS_MCDBBSS_BSCSRI_POS               _CBS_UL(11)
#define CBS_MCDBBSS_BSCSRI_LEN               _CBS_UL(1)
...
/* CBS_MCDSSGC_STCSDM (rw) */
#define CBS_MCDSSGC_STCSDM_POS               _CBS_UL(5)
#define CBS_MCDSSGC_STCSDM_LEN               _CBS_UL(1)

/* CBS_MCDSSGC_STCSHE (rw) */
#define CBS_MCDSSGC_STCSHE_POS               _CBS_UL(6)
#define CBS_MCDSSGC_STCSHE_LEN               _CBS_UL(1)
