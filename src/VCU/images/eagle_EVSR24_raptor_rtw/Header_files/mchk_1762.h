 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module MCHK on TC1762
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    volatile uint32 RESERVED0[2];        // [0xF010C200...0xF010C207] : reserved space
    volatile uint32 ID;                  // [0xF010C208] : MCHK Module Identification Register
    volatile uint32 RESERVED1[1];        // [0xF010C20C...0xF010C20F] : reserved space
    volatile uint32 IR;                  // [0xF010C210] : MCHK Memory Checker Input Register
    volatile uint32 RR;                  // [0xF010C214] : Memory Checker Result Register
    volatile uint32 RESERVED2[2];        // [0xF010C218...0xF010C21F] : reserved space
    volatile uint32 WR;                  // [0xF010C220] : Write Register
} MCHK_RegMap_t;

/* 'extern' declaration for the module struct. */
/* The module's base address will be assigned by the linker/locator. */
extern MCHK_RegMap_t MCHK;
...
#define MCHK_WR_WO_LEN                 _MCHK_UL(31)
