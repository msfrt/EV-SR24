 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P4 on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 IOCR4;               // [0xF0001014] : Port 4 Input/Output Control Register 4
    volatile uint32 IOCR8;               // [0xF0001018] : Port 4 Input/Output Control Register 8
    volatile uint32 IOCR12;              // [0xF000101C] : Port 4 Input/Output Control Register 12
    ...
    volatile uint32 PDR1;                // [0xF0001044] : Port 4 Pad Driver Mode 1 Register
    volatile uint32 RESERVED3[2];        // [0xF0001048...0xF000104F] : reserved space
...
/* P4_PDR0_PD4 (rw) */
#define P4_PDR0_PD4_POS                      _P4_UL(16)
#define P4_PDR0_PD4_LEN                      _P4_UL(3)

/* P4_PDR0_PD5 (rw) */
#define P4_PDR0_PD5_POS                      _P4_UL(20)
#define P4_PDR0_PD5_LEN                      _P4_UL(3)

/* P4_PDR0_PD6 (rw) */
#define P4_PDR0_PD6_POS                      _P4_UL(24)
#define P4_PDR0_PD6_LEN                      _P4_UL(3)

/* P4_PDR0_PD7 (rw) */
#define P4_PDR0_PD7_POS                      _P4_UL(28)
#define P4_PDR0_PD7_LEN                      _P4_UL(3)

/* P4_PDR1_PD8 (rw) */
#define P4_PDR1_PD8_POS                      _P4_UL(0)
#define P4_PDR1_PD8_LEN                      _P4_UL(3)

/* P4_PDR1_PD9 (rw) */
#define P4_PDR1_PD9_POS                      _P4_UL(4)
#define P4_PDR1_PD9_LEN                      _P4_UL(3)

/* P4_PDR1_PD10 (rw) */
#define P4_PDR1_PD10_POS                     _P4_UL(8)
#define P4_PDR1_PD10_LEN                     _P4_UL(3)

/* P4_PDR1_PD11 (rw) */
#define P4_PDR1_PD11_POS                     _P4_UL(12)
#define P4_PDR1_PD11_LEN                     _P4_UL(3)

/* P4_PDR1_PD12 (rw) */
#define P4_PDR1_PD12_POS                     _P4_UL(16)
#define P4_PDR1_PD12_LEN                     _P4_UL(3)

/* P4_PDR1_PD13 (rw) */
#define P4_PDR1_PD13_POS                     _P4_UL(20)
#define P4_PDR1_PD13_LEN                     _P4_UL(3)

/* P4_PDR1_PD14 (rw) */
#define P4_PDR1_PD14_POS                     _P4_UL(24)
#define P4_PDR1_PD14_LEN                     _P4_UL(3)

/* P4_PDR1_PD15 (rw) */
#define P4_PDR1_PD15_POS                     _P4_UL(28)
#define P4_PDR1_PD15_LEN                     _P4_UL(3)
