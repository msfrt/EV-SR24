 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module FADC on Metis
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 CFGR[4];             // [0xF0100320] : Configuration Register Channels
    volatile uint32 ACR[4];              // [0xF0100330] : Analog Control Register Channels
    volatile uint32 RCH[4];              // [0xF0100340] : Conversion Result Register Channels
    volatile uint32 RESERVED1[4];        // [0xF0100350...0xF010035F] : reserved space
    ...
    volatile uint32 RESERVED2[2];        // [0xF0100378...0xF010037F] : reserved space
    ...
    volatile uint32 RESERVED3[2];        // [0xF010038C...0xF0100393] : reserved space
    volatile uint32 FRR1;                // [0xF0100394] : Filter 1 Final Result Register
    volatile uint32 RESERVED4[22];       // [0xF0100398...0xF01003EF] : reserved space
    volatile uint32 SRC3;                // [0xF01003F0] : FADC Service Request Control Register 3
    volatile uint32 SRC2;                // [0xF01003F4] : FADC Service Request Control Register 2
...
/* new bitfield definitions for TC1796 B-step       */
