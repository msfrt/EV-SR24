 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CBS on TC1766
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* CBS_MCDBBSS_BSCMCD (rh) */
#define CBS_MCDBBSS_BSCMCD_POS         _CBS_UL(9)
#define CBS_MCDBBSS_BSCMCD_LEN         _CBS_UL(1)

/* CBS_MCDBBSS_BSCPCP (rh) */
#define CBS_MCDBBSS_BSCPCP_POS         _CBS_UL(12)
#define CBS_MCDBBSS_BSCPCP_LEN         _CBS_UL(1)

/* CBS_MCDBBSS_BSCRB (rh) */
#define CBS_MCDBBSS_BSCRB_POS          _CBS_UL(11)
#define CBS_MCDBBSS_BSCRB_LEN          _CBS_UL(1)
...
/* CBS_MCDBBSS_BSSMCD (rh) */
#define CBS_MCDBBSS_BSSMCD_POS         _CBS_UL(1)
#define CBS_MCDBBSS_BSSMCD_LEN         _CBS_UL(1)

/* CBS_MCDBBSS_BSSPCP (rh) */
#define CBS_MCDBBSS_BSSPCP_POS         _CBS_UL(4)
#define CBS_MCDBBSS_BSSPCP_LEN         _CBS_UL(1)

/* CBS_MCDBBSS_BSSRB (rh) */
#define CBS_MCDBBSS_BSSRB_POS          _CBS_UL(3)
#define CBS_MCDBBSS_BSSRB_LEN          _CBS_UL(1)
...
/* CBS_MCDBBS_BSMCD (rw) */
#define CBS_MCDBBS_BSMCD_POS           _CBS_UL(1)
#define CBS_MCDBBS_BSMCD_LEN           _CBS_UL(1)
...
/* CBS_MCDBBS_BSRB (rw) */
#define CBS_MCDBBS_BSRB_POS            _CBS_UL(3)
#define CBS_MCDBBS_BSRB_LEN            _CBS_UL(1)
...
/* CBS_MCDBBS_BTMCD (rw) */
#define CBS_MCDBBS_BTMCD_POS           _CBS_UL(9)
...
/* CBS_OCNTRL_EECEN (w) */
#define CBS_OCNTRL_EECEN_POS           _CBS_UL(11)
#define CBS_OCNTRL_EECEN_LEN           _CBS_UL(1)

/* CBS_OCNTRL_EECENP (w) */
#define CBS_OCNTRL_EECENP_POS          _CBS_UL(10)
#define CBS_OCNTRL_EECENP_LEN          _CBS_UL(1)
...
/* CBS_OCNTRL_TRCEEC (w) */
#define CBS_OCNTRL_TRCEEC_POS          _CBS_UL(9)
#define CBS_OCNTRL_TRCEEC_LEN          _CBS_UL(1)

/* CBS_OCNTRL_TRCEECP (w) */
#define CBS_OCNTRL_TRCEECP_POS         _CBS_UL(8)
#define CBS_OCNTRL_TRCEECP_LEN         _CBS_UL(1)
...
/* CBS_OSTATE_TRCEEC (rh) */
#define CBS_OSTATE_TRCEEC_POS          _CBS_UL(5)
#define CBS_OSTATE_TRCEEC_LEN          _CBS_UL(1)
