 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module P1 on TC1724
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 PDR0;                // [0xF0000D40] : Port 1 Pad Driver Mode 0 Register
    volatile uint32 PDR1;                // [0xF0000D44] : Port 1 Pad Driver Mode 1 Register
    volatile uint32 RESERVED3[2];        // [0xF0000D48...0xF0000D4F] : reserved space
...
/* P1_PDR0_PD0 (rw) */
#define P1_PDR0_PD0_POS                      _P1_UL(0)
#define P1_PDR0_PD0_LEN                      _P1_UL(3)

/* P1_PDR0_PD1 (rw) */
#define P1_PDR0_PD1_POS                      _P1_UL(4)
#define P1_PDR0_PD1_LEN                      _P1_UL(3)

/* P1_PDR0_PD2 (rw) */
#define P1_PDR0_PD2_POS                      _P1_UL(8)
#define P1_PDR0_PD2_LEN                      _P1_UL(3)

/* P1_PDR0_PD3 (rw) */
#define P1_PDR0_PD3_POS                      _P1_UL(12)
#define P1_PDR0_PD3_LEN                      _P1_UL(3)

/* P1_PDR0_PD4 (rw) */
#define P1_PDR0_PD4_POS                      _P1_UL(16)
#define P1_PDR0_PD4_LEN                      _P1_UL(3)

/* P1_PDR0_PD5 (rw) */
#define P1_PDR0_PD5_POS                      _P1_UL(20)
#define P1_PDR0_PD5_LEN                      _P1_UL(3)

/* P1_PDR0_PD6 (rw) */
#define P1_PDR0_PD6_POS                      _P1_UL(24)
#define P1_PDR0_PD6_LEN                      _P1_UL(3)

/* P1_PDR0_PD7 (rw) */
#define P1_PDR0_PD7_POS                      _P1_UL(28)
#define P1_PDR0_PD7_LEN                      _P1_UL(3)

/* P1_PDR1_PD8 (rw) */
#define P1_PDR1_PD8_POS                      _P1_UL(0)
#define P1_PDR1_PD8_LEN                      _P1_UL(3)

/* P1_PDR1_PD9 (rw) */
#define P1_PDR1_PD9_POS                      _P1_UL(4)
#define P1_PDR1_PD9_LEN                      _P1_UL(3)

/* P1_PDR1_PD10 (rw) */
#define P1_PDR1_PD10_POS                     _P1_UL(8)
#define P1_PDR1_PD10_LEN                     _P1_UL(3)

/* P1_PDR1_PD11 (rw) */
#define P1_PDR1_PD11_POS                     _P1_UL(12)
#define P1_PDR1_PD11_LEN                     _P1_UL(3)

/* P1_PDR1_PD12 (rw) */
#define P1_PDR1_PD12_POS                     _P1_UL(16)
#define P1_PDR1_PD12_LEN                     _P1_UL(3)

/* P1_PDR1_PD13 (rw) */
#define P1_PDR1_PD13_POS                     _P1_UL(20)
#define P1_PDR1_PD13_LEN                     _P1_UL(3)

/* P1_PDR1_PD14 (rw) */
#define P1_PDR1_PD14_POS                     _P1_UL(24)
#define P1_PDR1_PD14_LEN                     _P1_UL(3)

/* P1_PDR1_PD15 (rw) */
#define P1_PDR1_PD15_POS                     _P1_UL(28)
#define P1_PDR1_PD15_LEN                     _P1_UL(3)
