 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module MSC on TC1767
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
/* MSC_ID_MODNUM (r) */
#define MSC_ID_MODNUM_POS                    _MSC_UL(8)
#define MSC_ID_MODNUM_LEN                    _MSC_UL(8)
...
/* MSC0_ID_MODNUM (r) */
#define MSC0_ID_MODNUM_POS                   _MSC_UL(8)
#define MSC0_ID_MODNUM_LEN                   _MSC_UL(8)
