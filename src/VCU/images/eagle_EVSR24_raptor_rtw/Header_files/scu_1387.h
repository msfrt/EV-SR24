 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module SCU on TC1387
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED8[1];        // [0xF00005DC...0xF00005DF] : reserved space
    ...
    volatile uint32 RESERVED13[41];      // [0xF000064C...0xF00006EF] : reserved space
...
/* SCU_PLLERAYCON0_PLLPWD (rw) */
#define SCU_PLLERAYCON0_PLLPWD_POS           _SCU_UL(16)
#define SCU_PLLERAYCON0_PLLPWD_LEN           _SCU_UL(1)
...
#define SCU_PLLERAYCON1_K2DIV_LEN            _SCU_UL(4)
...
#define SCU_DTSCON_CAL_LEN                   _SCU_UL(12)
