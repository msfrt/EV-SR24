...
#ifndef _GPT12_1387_H
#define _GPT12_1387_H
 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module GPT12 on TC1387
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 T2CON;               // [0xF0003410] : Timer 2 Control Register
    volatile uint32 T3CON;               // [0xF0003414] : Timer 3 Control Register
    volatile uint32 T4CON;               // [0xF0003418] : Timer 4 Control Register
    volatile uint32 T5CON;               // [0xF000341C] : Timer 5 Control Register
    volatile uint32 T6CON;               // [0xF0003420] : Timer 6 Control Register
    ...
    volatile uint32 T2;                  // [0xF0003434] : Timer 2 Register
    volatile uint32 T3;                  // [0xF0003438] : Timer 3 Register
    volatile uint32 T4;                  // [0xF000343C] : Timer 4 Register
    volatile uint32 T5;                  // [0xF0003440] : Timer 5 Register
    volatile uint32 T6;                  // [0xF0003444] : Timer 6 Register
...
extern GPT12_RegMap_t GPT120 __attribute__ ((asection (".bss.label_only")));
extern GPT12_RegMap_t GPT121 __attribute__ ((asection (".bss.label_only")));
extern GPT12_RegMap_t GPT12[2] __attribute__ ((asection (".bss.label_only")));
...
#define GPT12_T5CON_T5M_LEN                  _GPT12_UL(2)
...
/* GPT12_T2_Tx (rwh) */
#define GPT12_T2_Tx_POS                      _GPT12_UL(0)
#define GPT12_T2_Tx_LEN                      _GPT12_UL(16)

/* GPT12_T3_Tx (rwh) */
#define GPT12_T3_Tx_POS                      _GPT12_UL(0)
#define GPT12_T3_Tx_LEN                      _GPT12_UL(16)

/* GPT12_T4_Tx (rwh) */
#define GPT12_T4_Tx_POS                      _GPT12_UL(0)
#define GPT12_T4_Tx_LEN                      _GPT12_UL(16)
...
#define GPT120_T5CON_T5M_LEN                 _GPT12_UL(2)
...
/* GPT120_T2_Tx (rwh) */
#define GPT120_T2_Tx_POS                     _GPT12_UL(0)
#define GPT120_T2_Tx_LEN                     _GPT12_UL(16)

/* GPT120_T3_Tx (rwh) */
#define GPT120_T3_Tx_POS                     _GPT12_UL(0)
#define GPT120_T3_Tx_LEN                     _GPT12_UL(16)

/* GPT120_T4_Tx (rwh) */
#define GPT120_T4_Tx_POS                     _GPT12_UL(0)
#define GPT120_T4_Tx_LEN                     _GPT12_UL(16)
...
#define GPT121_T5CON_T5M_LEN                 _GPT12_UL(2)
...
/* GPT121_T2_Tx (rwh) */
#define GPT121_T2_Tx_POS                     _GPT12_UL(0)
#define GPT121_T2_Tx_LEN                     _GPT12_UL(16)

/* GPT121_T3_Tx (rwh) */
#define GPT121_T3_Tx_POS                     _GPT12_UL(0)
#define GPT121_T3_Tx_LEN                     _GPT12_UL(16)

/* GPT121_T4_Tx (rwh) */
#define GPT121_T4_Tx_POS                     _GPT12_UL(0)
#define GPT121_T4_Tx_LEN                     _GPT12_UL(16)
