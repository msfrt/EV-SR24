 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module ADC on TC1793
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 RESERVED0[1];        // [0xF0101004...0xF0101007] : reserved space
    volatile uint32 ID;                  // [0xF0101008] : Module Identification Register
    ...
    volatile uint32 QINR0;               // [0xF010108C] : Queue 0 Input Register
    ...
    volatile uint32 QINR2;               // [0xF01010AC] : Queue 2 Input Register
    ...
    volatile uint32 QINR4;               // [0xF01010CC] : Queue 4 Input Register
    ...
    volatile uint32 BWDENR;              // [0xF0101224] : Broken Wire Detection Enable Register
    volatile uint32 BWDCFGR;             // [0xF0101228] : Broken Wire Detection Configuration Register
    volatile uint32 RESERVED9[108];      // [0xF010122C...0xF01013DB] : reserved space
...
extern ADC_RegMap_t ADC3 __attribute__ ((asection (".bss.label_only")));
extern ADC_RegMap_t ADC[4] __attribute__ ((asection (".bss.label_only")));
...
/* ADC3_ID_MOD_NUMBER (r) */
#define ADC3_ID_MOD_NUMBER_POS               _ADC_UL(16)
#define ADC3_ID_MOD_NUMBER_LEN               _ADC_UL(16)

/* ADC3_ID_MOD_REV (r) */
#define ADC3_ID_MOD_REV_POS                  _ADC_UL(0)
#define ADC3_ID_MOD_REV_LEN                  _ADC_UL(8)

/* ADC3_ID_MOD_TYPE (r) */
#define ADC3_ID_MOD_TYPE_POS                 _ADC_UL(8)
#define ADC3_ID_MOD_TYPE_LEN                 _ADC_UL(8)
...
/* ADC_GLOBCFG_MTMCH (rw) */
#define ADC_GLOBCFG_MTMCH_POS                _ADC_UL(8)
#define ADC_GLOBCFG_MTMCH_LEN                _ADC_UL(4)

/* ADC_GLOBCFG_MTMEN (rw) */
#define ADC_GLOBCFG_MTMEN_POS                _ADC_UL(15)
#define ADC_GLOBCFG_MTMEN_LEN                _ADC_UL(1)
...
#define ADC_RCR_DRCTR_LEN                    _ADC_UL(3)
...
/* ADC_RCR_RFCTR (rw) */
#define ADC_RCR_RFCTR_POS                    _ADC_UL(8)
#define ADC_RCR_RFCTR_LEN                    _ADC_UL(4)
...
/* ADC_BWDENR_EN0 (rw) */
#define ADC_BWDENR_EN0_POS                   _ADC_UL(0)
#define ADC_BWDENR_EN0_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN1 (rw) */
#define ADC_BWDENR_EN1_POS                   _ADC_UL(1)
#define ADC_BWDENR_EN1_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN2 (rw) */
#define ADC_BWDENR_EN2_POS                   _ADC_UL(2)
#define ADC_BWDENR_EN2_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN3 (rw) */
#define ADC_BWDENR_EN3_POS                   _ADC_UL(3)
#define ADC_BWDENR_EN3_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN4 (rw) */
#define ADC_BWDENR_EN4_POS                   _ADC_UL(4)
#define ADC_BWDENR_EN4_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN5 (rw) */
#define ADC_BWDENR_EN5_POS                   _ADC_UL(5)
#define ADC_BWDENR_EN5_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN6 (rw) */
#define ADC_BWDENR_EN6_POS                   _ADC_UL(6)
#define ADC_BWDENR_EN6_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN7 (rw) */
#define ADC_BWDENR_EN7_POS                   _ADC_UL(7)
#define ADC_BWDENR_EN7_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN8 (rw) */
#define ADC_BWDENR_EN8_POS                   _ADC_UL(8)
#define ADC_BWDENR_EN8_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN9 (rw) */
#define ADC_BWDENR_EN9_POS                   _ADC_UL(9)
#define ADC_BWDENR_EN9_LEN                   _ADC_UL(1)

/* ADC_BWDENR_EN10 (rw) */
#define ADC_BWDENR_EN10_POS                  _ADC_UL(10)
#define ADC_BWDENR_EN10_LEN                  _ADC_UL(1)

/* ADC_BWDENR_EN11 (rw) */
#define ADC_BWDENR_EN11_POS                  _ADC_UL(11)
#define ADC_BWDENR_EN11_LEN                  _ADC_UL(1)

/* ADC_BWDENR_EN12 (rw) */
#define ADC_BWDENR_EN12_POS                  _ADC_UL(12)
#define ADC_BWDENR_EN12_LEN                  _ADC_UL(1)

/* ADC_BWDENR_EN13 (rw) */
#define ADC_BWDENR_EN13_POS                  _ADC_UL(13)
#define ADC_BWDENR_EN13_LEN                  _ADC_UL(1)

/* ADC_BWDENR_EN14 (rw) */
#define ADC_BWDENR_EN14_POS                  _ADC_UL(14)
#define ADC_BWDENR_EN14_LEN                  _ADC_UL(1)

/* ADC_BWDENR_EN15 (rw) */
#define ADC_BWDENR_EN15_POS                  _ADC_UL(15)
#define ADC_BWDENR_EN15_LEN                  _ADC_UL(1)

/* ADC_BWDCFGR_CHP (rw) */
#define ADC_BWDCFGR_CHP_POS                  _ADC_UL(0)
#define ADC_BWDCFGR_CHP_LEN                  _ADC_UL(5)
...
/* ADC0_GLOBCFG_MTMCH (rw) */
#define ADC0_GLOBCFG_MTMCH_POS               _ADC_UL(8)
#define ADC0_GLOBCFG_MTMCH_LEN               _ADC_UL(4)

/* ADC0_GLOBCFG_MTMEN (rw) */
#define ADC0_GLOBCFG_MTMEN_POS               _ADC_UL(15)
#define ADC0_GLOBCFG_MTMEN_LEN               _ADC_UL(1)
...
#define ADC0_RCR_DRCTR_LEN                   _ADC_UL(3)
...
/* ADC0_RCR_RFCTR (rw) */
#define ADC0_RCR_RFCTR_POS                   _ADC_UL(8)
#define ADC0_RCR_RFCTR_LEN                   _ADC_UL(4)
...
/* ADC0_BWDENR_EN0 (rw) */
#define ADC0_BWDENR_EN0_POS                  _ADC_UL(0)
#define ADC0_BWDENR_EN0_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN1 (rw) */
#define ADC0_BWDENR_EN1_POS                  _ADC_UL(1)
#define ADC0_BWDENR_EN1_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN2 (rw) */
#define ADC0_BWDENR_EN2_POS                  _ADC_UL(2)
#define ADC0_BWDENR_EN2_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN3 (rw) */
#define ADC0_BWDENR_EN3_POS                  _ADC_UL(3)
#define ADC0_BWDENR_EN3_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN4 (rw) */
#define ADC0_BWDENR_EN4_POS                  _ADC_UL(4)
#define ADC0_BWDENR_EN4_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN5 (rw) */
#define ADC0_BWDENR_EN5_POS                  _ADC_UL(5)
#define ADC0_BWDENR_EN5_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN6 (rw) */
#define ADC0_BWDENR_EN6_POS                  _ADC_UL(6)
#define ADC0_BWDENR_EN6_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN7 (rw) */
#define ADC0_BWDENR_EN7_POS                  _ADC_UL(7)
#define ADC0_BWDENR_EN7_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN8 (rw) */
#define ADC0_BWDENR_EN8_POS                  _ADC_UL(8)
#define ADC0_BWDENR_EN8_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN9 (rw) */
#define ADC0_BWDENR_EN9_POS                  _ADC_UL(9)
#define ADC0_BWDENR_EN9_LEN                  _ADC_UL(1)

/* ADC0_BWDENR_EN10 (rw) */
#define ADC0_BWDENR_EN10_POS                 _ADC_UL(10)
#define ADC0_BWDENR_EN10_LEN                 _ADC_UL(1)

/* ADC0_BWDENR_EN11 (rw) */
#define ADC0_BWDENR_EN11_POS                 _ADC_UL(11)
#define ADC0_BWDENR_EN11_LEN                 _ADC_UL(1)

/* ADC0_BWDENR_EN12 (rw) */
#define ADC0_BWDENR_EN12_POS                 _ADC_UL(12)
#define ADC0_BWDENR_EN12_LEN                 _ADC_UL(1)

/* ADC0_BWDENR_EN13 (rw) */
#define ADC0_BWDENR_EN13_POS                 _ADC_UL(13)
#define ADC0_BWDENR_EN13_LEN                 _ADC_UL(1)

/* ADC0_BWDENR_EN14 (rw) */
#define ADC0_BWDENR_EN14_POS                 _ADC_UL(14)
#define ADC0_BWDENR_EN14_LEN                 _ADC_UL(1)

/* ADC0_BWDENR_EN15 (rw) */
#define ADC0_BWDENR_EN15_POS                 _ADC_UL(15)
#define ADC0_BWDENR_EN15_LEN                 _ADC_UL(1)

/* ADC0_BWDCFGR_CHP (rw) */
#define ADC0_BWDCFGR_CHP_POS                 _ADC_UL(0)
#define ADC0_BWDCFGR_CHP_LEN                 _ADC_UL(5)
...
/* ADC1_GLOBCFG_MTMCH (rw) */
#define ADC1_GLOBCFG_MTMCH_POS               _ADC_UL(8)
#define ADC1_GLOBCFG_MTMCH_LEN               _ADC_UL(4)

/* ADC1_GLOBCFG_MTMEN (rw) */
#define ADC1_GLOBCFG_MTMEN_POS               _ADC_UL(15)
#define ADC1_GLOBCFG_MTMEN_LEN               _ADC_UL(1)
...
#define ADC1_RCR_DRCTR_LEN                   _ADC_UL(3)
...
/* ADC1_RCR_RFCTR (rw) */
#define ADC1_RCR_RFCTR_POS                   _ADC_UL(8)
#define ADC1_RCR_RFCTR_LEN                   _ADC_UL(4)
...
/* ADC1_BWDENR_EN0 (rw) */
#define ADC1_BWDENR_EN0_POS                  _ADC_UL(0)
#define ADC1_BWDENR_EN0_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN1 (rw) */
#define ADC1_BWDENR_EN1_POS                  _ADC_UL(1)
#define ADC1_BWDENR_EN1_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN2 (rw) */
#define ADC1_BWDENR_EN2_POS                  _ADC_UL(2)
#define ADC1_BWDENR_EN2_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN3 (rw) */
#define ADC1_BWDENR_EN3_POS                  _ADC_UL(3)
#define ADC1_BWDENR_EN3_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN4 (rw) */
#define ADC1_BWDENR_EN4_POS                  _ADC_UL(4)
#define ADC1_BWDENR_EN4_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN5 (rw) */
#define ADC1_BWDENR_EN5_POS                  _ADC_UL(5)
#define ADC1_BWDENR_EN5_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN6 (rw) */
#define ADC1_BWDENR_EN6_POS                  _ADC_UL(6)
#define ADC1_BWDENR_EN6_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN7 (rw) */
#define ADC1_BWDENR_EN7_POS                  _ADC_UL(7)
#define ADC1_BWDENR_EN7_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN8 (rw) */
#define ADC1_BWDENR_EN8_POS                  _ADC_UL(8)
#define ADC1_BWDENR_EN8_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN9 (rw) */
#define ADC1_BWDENR_EN9_POS                  _ADC_UL(9)
#define ADC1_BWDENR_EN9_LEN                  _ADC_UL(1)

/* ADC1_BWDENR_EN10 (rw) */
#define ADC1_BWDENR_EN10_POS                 _ADC_UL(10)
#define ADC1_BWDENR_EN10_LEN                 _ADC_UL(1)

/* ADC1_BWDENR_EN11 (rw) */
#define ADC1_BWDENR_EN11_POS                 _ADC_UL(11)
#define ADC1_BWDENR_EN11_LEN                 _ADC_UL(1)

/* ADC1_BWDENR_EN12 (rw) */
#define ADC1_BWDENR_EN12_POS                 _ADC_UL(12)
#define ADC1_BWDENR_EN12_LEN                 _ADC_UL(1)

/* ADC1_BWDENR_EN13 (rw) */
#define ADC1_BWDENR_EN13_POS                 _ADC_UL(13)
#define ADC1_BWDENR_EN13_LEN                 _ADC_UL(1)

/* ADC1_BWDENR_EN14 (rw) */
#define ADC1_BWDENR_EN14_POS                 _ADC_UL(14)
#define ADC1_BWDENR_EN14_LEN                 _ADC_UL(1)

/* ADC1_BWDENR_EN15 (rw) */
#define ADC1_BWDENR_EN15_POS                 _ADC_UL(15)
#define ADC1_BWDENR_EN15_LEN                 _ADC_UL(1)

/* ADC1_BWDCFGR_CHP (rw) */
#define ADC1_BWDCFGR_CHP_POS                 _ADC_UL(0)
#define ADC1_BWDCFGR_CHP_LEN                 _ADC_UL(5)
...
/* ADC2_GLOBCFG_MTMCH (rw) */
#define ADC2_GLOBCFG_MTMCH_POS               _ADC_UL(8)
#define ADC2_GLOBCFG_MTMCH_LEN               _ADC_UL(4)

/* ADC2_GLOBCFG_MTMEN (rw) */
#define ADC2_GLOBCFG_MTMEN_POS               _ADC_UL(15)
#define ADC2_GLOBCFG_MTMEN_LEN               _ADC_UL(1)
...
#define ADC2_RCR_DRCTR_LEN                   _ADC_UL(3)
...
/* ADC2_RCR_RFCTR (rw) */
#define ADC2_RCR_RFCTR_POS                   _ADC_UL(8)
#define ADC2_RCR_RFCTR_LEN                   _ADC_UL(4)
...
/* ADC2_BWDENR_EN0 (rw) */
#define ADC2_BWDENR_EN0_POS                  _ADC_UL(0)
#define ADC2_BWDENR_EN0_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN1 (rw) */
#define ADC2_BWDENR_EN1_POS                  _ADC_UL(1)
#define ADC2_BWDENR_EN1_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN2 (rw) */
#define ADC2_BWDENR_EN2_POS                  _ADC_UL(2)
#define ADC2_BWDENR_EN2_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN3 (rw) */
#define ADC2_BWDENR_EN3_POS                  _ADC_UL(3)
#define ADC2_BWDENR_EN3_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN4 (rw) */
#define ADC2_BWDENR_EN4_POS                  _ADC_UL(4)
#define ADC2_BWDENR_EN4_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN5 (rw) */
#define ADC2_BWDENR_EN5_POS                  _ADC_UL(5)
#define ADC2_BWDENR_EN5_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN6 (rw) */
#define ADC2_BWDENR_EN6_POS                  _ADC_UL(6)
#define ADC2_BWDENR_EN6_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN7 (rw) */
#define ADC2_BWDENR_EN7_POS                  _ADC_UL(7)
#define ADC2_BWDENR_EN7_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN8 (rw) */
#define ADC2_BWDENR_EN8_POS                  _ADC_UL(8)
#define ADC2_BWDENR_EN8_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN9 (rw) */
#define ADC2_BWDENR_EN9_POS                  _ADC_UL(9)
#define ADC2_BWDENR_EN9_LEN                  _ADC_UL(1)

/* ADC2_BWDENR_EN10 (rw) */
#define ADC2_BWDENR_EN10_POS                 _ADC_UL(10)
#define ADC2_BWDENR_EN10_LEN                 _ADC_UL(1)

/* ADC2_BWDENR_EN11 (rw) */
#define ADC2_BWDENR_EN11_POS                 _ADC_UL(11)
#define ADC2_BWDENR_EN11_LEN                 _ADC_UL(1)

/* ADC2_BWDENR_EN12 (rw) */
#define ADC2_BWDENR_EN12_POS                 _ADC_UL(12)
#define ADC2_BWDENR_EN12_LEN                 _ADC_UL(1)

/* ADC2_BWDENR_EN13 (rw) */
#define ADC2_BWDENR_EN13_POS                 _ADC_UL(13)
#define ADC2_BWDENR_EN13_LEN                 _ADC_UL(1)

/* ADC2_BWDENR_EN14 (rw) */
#define ADC2_BWDENR_EN14_POS                 _ADC_UL(14)
#define ADC2_BWDENR_EN14_LEN                 _ADC_UL(1)

/* ADC2_BWDENR_EN15 (rw) */
#define ADC2_BWDENR_EN15_POS                 _ADC_UL(15)
#define ADC2_BWDENR_EN15_LEN                 _ADC_UL(1)

/* ADC2_BWDCFGR_CHP (rw) */
#define ADC2_BWDCFGR_CHP_POS                 _ADC_UL(0)
#define ADC2_BWDCFGR_CHP_LEN                 _ADC_UL(5)
...
/* ADC3_RSIR_GTSEL (rw) */
#define ADC3_RSIR_GTSEL_POS                  _ADC_UL(0)
#define ADC3_RSIR_GTSEL_LEN                  _ADC_UL(3)

/* ADC3_RSIR_TMEN (rw) */
#define ADC3_RSIR_TMEN_POS                   _ADC_UL(4)
#define ADC3_RSIR_TMEN_LEN                   _ADC_UL(1)

/* ADC3_RSIR_GTI (rh) */
#define ADC3_RSIR_GTI_POS                    _ADC_UL(7)
#define ADC3_RSIR_GTI_LEN                    _ADC_UL(1)

/* ADC3_RSIR_TRSEL (rw) */
#define ADC3_RSIR_TRSEL_POS                  _ADC_UL(8)
#define ADC3_RSIR_TRSEL_LEN                  _ADC_UL(3)

/* ADC3_RSIR_FEN (rw) */
#define ADC3_RSIR_FEN_POS                    _ADC_UL(12)
#define ADC3_RSIR_FEN_LEN                    _ADC_UL(1)

/* ADC3_RSIR_REN (rw) */
#define ADC3_RSIR_REN_POS                    _ADC_UL(13)
#define ADC3_RSIR_REN_LEN                    _ADC_UL(1)

/* ADC3_RSIR_TRI (rh) */
#define ADC3_RSIR_TRI_POS                    _ADC_UL(15)
#define ADC3_RSIR_TRI_LEN                    _ADC_UL(1)

/* ADC3_GLOBCTR_DIVA (rw) */
#define ADC3_GLOBCTR_DIVA_POS                _ADC_UL(0)
#define ADC3_GLOBCTR_DIVA_LEN                _ADC_UL(6)

/* ADC3_GLOBCTR_DIVD (rw) */
#define ADC3_GLOBCTR_DIVD_POS                _ADC_UL(6)
#define ADC3_GLOBCTR_DIVD_LEN                _ADC_UL(2)

/* ADC3_GLOBCTR_ANON (rw) */
#define ADC3_GLOBCTR_ANON_POS                _ADC_UL(8)
#define ADC3_GLOBCTR_ANON_LEN                _ADC_UL(2)

/* ADC3_GLOBCTR_ARBRND (rw) */
#define ADC3_GLOBCTR_ARBRND_POS              _ADC_UL(10)
#define ADC3_GLOBCTR_ARBRND_LEN              _ADC_UL(2)

/* ADC3_GLOBCTR_ARBM (rw) */
#define ADC3_GLOBCTR_ARBM_POS                _ADC_UL(15)
#define ADC3_GLOBCTR_ARBM_LEN                _ADC_UL(1)

/* ADC3_GLOBCFG_MTM7 (rw) */
#define ADC3_GLOBCFG_MTM7_POS                _ADC_UL(4)
#define ADC3_GLOBCFG_MTM7_LEN                _ADC_UL(1)

/* ADC3_GLOBCFG_SUCAL (rw) */
#define ADC3_GLOBCFG_SUCAL_POS               _ADC_UL(5)
#define ADC3_GLOBCFG_SUCAL_LEN               _ADC_UL(1)

/* ADC3_GLOBCFG_DPCAL (rw) */
#define ADC3_GLOBCFG_DPCAL_POS               _ADC_UL(6)
#define ADC3_GLOBCFG_DPCAL_LEN               _ADC_UL(1)

/* ADC3_GLOBCFG_MTMCH (rw) */
#define ADC3_GLOBCFG_MTMCH_POS               _ADC_UL(8)
#define ADC3_GLOBCFG_MTMCH_LEN               _ADC_UL(4)

/* ADC3_GLOBCFG_MTMEN (rw) */
#define ADC3_GLOBCFG_MTMEN_POS               _ADC_UL(15)
#define ADC3_GLOBCFG_MTMEN_LEN               _ADC_UL(1)

/* ADC3_GLOBSTR_BUSY (rh) */
#define ADC3_GLOBSTR_BUSY_POS                _ADC_UL(0)
#define ADC3_GLOBSTR_BUSY_LEN                _ADC_UL(1)

/* ADC3_GLOBSTR_SAMPLE (rh) */
#define ADC3_GLOBSTR_SAMPLE_POS              _ADC_UL(1)
#define ADC3_GLOBSTR_SAMPLE_LEN              _ADC_UL(1)

/* ADC3_GLOBSTR_CAL (rh) */
#define ADC3_GLOBSTR_CAL_POS                 _ADC_UL(2)
#define ADC3_GLOBSTR_CAL_LEN                 _ADC_UL(1)

/* ADC3_GLOBSTR_CHNR (rh) */
#define ADC3_GLOBSTR_CHNR_POS                _ADC_UL(3)
#define ADC3_GLOBSTR_CHNR_LEN                _ADC_UL(4)

/* ADC3_GLOBSTR_ANON (rh) */
#define ADC3_GLOBSTR_ANON_POS                _ADC_UL(8)
#define ADC3_GLOBSTR_ANON_LEN                _ADC_UL(2)

/* ADC3_GLOBSTR_SYNRUN (rh) */
#define ADC3_GLOBSTR_SYNRUN_POS              _ADC_UL(10)
#define ADC3_GLOBSTR_SYNRUN_LEN              _ADC_UL(1)

/* ADC3_GLOBSTR_CSRC (rh) */
#define ADC3_GLOBSTR_CSRC_POS                _ADC_UL(11)
#define ADC3_GLOBSTR_CSRC_LEN                _ADC_UL(3)

/* ADC3_ASENR_ASEN0 (rw) */
#define ADC3_ASENR_ASEN0_POS                 _ADC_UL(0)
#define ADC3_ASENR_ASEN0_LEN                 _ADC_UL(1)

/* ADC3_ASENR_ASEN1 (rw) */
#define ADC3_ASENR_ASEN1_POS                 _ADC_UL(1)
#define ADC3_ASENR_ASEN1_LEN                 _ADC_UL(1)

/* ADC3_ASENR_ASEN2 (rw) */
#define ADC3_ASENR_ASEN2_POS                 _ADC_UL(2)
#define ADC3_ASENR_ASEN2_LEN                 _ADC_UL(1)

/* ADC3_ASENR_ASEN3 (rw) */
#define ADC3_ASENR_ASEN3_POS                 _ADC_UL(3)
#define ADC3_ASENR_ASEN3_LEN                 _ADC_UL(1)

/* ADC3_ASENR_ASEN4 (rw) */
#define ADC3_ASENR_ASEN4_POS                 _ADC_UL(4)
#define ADC3_ASENR_ASEN4_LEN                 _ADC_UL(1)

/* ADC3_RSPR0_PRIO0 (rw) */
#define ADC3_RSPR0_PRIO0_POS                 _ADC_UL(0)
#define ADC3_RSPR0_PRIO0_LEN                 _ADC_UL(2)

/* ADC3_RSPR0_CSM0 (rw) */
#define ADC3_RSPR0_CSM0_POS                  _ADC_UL(3)
#define ADC3_RSPR0_CSM0_LEN                  _ADC_UL(1)

/* ADC3_RSPR0_PRIO1 (rw) */
#define ADC3_RSPR0_PRIO1_POS                 _ADC_UL(4)
#define ADC3_RSPR0_PRIO1_LEN                 _ADC_UL(2)

/* ADC3_RSPR0_CSM1 (rw) */
#define ADC3_RSPR0_CSM1_POS                  _ADC_UL(7)
#define ADC3_RSPR0_CSM1_LEN                  _ADC_UL(1)

/* ADC3_RSPR0_PRIO2 (rw) */
#define ADC3_RSPR0_PRIO2_POS                 _ADC_UL(8)
#define ADC3_RSPR0_PRIO2_LEN                 _ADC_UL(2)

/* ADC3_RSPR0_CSM2 (rw) */
#define ADC3_RSPR0_CSM2_POS                  _ADC_UL(11)
#define ADC3_RSPR0_CSM2_LEN                  _ADC_UL(1)

/* ADC3_RSPR0_PRIO3 (rw) */
#define ADC3_RSPR0_PRIO3_POS                 _ADC_UL(12)
#define ADC3_RSPR0_PRIO3_LEN                 _ADC_UL(2)

/* ADC3_RSPR0_CSM3 (rw) */
#define ADC3_RSPR0_CSM3_POS                  _ADC_UL(15)
#define ADC3_RSPR0_CSM3_LEN                  _ADC_UL(1)

/* ADC3_RSPR4_PRIO4 (rw) */
#define ADC3_RSPR4_PRIO4_POS                 _ADC_UL(0)
#define ADC3_RSPR4_PRIO4_LEN                 _ADC_UL(2)

/* ADC3_RSPR4_CSM4 (rw) */
#define ADC3_RSPR4_CSM4_POS                  _ADC_UL(3)
#define ADC3_RSPR4_CSM4_LEN                  _ADC_UL(1)

/* ADC3_SYNCTR_STSEL (rw) */
#define ADC3_SYNCTR_STSEL_POS                _ADC_UL(0)
#define ADC3_SYNCTR_STSEL_LEN                _ADC_UL(2)

/* ADC3_SYNCTR_EVALR1 (rw) */
#define ADC3_SYNCTR_EVALR1_POS               _ADC_UL(4)
#define ADC3_SYNCTR_EVALR1_LEN               _ADC_UL(1)

/* ADC3_SYNCTR_EVALR2 (rw) */
#define ADC3_SYNCTR_EVALR2_POS               _ADC_UL(5)
#define ADC3_SYNCTR_EVALR2_LEN               _ADC_UL(1)

/* ADC3_SYNCTR_EVALR3 (rw) */
#define ADC3_SYNCTR_EVALR3_POS               _ADC_UL(6)
#define ADC3_SYNCTR_EVALR3_LEN               _ADC_UL(1)

/* ADC3_INPCR_STC (rw) */
#define ADC3_INPCR_STC_POS                   _ADC_UL(0)
#define ADC3_INPCR_STC_LEN                   _ADC_UL(8)

/* ADC3_INPCR_DW (rw) */
#define ADC3_INPCR_DW_POS                    _ADC_UL(8)
#define ADC3_INPCR_DW_LEN                    _ADC_UL(2)

/* ADC3_CHFR_FC0 (rwh) */
#define ADC3_CHFR_FC0_POS                    _ADC_UL(0)
#define ADC3_CHFR_FC0_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC1 (rwh) */
#define ADC3_CHFR_FC1_POS                    _ADC_UL(1)
#define ADC3_CHFR_FC1_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC2 (rwh) */
#define ADC3_CHFR_FC2_POS                    _ADC_UL(2)
#define ADC3_CHFR_FC2_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC3 (rwh) */
#define ADC3_CHFR_FC3_POS                    _ADC_UL(3)
#define ADC3_CHFR_FC3_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC4 (rwh) */
#define ADC3_CHFR_FC4_POS                    _ADC_UL(4)
#define ADC3_CHFR_FC4_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC5 (rwh) */
#define ADC3_CHFR_FC5_POS                    _ADC_UL(5)
#define ADC3_CHFR_FC5_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC6 (rwh) */
#define ADC3_CHFR_FC6_POS                    _ADC_UL(6)
#define ADC3_CHFR_FC6_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC7 (rwh) */
#define ADC3_CHFR_FC7_POS                    _ADC_UL(7)
#define ADC3_CHFR_FC7_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC8 (rwh) */
#define ADC3_CHFR_FC8_POS                    _ADC_UL(8)
#define ADC3_CHFR_FC8_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC9 (rwh) */
#define ADC3_CHFR_FC9_POS                    _ADC_UL(9)
#define ADC3_CHFR_FC9_LEN                    _ADC_UL(1)

/* ADC3_CHFR_FC10 (rwh) */
#define ADC3_CHFR_FC10_POS                   _ADC_UL(10)
#define ADC3_CHFR_FC10_LEN                   _ADC_UL(1)

/* ADC3_CHFR_FC11 (rwh) */
#define ADC3_CHFR_FC11_POS                   _ADC_UL(11)
#define ADC3_CHFR_FC11_LEN                   _ADC_UL(1)

/* ADC3_CHFR_FC12 (rwh) */
#define ADC3_CHFR_FC12_POS                   _ADC_UL(12)
#define ADC3_CHFR_FC12_LEN                   _ADC_UL(1)

/* ADC3_CHFR_FC13 (rwh) */
#define ADC3_CHFR_FC13_POS                   _ADC_UL(13)
#define ADC3_CHFR_FC13_LEN                   _ADC_UL(1)

/* ADC3_CHFR_FC14 (rwh) */
#define ADC3_CHFR_FC14_POS                   _ADC_UL(14)
#define ADC3_CHFR_FC14_LEN                   _ADC_UL(1)

/* ADC3_CHFR_FC15 (rwh) */
#define ADC3_CHFR_FC15_POS                   _ADC_UL(15)
#define ADC3_CHFR_FC15_LEN                   _ADC_UL(1)

/* ADC3_CHFCR_CFC0 (w) */
#define ADC3_CHFCR_CFC0_POS                  _ADC_UL(0)
#define ADC3_CHFCR_CFC0_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC1 (w) */
#define ADC3_CHFCR_CFC1_POS                  _ADC_UL(1)
#define ADC3_CHFCR_CFC1_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC2 (w) */
#define ADC3_CHFCR_CFC2_POS                  _ADC_UL(2)
#define ADC3_CHFCR_CFC2_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC3 (w) */
#define ADC3_CHFCR_CFC3_POS                  _ADC_UL(3)
#define ADC3_CHFCR_CFC3_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC4 (w) */
#define ADC3_CHFCR_CFC4_POS                  _ADC_UL(4)
#define ADC3_CHFCR_CFC4_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC5 (w) */
#define ADC3_CHFCR_CFC5_POS                  _ADC_UL(5)
#define ADC3_CHFCR_CFC5_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC6 (w) */
#define ADC3_CHFCR_CFC6_POS                  _ADC_UL(6)
#define ADC3_CHFCR_CFC6_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC7 (w) */
#define ADC3_CHFCR_CFC7_POS                  _ADC_UL(7)
#define ADC3_CHFCR_CFC7_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC8 (w) */
#define ADC3_CHFCR_CFC8_POS                  _ADC_UL(8)
#define ADC3_CHFCR_CFC8_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC9 (w) */
#define ADC3_CHFCR_CFC9_POS                  _ADC_UL(9)
#define ADC3_CHFCR_CFC9_LEN                  _ADC_UL(1)

/* ADC3_CHFCR_CFC10 (w) */
#define ADC3_CHFCR_CFC10_POS                 _ADC_UL(10)
#define ADC3_CHFCR_CFC10_LEN                 _ADC_UL(1)

/* ADC3_CHFCR_CFC11 (w) */
#define ADC3_CHFCR_CFC11_POS                 _ADC_UL(11)
#define ADC3_CHFCR_CFC11_LEN                 _ADC_UL(1)

/* ADC3_CHFCR_CFC12 (w) */
#define ADC3_CHFCR_CFC12_POS                 _ADC_UL(12)
#define ADC3_CHFCR_CFC12_LEN                 _ADC_UL(1)

/* ADC3_CHFCR_CFC13 (w) */
#define ADC3_CHFCR_CFC13_POS                 _ADC_UL(13)
#define ADC3_CHFCR_CFC13_LEN                 _ADC_UL(1)

/* ADC3_CHFCR_CFC14 (w) */
#define ADC3_CHFCR_CFC14_POS                 _ADC_UL(14)
#define ADC3_CHFCR_CFC14_LEN                 _ADC_UL(1)

/* ADC3_CHFCR_CFC15 (w) */
#define ADC3_CHFCR_CFC15_POS                 _ADC_UL(15)
#define ADC3_CHFCR_CFC15_LEN                 _ADC_UL(1)

/* ADC3_CHENPR0_CHENP0 (rw) */
#define ADC3_CHENPR0_CHENP0_POS              _ADC_UL(0)
#define ADC3_CHENPR0_CHENP0_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP1 (rw) */
#define ADC3_CHENPR0_CHENP1_POS              _ADC_UL(4)
#define ADC3_CHENPR0_CHENP1_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP2 (rw) */
#define ADC3_CHENPR0_CHENP2_POS              _ADC_UL(8)
#define ADC3_CHENPR0_CHENP2_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP3 (rw) */
#define ADC3_CHENPR0_CHENP3_POS              _ADC_UL(12)
#define ADC3_CHENPR0_CHENP3_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP4 (rw) */
#define ADC3_CHENPR0_CHENP4_POS              _ADC_UL(16)
#define ADC3_CHENPR0_CHENP4_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP5 (rw) */
#define ADC3_CHENPR0_CHENP5_POS              _ADC_UL(20)
#define ADC3_CHENPR0_CHENP5_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP6 (rw) */
#define ADC3_CHENPR0_CHENP6_POS              _ADC_UL(24)
#define ADC3_CHENPR0_CHENP6_LEN              _ADC_UL(3)

/* ADC3_CHENPR0_CHENP7 (rw) */
#define ADC3_CHENPR0_CHENP7_POS              _ADC_UL(28)
#define ADC3_CHENPR0_CHENP7_LEN              _ADC_UL(3)

/* ADC3_CHENPR8_CHENP8 (rw) */
#define ADC3_CHENPR8_CHENP8_POS              _ADC_UL(0)
#define ADC3_CHENPR8_CHENP8_LEN              _ADC_UL(3)

/* ADC3_CHENPR8_CHENP9 (rw) */
#define ADC3_CHENPR8_CHENP9_POS              _ADC_UL(4)
#define ADC3_CHENPR8_CHENP9_LEN              _ADC_UL(3)

/* ADC3_CHENPR8_CHENP10 (rw) */
#define ADC3_CHENPR8_CHENP10_POS             _ADC_UL(8)
#define ADC3_CHENPR8_CHENP10_LEN             _ADC_UL(3)

/* ADC3_CHENPR8_CHENP11 (rw) */
#define ADC3_CHENPR8_CHENP11_POS             _ADC_UL(12)
#define ADC3_CHENPR8_CHENP11_LEN             _ADC_UL(3)

/* ADC3_CHENPR8_CHENP12 (rw) */
#define ADC3_CHENPR8_CHENP12_POS             _ADC_UL(16)
#define ADC3_CHENPR8_CHENP12_LEN             _ADC_UL(3)

/* ADC3_CHENPR8_CHENP13 (rw) */
#define ADC3_CHENPR8_CHENP13_POS             _ADC_UL(20)
#define ADC3_CHENPR8_CHENP13_LEN             _ADC_UL(3)

/* ADC3_CHENPR8_CHENP14 (rw) */
#define ADC3_CHENPR8_CHENP14_POS             _ADC_UL(24)
#define ADC3_CHENPR8_CHENP14_LEN             _ADC_UL(3)

/* ADC3_CHENPR8_CHENP15 (rw) */
#define ADC3_CHENPR8_CHENP15_POS             _ADC_UL(28)
#define ADC3_CHENPR8_CHENP15_LEN             _ADC_UL(3)

/* ADC3_EVFR_FR0 (rwh) */
#define ADC3_EVFR_FR0_POS                    _ADC_UL(0)
#define ADC3_EVFR_FR0_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR1 (rwh) */
#define ADC3_EVFR_FR1_POS                    _ADC_UL(1)
#define ADC3_EVFR_FR1_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR2 (rwh) */
#define ADC3_EVFR_FR2_POS                    _ADC_UL(2)
#define ADC3_EVFR_FR2_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR3 (rwh) */
#define ADC3_EVFR_FR3_POS                    _ADC_UL(3)
#define ADC3_EVFR_FR3_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR4 (rwh) */
#define ADC3_EVFR_FR4_POS                    _ADC_UL(4)
#define ADC3_EVFR_FR4_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR5 (rwh) */
#define ADC3_EVFR_FR5_POS                    _ADC_UL(5)
#define ADC3_EVFR_FR5_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR6 (rwh) */
#define ADC3_EVFR_FR6_POS                    _ADC_UL(6)
#define ADC3_EVFR_FR6_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR7 (rwh) */
#define ADC3_EVFR_FR7_POS                    _ADC_UL(7)
#define ADC3_EVFR_FR7_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR8 (rwh) */
#define ADC3_EVFR_FR8_POS                    _ADC_UL(8)
#define ADC3_EVFR_FR8_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR9 (rwh) */
#define ADC3_EVFR_FR9_POS                    _ADC_UL(9)
#define ADC3_EVFR_FR9_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FR10 (rwh) */
#define ADC3_EVFR_FR10_POS                   _ADC_UL(10)
#define ADC3_EVFR_FR10_LEN                   _ADC_UL(1)

/* ADC3_EVFR_FR11 (rwh) */
#define ADC3_EVFR_FR11_POS                   _ADC_UL(11)
#define ADC3_EVFR_FR11_LEN                   _ADC_UL(1)

/* ADC3_EVFR_FR12 (rwh) */
#define ADC3_EVFR_FR12_POS                   _ADC_UL(12)
#define ADC3_EVFR_FR12_LEN                   _ADC_UL(1)

/* ADC3_EVFR_FR13 (rwh) */
#define ADC3_EVFR_FR13_POS                   _ADC_UL(13)
#define ADC3_EVFR_FR13_LEN                   _ADC_UL(1)

/* ADC3_EVFR_FR14 (rwh) */
#define ADC3_EVFR_FR14_POS                   _ADC_UL(14)
#define ADC3_EVFR_FR14_LEN                   _ADC_UL(1)

/* ADC3_EVFR_FR15 (rwh) */
#define ADC3_EVFR_FR15_POS                   _ADC_UL(15)
#define ADC3_EVFR_FR15_LEN                   _ADC_UL(1)

/* ADC3_EVFR_FS0 (rwh) */
#define ADC3_EVFR_FS0_POS                    _ADC_UL(16)
#define ADC3_EVFR_FS0_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FS1 (rwh) */
#define ADC3_EVFR_FS1_POS                    _ADC_UL(17)
#define ADC3_EVFR_FS1_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FS2 (rwh) */
#define ADC3_EVFR_FS2_POS                    _ADC_UL(18)
#define ADC3_EVFR_FS2_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FS3 (rwh) */
#define ADC3_EVFR_FS3_POS                    _ADC_UL(19)
#define ADC3_EVFR_FS3_LEN                    _ADC_UL(1)

/* ADC3_EVFR_FS4 (rwh) */
#define ADC3_EVFR_FS4_POS                    _ADC_UL(20)
#define ADC3_EVFR_FS4_LEN                    _ADC_UL(1)

/* ADC3_EVFR_GFS0 (rh) */
#define ADC3_EVFR_GFS0_POS                   _ADC_UL(24)
#define ADC3_EVFR_GFS0_LEN                   _ADC_UL(1)

/* ADC3_EVFR_GFS1 (rh) */
#define ADC3_EVFR_GFS1_POS                   _ADC_UL(25)
#define ADC3_EVFR_GFS1_LEN                   _ADC_UL(1)

/* ADC3_EVFR_GFS2 (rh) */
#define ADC3_EVFR_GFS2_POS                   _ADC_UL(26)
#define ADC3_EVFR_GFS2_LEN                   _ADC_UL(1)

/* ADC3_EVFR_GFS3 (rh) */
#define ADC3_EVFR_GFS3_POS                   _ADC_UL(27)
#define ADC3_EVFR_GFS3_LEN                   _ADC_UL(1)

/* ADC3_EVFR_GFS4 (rh) */
#define ADC3_EVFR_GFS4_POS                   _ADC_UL(28)
#define ADC3_EVFR_GFS4_LEN                   _ADC_UL(1)

/* ADC3_EVFCR_CFR0 (w) */
#define ADC3_EVFCR_CFR0_POS                  _ADC_UL(0)
#define ADC3_EVFCR_CFR0_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR1 (w) */
#define ADC3_EVFCR_CFR1_POS                  _ADC_UL(1)
#define ADC3_EVFCR_CFR1_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR2 (w) */
#define ADC3_EVFCR_CFR2_POS                  _ADC_UL(2)
#define ADC3_EVFCR_CFR2_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR3 (w) */
#define ADC3_EVFCR_CFR3_POS                  _ADC_UL(3)
#define ADC3_EVFCR_CFR3_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR4 (w) */
#define ADC3_EVFCR_CFR4_POS                  _ADC_UL(4)
#define ADC3_EVFCR_CFR4_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR5 (w) */
#define ADC3_EVFCR_CFR5_POS                  _ADC_UL(5)
#define ADC3_EVFCR_CFR5_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR6 (w) */
#define ADC3_EVFCR_CFR6_POS                  _ADC_UL(6)
#define ADC3_EVFCR_CFR6_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR7 (w) */
#define ADC3_EVFCR_CFR7_POS                  _ADC_UL(7)
#define ADC3_EVFCR_CFR7_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR8 (w) */
#define ADC3_EVFCR_CFR8_POS                  _ADC_UL(8)
#define ADC3_EVFCR_CFR8_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR9 (w) */
#define ADC3_EVFCR_CFR9_POS                  _ADC_UL(9)
#define ADC3_EVFCR_CFR9_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFR10 (w) */
#define ADC3_EVFCR_CFR10_POS                 _ADC_UL(10)
#define ADC3_EVFCR_CFR10_LEN                 _ADC_UL(1)

/* ADC3_EVFCR_CFR11 (w) */
#define ADC3_EVFCR_CFR11_POS                 _ADC_UL(11)
#define ADC3_EVFCR_CFR11_LEN                 _ADC_UL(1)

/* ADC3_EVFCR_CFR12 (w) */
#define ADC3_EVFCR_CFR12_POS                 _ADC_UL(12)
#define ADC3_EVFCR_CFR12_LEN                 _ADC_UL(1)

/* ADC3_EVFCR_CFR13 (w) */
#define ADC3_EVFCR_CFR13_POS                 _ADC_UL(13)
#define ADC3_EVFCR_CFR13_LEN                 _ADC_UL(1)

/* ADC3_EVFCR_CFR14 (w) */
#define ADC3_EVFCR_CFR14_POS                 _ADC_UL(14)
#define ADC3_EVFCR_CFR14_LEN                 _ADC_UL(1)

/* ADC3_EVFCR_CFR15 (w) */
#define ADC3_EVFCR_CFR15_POS                 _ADC_UL(15)
#define ADC3_EVFCR_CFR15_LEN                 _ADC_UL(1)

/* ADC3_EVFCR_CFS0 (w) */
#define ADC3_EVFCR_CFS0_POS                  _ADC_UL(16)
#define ADC3_EVFCR_CFS0_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFS1 (w) */
#define ADC3_EVFCR_CFS1_POS                  _ADC_UL(17)
#define ADC3_EVFCR_CFS1_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFS2 (w) */
#define ADC3_EVFCR_CFS2_POS                  _ADC_UL(18)
#define ADC3_EVFCR_CFS2_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFS3 (w) */
#define ADC3_EVFCR_CFS3_POS                  _ADC_UL(19)
#define ADC3_EVFCR_CFS3_LEN                  _ADC_UL(1)

/* ADC3_EVFCR_CFS4 (w) */
#define ADC3_EVFCR_CFS4_POS                  _ADC_UL(20)
#define ADC3_EVFCR_CFS4_LEN                  _ADC_UL(1)

/* ADC3_EVNPR_SENP0 (rw) */
#define ADC3_EVNPR_SENP0_POS                 _ADC_UL(0)
#define ADC3_EVNPR_SENP0_LEN                 _ADC_UL(3)

/* ADC3_EVNPR_SENP1 (rw) */
#define ADC3_EVNPR_SENP1_POS                 _ADC_UL(4)
#define ADC3_EVNPR_SENP1_LEN                 _ADC_UL(3)

/* ADC3_EVNPR_SENP2 (rw) */
#define ADC3_EVNPR_SENP2_POS                 _ADC_UL(8)
#define ADC3_EVNPR_SENP2_LEN                 _ADC_UL(3)

/* ADC3_EVNPR_SENP3 (rw) */
#define ADC3_EVNPR_SENP3_POS                 _ADC_UL(12)
#define ADC3_EVNPR_SENP3_LEN                 _ADC_UL(3)

/* ADC3_EVNPR_SENP4 (rw) */
#define ADC3_EVNPR_SENP4_POS                 _ADC_UL(16)
#define ADC3_EVNPR_SENP4_LEN                 _ADC_UL(3)

/* ADC3_QMR0_ENGT (rw) */
#define ADC3_QMR0_ENGT_POS                   _ADC_UL(0)
#define ADC3_QMR0_ENGT_LEN                   _ADC_UL(2)

/* ADC3_QMR0_ENTR (rw) */
#define ADC3_QMR0_ENTR_POS                   _ADC_UL(2)
#define ADC3_QMR0_ENTR_LEN                   _ADC_UL(1)

/* ADC3_QMR0_CLRV (w) */
#define ADC3_QMR0_CLRV_POS                   _ADC_UL(8)
#define ADC3_QMR0_CLRV_LEN                   _ADC_UL(1)

/* ADC3_QMR0_TREV (w) */
#define ADC3_QMR0_TREV_POS                   _ADC_UL(9)
#define ADC3_QMR0_TREV_LEN                   _ADC_UL(1)

/* ADC3_QMR0_FLUSH (w) */
#define ADC3_QMR0_FLUSH_POS                  _ADC_UL(10)
#define ADC3_QMR0_FLUSH_LEN                  _ADC_UL(1)

/* ADC3_QMR0_CEV (w) */
#define ADC3_QMR0_CEV_POS                    _ADC_UL(11)
#define ADC3_QMR0_CEV_LEN                    _ADC_UL(1)

/* ADC3_QSR0_FILL (rh) */
#define ADC3_QSR0_FILL_POS                   _ADC_UL(0)
#define ADC3_QSR0_FILL_LEN                   _ADC_UL(4)

/* ADC3_QSR0_EMPTY (rh) */
#define ADC3_QSR0_EMPTY_POS                  _ADC_UL(5)
#define ADC3_QSR0_EMPTY_LEN                  _ADC_UL(1)

/* ADC3_QSR0_REQGT (rh) */
#define ADC3_QSR0_REQGT_POS                  _ADC_UL(7)
#define ADC3_QSR0_REQGT_LEN                  _ADC_UL(1)

/* ADC3_QSR0_EV (rh) */
#define ADC3_QSR0_EV_POS                     _ADC_UL(8)
#define ADC3_QSR0_EV_LEN                     _ADC_UL(1)

/* ADC3_Q0R0_REQCHNR (rh) */
#define ADC3_Q0R0_REQCHNR_POS                _ADC_UL(0)
#define ADC3_Q0R0_REQCHNR_LEN                _ADC_UL(4)

/* ADC3_Q0R0_RF (rh) */
#define ADC3_Q0R0_RF_POS                     _ADC_UL(5)
#define ADC3_Q0R0_RF_LEN                     _ADC_UL(1)

/* ADC3_Q0R0_ENSI (rh) */
#define ADC3_Q0R0_ENSI_POS                   _ADC_UL(6)
#define ADC3_Q0R0_ENSI_LEN                   _ADC_UL(1)

/* ADC3_Q0R0_EXTR (rh) */
#define ADC3_Q0R0_EXTR_POS                   _ADC_UL(7)
#define ADC3_Q0R0_EXTR_LEN                   _ADC_UL(1)

/* ADC3_Q0R0_V (rh) */
#define ADC3_Q0R0_V_POS                      _ADC_UL(8)
#define ADC3_Q0R0_V_LEN                      _ADC_UL(1)

/* ADC3_QBUR0_REQCHNR (rh) */
#define ADC3_QBUR0_REQCHNR_POS               _ADC_UL(0)
#define ADC3_QBUR0_REQCHNR_LEN               _ADC_UL(4)

/* ADC3_QBUR0_RF (rh) */
#define ADC3_QBUR0_RF_POS                    _ADC_UL(5)
#define ADC3_QBUR0_RF_LEN                    _ADC_UL(1)

/* ADC3_QBUR0_ENSI (rh) */
#define ADC3_QBUR0_ENSI_POS                  _ADC_UL(6)
#define ADC3_QBUR0_ENSI_LEN                  _ADC_UL(1)

/* ADC3_QBUR0_EXTR (rh) */
#define ADC3_QBUR0_EXTR_POS                  _ADC_UL(7)
#define ADC3_QBUR0_EXTR_LEN                  _ADC_UL(1)

/* ADC3_QBUR0_V (rh) */
#define ADC3_QBUR0_V_POS                     _ADC_UL(8)
#define ADC3_QBUR0_V_LEN                     _ADC_UL(1)

/* ADC3_QINR0_REQCHNR (w) */
#define ADC3_QINR0_REQCHNR_POS               _ADC_UL(0)
#define ADC3_QINR0_REQCHNR_LEN               _ADC_UL(4)

/* ADC3_QINR0_RF (w) */
#define ADC3_QINR0_RF_POS                    _ADC_UL(5)
#define ADC3_QINR0_RF_LEN                    _ADC_UL(1)

/* ADC3_QINR0_ENSI (w) */
#define ADC3_QINR0_ENSI_POS                  _ADC_UL(6)
#define ADC3_QINR0_ENSI_LEN                  _ADC_UL(1)

/* ADC3_QINR0_EXTR (w) */
#define ADC3_QINR0_EXTR_POS                  _ADC_UL(7)
#define ADC3_QINR0_EXTR_LEN                  _ADC_UL(1)

/* ADC3_CRCR1_CH0 (rwh) */
#define ADC3_CRCR1_CH0_POS                   _ADC_UL(0)
#define ADC3_CRCR1_CH0_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH1 (rwh) */
#define ADC3_CRCR1_CH1_POS                   _ADC_UL(1)
#define ADC3_CRCR1_CH1_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH2 (rwh) */
#define ADC3_CRCR1_CH2_POS                   _ADC_UL(2)
#define ADC3_CRCR1_CH2_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH3 (rwh) */
#define ADC3_CRCR1_CH3_POS                   _ADC_UL(3)
#define ADC3_CRCR1_CH3_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH4 (rwh) */
#define ADC3_CRCR1_CH4_POS                   _ADC_UL(4)
#define ADC3_CRCR1_CH4_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH5 (rwh) */
#define ADC3_CRCR1_CH5_POS                   _ADC_UL(5)
#define ADC3_CRCR1_CH5_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH6 (rwh) */
#define ADC3_CRCR1_CH6_POS                   _ADC_UL(6)
#define ADC3_CRCR1_CH6_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH7 (rwh) */
#define ADC3_CRCR1_CH7_POS                   _ADC_UL(7)
#define ADC3_CRCR1_CH7_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH8 (rwh) */
#define ADC3_CRCR1_CH8_POS                   _ADC_UL(8)
#define ADC3_CRCR1_CH8_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH9 (rwh) */
#define ADC3_CRCR1_CH9_POS                   _ADC_UL(9)
#define ADC3_CRCR1_CH9_LEN                   _ADC_UL(1)

/* ADC3_CRCR1_CH10 (rwh) */
#define ADC3_CRCR1_CH10_POS                  _ADC_UL(10)
#define ADC3_CRCR1_CH10_LEN                  _ADC_UL(1)

/* ADC3_CRCR1_CH11 (rwh) */
#define ADC3_CRCR1_CH11_POS                  _ADC_UL(11)
#define ADC3_CRCR1_CH11_LEN                  _ADC_UL(1)

/* ADC3_CRCR1_CH12 (rwh) */
#define ADC3_CRCR1_CH12_POS                  _ADC_UL(12)
#define ADC3_CRCR1_CH12_LEN                  _ADC_UL(1)

/* ADC3_CRCR1_CH13 (rwh) */
#define ADC3_CRCR1_CH13_POS                  _ADC_UL(13)
#define ADC3_CRCR1_CH13_LEN                  _ADC_UL(1)

/* ADC3_CRCR1_CH14 (rwh) */
#define ADC3_CRCR1_CH14_POS                  _ADC_UL(14)
#define ADC3_CRCR1_CH14_LEN                  _ADC_UL(1)

/* ADC3_CRCR1_CH15 (rwh) */
#define ADC3_CRCR1_CH15_POS                  _ADC_UL(15)
#define ADC3_CRCR1_CH15_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP0 (rwh) */
#define ADC3_CRPR1_CHP0_POS                  _ADC_UL(0)
#define ADC3_CRPR1_CHP0_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP1 (rwh) */
#define ADC3_CRPR1_CHP1_POS                  _ADC_UL(1)
#define ADC3_CRPR1_CHP1_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP2 (rwh) */
#define ADC3_CRPR1_CHP2_POS                  _ADC_UL(2)
#define ADC3_CRPR1_CHP2_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP3 (rwh) */
#define ADC3_CRPR1_CHP3_POS                  _ADC_UL(3)
#define ADC3_CRPR1_CHP3_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP4 (rwh) */
#define ADC3_CRPR1_CHP4_POS                  _ADC_UL(4)
#define ADC3_CRPR1_CHP4_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP5 (rwh) */
#define ADC3_CRPR1_CHP5_POS                  _ADC_UL(5)
#define ADC3_CRPR1_CHP5_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP6 (rwh) */
#define ADC3_CRPR1_CHP6_POS                  _ADC_UL(6)
#define ADC3_CRPR1_CHP6_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP7 (rwh) */
#define ADC3_CRPR1_CHP7_POS                  _ADC_UL(7)
#define ADC3_CRPR1_CHP7_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP8 (rwh) */
#define ADC3_CRPR1_CHP8_POS                  _ADC_UL(8)
#define ADC3_CRPR1_CHP8_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP9 (rwh) */
#define ADC3_CRPR1_CHP9_POS                  _ADC_UL(9)
#define ADC3_CRPR1_CHP9_LEN                  _ADC_UL(1)

/* ADC3_CRPR1_CHP10 (rwh) */
#define ADC3_CRPR1_CHP10_POS                 _ADC_UL(10)
#define ADC3_CRPR1_CHP10_LEN                 _ADC_UL(1)

/* ADC3_CRPR1_CHP11 (rwh) */
#define ADC3_CRPR1_CHP11_POS                 _ADC_UL(11)
#define ADC3_CRPR1_CHP11_LEN                 _ADC_UL(1)

/* ADC3_CRPR1_CHP12 (rwh) */
#define ADC3_CRPR1_CHP12_POS                 _ADC_UL(12)
#define ADC3_CRPR1_CHP12_LEN                 _ADC_UL(1)

/* ADC3_CRPR1_CHP13 (rwh) */
#define ADC3_CRPR1_CHP13_POS                 _ADC_UL(13)
#define ADC3_CRPR1_CHP13_LEN                 _ADC_UL(1)

/* ADC3_CRPR1_CHP14 (rwh) */
#define ADC3_CRPR1_CHP14_POS                 _ADC_UL(14)
#define ADC3_CRPR1_CHP14_LEN                 _ADC_UL(1)

/* ADC3_CRPR1_CHP15 (rwh) */
#define ADC3_CRPR1_CHP15_POS                 _ADC_UL(15)
#define ADC3_CRPR1_CHP15_LEN                 _ADC_UL(1)

/* ADC3_CRMR1_ENGT (rw) */
#define ADC3_CRMR1_ENGT_POS                  _ADC_UL(0)
#define ADC3_CRMR1_ENGT_LEN                  _ADC_UL(2)

/* ADC3_CRMR1_ENTR (rw) */
#define ADC3_CRMR1_ENTR_POS                  _ADC_UL(2)
#define ADC3_CRMR1_ENTR_LEN                  _ADC_UL(1)

/* ADC3_CRMR1_ENSI (rw) */
#define ADC3_CRMR1_ENSI_POS                  _ADC_UL(3)
#define ADC3_CRMR1_ENSI_LEN                  _ADC_UL(1)

/* ADC3_CRMR1_SCAN (rw) */
#define ADC3_CRMR1_SCAN_POS                  _ADC_UL(4)
#define ADC3_CRMR1_SCAN_LEN                  _ADC_UL(1)

/* ADC3_CRMR1_LDM (rw) */
#define ADC3_CRMR1_LDM_POS                   _ADC_UL(5)
#define ADC3_CRMR1_LDM_LEN                   _ADC_UL(1)

/* ADC3_CRMR1_REQGT (rh) */
#define ADC3_CRMR1_REQGT_POS                 _ADC_UL(7)
#define ADC3_CRMR1_REQGT_LEN                 _ADC_UL(1)

/* ADC3_CRMR1_CLRPND (w) */
#define ADC3_CRMR1_CLRPND_POS                _ADC_UL(8)
#define ADC3_CRMR1_CLRPND_LEN                _ADC_UL(1)

/* ADC3_CRMR1_LDEV (w) */
#define ADC3_CRMR1_LDEV_POS                  _ADC_UL(9)
#define ADC3_CRMR1_LDEV_LEN                  _ADC_UL(1)

/* ADC3_QMR2_ENGT (rw) */
#define ADC3_QMR2_ENGT_POS                   _ADC_UL(0)
#define ADC3_QMR2_ENGT_LEN                   _ADC_UL(2)

/* ADC3_QMR2_ENTR (rw) */
#define ADC3_QMR2_ENTR_POS                   _ADC_UL(2)
#define ADC3_QMR2_ENTR_LEN                   _ADC_UL(1)

/* ADC3_QMR2_CLRV (w) */
#define ADC3_QMR2_CLRV_POS                   _ADC_UL(8)
#define ADC3_QMR2_CLRV_LEN                   _ADC_UL(1)

/* ADC3_QMR2_TREV (w) */
#define ADC3_QMR2_TREV_POS                   _ADC_UL(9)
#define ADC3_QMR2_TREV_LEN                   _ADC_UL(1)

/* ADC3_QMR2_FLUSH (w) */
#define ADC3_QMR2_FLUSH_POS                  _ADC_UL(10)
#define ADC3_QMR2_FLUSH_LEN                  _ADC_UL(1)

/* ADC3_QMR2_CEV (w) */
#define ADC3_QMR2_CEV_POS                    _ADC_UL(11)
#define ADC3_QMR2_CEV_LEN                    _ADC_UL(1)

/* ADC3_QSR2_FILL (rh) */
#define ADC3_QSR2_FILL_POS                   _ADC_UL(0)
#define ADC3_QSR2_FILL_LEN                   _ADC_UL(4)

/* ADC3_QSR2_EMPTY (rh) */
#define ADC3_QSR2_EMPTY_POS                  _ADC_UL(5)
#define ADC3_QSR2_EMPTY_LEN                  _ADC_UL(1)

/* ADC3_QSR2_REQGT (rh) */
#define ADC3_QSR2_REQGT_POS                  _ADC_UL(7)
#define ADC3_QSR2_REQGT_LEN                  _ADC_UL(1)

/* ADC3_QSR2_EV (rh) */
#define ADC3_QSR2_EV_POS                     _ADC_UL(8)
#define ADC3_QSR2_EV_LEN                     _ADC_UL(1)

/* ADC3_Q0R2_REQCHNR (rh) */
#define ADC3_Q0R2_REQCHNR_POS                _ADC_UL(0)
#define ADC3_Q0R2_REQCHNR_LEN                _ADC_UL(4)

/* ADC3_Q0R2_RF (rh) */
#define ADC3_Q0R2_RF_POS                     _ADC_UL(5)
#define ADC3_Q0R2_RF_LEN                     _ADC_UL(1)

/* ADC3_Q0R2_ENSI (rh) */
#define ADC3_Q0R2_ENSI_POS                   _ADC_UL(6)
#define ADC3_Q0R2_ENSI_LEN                   _ADC_UL(1)

/* ADC3_Q0R2_EXTR (rh) */
#define ADC3_Q0R2_EXTR_POS                   _ADC_UL(7)
#define ADC3_Q0R2_EXTR_LEN                   _ADC_UL(1)

/* ADC3_Q0R2_V (rh) */
#define ADC3_Q0R2_V_POS                      _ADC_UL(8)
#define ADC3_Q0R2_V_LEN                      _ADC_UL(1)

/* ADC3_QBUR2_REQCHNR (rh) */
#define ADC3_QBUR2_REQCHNR_POS               _ADC_UL(0)
#define ADC3_QBUR2_REQCHNR_LEN               _ADC_UL(4)

/* ADC3_QBUR2_RF (rh) */
#define ADC3_QBUR2_RF_POS                    _ADC_UL(5)
#define ADC3_QBUR2_RF_LEN                    _ADC_UL(1)

/* ADC3_QBUR2_ENSI (rh) */
#define ADC3_QBUR2_ENSI_POS                  _ADC_UL(6)
#define ADC3_QBUR2_ENSI_LEN                  _ADC_UL(1)

/* ADC3_QBUR2_EXTR (rh) */
#define ADC3_QBUR2_EXTR_POS                  _ADC_UL(7)
#define ADC3_QBUR2_EXTR_LEN                  _ADC_UL(1)

/* ADC3_QBUR2_V (rh) */
#define ADC3_QBUR2_V_POS                     _ADC_UL(8)
#define ADC3_QBUR2_V_LEN                     _ADC_UL(1)

/* ADC3_QINR2_REQCHNR (w) */
#define ADC3_QINR2_REQCHNR_POS               _ADC_UL(0)
#define ADC3_QINR2_REQCHNR_LEN               _ADC_UL(4)

/* ADC3_QINR2_RF (w) */
#define ADC3_QINR2_RF_POS                    _ADC_UL(5)
#define ADC3_QINR2_RF_LEN                    _ADC_UL(1)

/* ADC3_QINR2_ENSI (w) */
#define ADC3_QINR2_ENSI_POS                  _ADC_UL(6)
#define ADC3_QINR2_ENSI_LEN                  _ADC_UL(1)

/* ADC3_QINR2_EXTR (w) */
#define ADC3_QINR2_EXTR_POS                  _ADC_UL(7)
#define ADC3_QINR2_EXTR_LEN                  _ADC_UL(1)

/* ADC3_CRCR3_CH0 (rwh) */
#define ADC3_CRCR3_CH0_POS                   _ADC_UL(0)
#define ADC3_CRCR3_CH0_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH1 (rwh) */
#define ADC3_CRCR3_CH1_POS                   _ADC_UL(1)
#define ADC3_CRCR3_CH1_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH2 (rwh) */
#define ADC3_CRCR3_CH2_POS                   _ADC_UL(2)
#define ADC3_CRCR3_CH2_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH3 (rwh) */
#define ADC3_CRCR3_CH3_POS                   _ADC_UL(3)
#define ADC3_CRCR3_CH3_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH4 (rwh) */
#define ADC3_CRCR3_CH4_POS                   _ADC_UL(4)
#define ADC3_CRCR3_CH4_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH5 (rwh) */
#define ADC3_CRCR3_CH5_POS                   _ADC_UL(5)
#define ADC3_CRCR3_CH5_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH6 (rwh) */
#define ADC3_CRCR3_CH6_POS                   _ADC_UL(6)
#define ADC3_CRCR3_CH6_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH7 (rwh) */
#define ADC3_CRCR3_CH7_POS                   _ADC_UL(7)
#define ADC3_CRCR3_CH7_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH8 (rwh) */
#define ADC3_CRCR3_CH8_POS                   _ADC_UL(8)
#define ADC3_CRCR3_CH8_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH9 (rwh) */
#define ADC3_CRCR3_CH9_POS                   _ADC_UL(9)
#define ADC3_CRCR3_CH9_LEN                   _ADC_UL(1)

/* ADC3_CRCR3_CH10 (rwh) */
#define ADC3_CRCR3_CH10_POS                  _ADC_UL(10)
#define ADC3_CRCR3_CH10_LEN                  _ADC_UL(1)

/* ADC3_CRCR3_CH11 (rwh) */
#define ADC3_CRCR3_CH11_POS                  _ADC_UL(11)
#define ADC3_CRCR3_CH11_LEN                  _ADC_UL(1)

/* ADC3_CRCR3_CH12 (rwh) */
#define ADC3_CRCR3_CH12_POS                  _ADC_UL(12)
#define ADC3_CRCR3_CH12_LEN                  _ADC_UL(1)

/* ADC3_CRCR3_CH13 (rwh) */
#define ADC3_CRCR3_CH13_POS                  _ADC_UL(13)
#define ADC3_CRCR3_CH13_LEN                  _ADC_UL(1)

/* ADC3_CRCR3_CH14 (rwh) */
#define ADC3_CRCR3_CH14_POS                  _ADC_UL(14)
#define ADC3_CRCR3_CH14_LEN                  _ADC_UL(1)

/* ADC3_CRCR3_CH15 (rwh) */
#define ADC3_CRCR3_CH15_POS                  _ADC_UL(15)
#define ADC3_CRCR3_CH15_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP0 (rwh) */
#define ADC3_CRPR3_CHP0_POS                  _ADC_UL(0)
#define ADC3_CRPR3_CHP0_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP1 (rwh) */
#define ADC3_CRPR3_CHP1_POS                  _ADC_UL(1)
#define ADC3_CRPR3_CHP1_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP2 (rwh) */
#define ADC3_CRPR3_CHP2_POS                  _ADC_UL(2)
#define ADC3_CRPR3_CHP2_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP3 (rwh) */
#define ADC3_CRPR3_CHP3_POS                  _ADC_UL(3)
#define ADC3_CRPR3_CHP3_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP4 (rwh) */
#define ADC3_CRPR3_CHP4_POS                  _ADC_UL(4)
#define ADC3_CRPR3_CHP4_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP5 (rwh) */
#define ADC3_CRPR3_CHP5_POS                  _ADC_UL(5)
#define ADC3_CRPR3_CHP5_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP6 (rwh) */
#define ADC3_CRPR3_CHP6_POS                  _ADC_UL(6)
#define ADC3_CRPR3_CHP6_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP7 (rwh) */
#define ADC3_CRPR3_CHP7_POS                  _ADC_UL(7)
#define ADC3_CRPR3_CHP7_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP8 (rwh) */
#define ADC3_CRPR3_CHP8_POS                  _ADC_UL(8)
#define ADC3_CRPR3_CHP8_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP9 (rwh) */
#define ADC3_CRPR3_CHP9_POS                  _ADC_UL(9)
#define ADC3_CRPR3_CHP9_LEN                  _ADC_UL(1)

/* ADC3_CRPR3_CHP10 (rwh) */
#define ADC3_CRPR3_CHP10_POS                 _ADC_UL(10)
#define ADC3_CRPR3_CHP10_LEN                 _ADC_UL(1)

/* ADC3_CRPR3_CHP11 (rwh) */
#define ADC3_CRPR3_CHP11_POS                 _ADC_UL(11)
#define ADC3_CRPR3_CHP11_LEN                 _ADC_UL(1)

/* ADC3_CRPR3_CHP12 (rwh) */
#define ADC3_CRPR3_CHP12_POS                 _ADC_UL(12)
#define ADC3_CRPR3_CHP12_LEN                 _ADC_UL(1)

/* ADC3_CRPR3_CHP13 (rwh) */
#define ADC3_CRPR3_CHP13_POS                 _ADC_UL(13)
#define ADC3_CRPR3_CHP13_LEN                 _ADC_UL(1)

/* ADC3_CRPR3_CHP14 (rwh) */
#define ADC3_CRPR3_CHP14_POS                 _ADC_UL(14)
#define ADC3_CRPR3_CHP14_LEN                 _ADC_UL(1)

/* ADC3_CRPR3_CHP15 (rwh) */
#define ADC3_CRPR3_CHP15_POS                 _ADC_UL(15)
#define ADC3_CRPR3_CHP15_LEN                 _ADC_UL(1)

/* ADC3_CRMR3_ENGT (rw) */
#define ADC3_CRMR3_ENGT_POS                  _ADC_UL(0)
#define ADC3_CRMR3_ENGT_LEN                  _ADC_UL(2)

/* ADC3_CRMR3_ENTR (rw) */
#define ADC3_CRMR3_ENTR_POS                  _ADC_UL(2)
#define ADC3_CRMR3_ENTR_LEN                  _ADC_UL(1)

/* ADC3_CRMR3_ENSI (rw) */
#define ADC3_CRMR3_ENSI_POS                  _ADC_UL(3)
#define ADC3_CRMR3_ENSI_LEN                  _ADC_UL(1)

/* ADC3_CRMR3_SCAN (rw) */
#define ADC3_CRMR3_SCAN_POS                  _ADC_UL(4)
#define ADC3_CRMR3_SCAN_LEN                  _ADC_UL(1)

/* ADC3_CRMR3_LDM (rw) */
#define ADC3_CRMR3_LDM_POS                   _ADC_UL(5)
#define ADC3_CRMR3_LDM_LEN                   _ADC_UL(1)

/* ADC3_CRMR3_REQGT (rh) */
#define ADC3_CRMR3_REQGT_POS                 _ADC_UL(7)
#define ADC3_CRMR3_REQGT_LEN                 _ADC_UL(1)

/* ADC3_CRMR3_CLRPND (w) */
#define ADC3_CRMR3_CLRPND_POS                _ADC_UL(8)
#define ADC3_CRMR3_CLRPND_LEN                _ADC_UL(1)

/* ADC3_CRMR3_LDEV (w) */
#define ADC3_CRMR3_LDEV_POS                  _ADC_UL(9)
#define ADC3_CRMR3_LDEV_LEN                  _ADC_UL(1)

/* ADC3_QMR4_ENGT (rw) */
#define ADC3_QMR4_ENGT_POS                   _ADC_UL(0)
#define ADC3_QMR4_ENGT_LEN                   _ADC_UL(2)

/* ADC3_QMR4_ENTR (rw) */
#define ADC3_QMR4_ENTR_POS                   _ADC_UL(2)
#define ADC3_QMR4_ENTR_LEN                   _ADC_UL(1)

/* ADC3_QMR4_CLRV (w) */
#define ADC3_QMR4_CLRV_POS                   _ADC_UL(8)
#define ADC3_QMR4_CLRV_LEN                   _ADC_UL(1)

/* ADC3_QMR4_TREV (w) */
#define ADC3_QMR4_TREV_POS                   _ADC_UL(9)
#define ADC3_QMR4_TREV_LEN                   _ADC_UL(1)

/* ADC3_QMR4_FLUSH (w) */
#define ADC3_QMR4_FLUSH_POS                  _ADC_UL(10)
#define ADC3_QMR4_FLUSH_LEN                  _ADC_UL(1)

/* ADC3_QMR4_CEV (w) */
#define ADC3_QMR4_CEV_POS                    _ADC_UL(11)
#define ADC3_QMR4_CEV_LEN                    _ADC_UL(1)

/* ADC3_QSR4_FILL (rh) */
#define ADC3_QSR4_FILL_POS                   _ADC_UL(0)
#define ADC3_QSR4_FILL_LEN                   _ADC_UL(4)

/* ADC3_QSR4_EMPTY (rh) */
#define ADC3_QSR4_EMPTY_POS                  _ADC_UL(5)
#define ADC3_QSR4_EMPTY_LEN                  _ADC_UL(1)

/* ADC3_QSR4_REQGT (rh) */
#define ADC3_QSR4_REQGT_POS                  _ADC_UL(7)
#define ADC3_QSR4_REQGT_LEN                  _ADC_UL(1)

/* ADC3_QSR4_EV (rh) */
#define ADC3_QSR4_EV_POS                     _ADC_UL(8)
#define ADC3_QSR4_EV_LEN                     _ADC_UL(1)

/* ADC3_Q0R4_REQCHNR (rh) */
#define ADC3_Q0R4_REQCHNR_POS                _ADC_UL(0)
#define ADC3_Q0R4_REQCHNR_LEN                _ADC_UL(4)

/* ADC3_Q0R4_RF (rh) */
#define ADC3_Q0R4_RF_POS                     _ADC_UL(5)
#define ADC3_Q0R4_RF_LEN                     _ADC_UL(1)

/* ADC3_Q0R4_ENSI (rh) */
#define ADC3_Q0R4_ENSI_POS                   _ADC_UL(6)
#define ADC3_Q0R4_ENSI_LEN                   _ADC_UL(1)

/* ADC3_Q0R4_EXTR (rh) */
#define ADC3_Q0R4_EXTR_POS                   _ADC_UL(7)
#define ADC3_Q0R4_EXTR_LEN                   _ADC_UL(1)

/* ADC3_Q0R4_V (rh) */
#define ADC3_Q0R4_V_POS                      _ADC_UL(8)
#define ADC3_Q0R4_V_LEN                      _ADC_UL(1)

/* ADC3_QBUR4_REQCHNR (rh) */
#define ADC3_QBUR4_REQCHNR_POS               _ADC_UL(0)
#define ADC3_QBUR4_REQCHNR_LEN               _ADC_UL(4)

/* ADC3_QBUR4_RF (rh) */
#define ADC3_QBUR4_RF_POS                    _ADC_UL(5)
#define ADC3_QBUR4_RF_LEN                    _ADC_UL(1)

/* ADC3_QBUR4_ENSI (rh) */
#define ADC3_QBUR4_ENSI_POS                  _ADC_UL(6)
#define ADC3_QBUR4_ENSI_LEN                  _ADC_UL(1)

/* ADC3_QBUR4_EXTR (rh) */
#define ADC3_QBUR4_EXTR_POS                  _ADC_UL(7)
#define ADC3_QBUR4_EXTR_LEN                  _ADC_UL(1)

/* ADC3_QBUR4_V (rh) */
#define ADC3_QBUR4_V_POS                     _ADC_UL(8)
#define ADC3_QBUR4_V_LEN                     _ADC_UL(1)

/* ADC3_QINR4_REQCHNR (w) */
#define ADC3_QINR4_REQCHNR_POS               _ADC_UL(0)
#define ADC3_QINR4_REQCHNR_LEN               _ADC_UL(4)

/* ADC3_QINR4_RF (w) */
#define ADC3_QINR4_RF_POS                    _ADC_UL(5)
#define ADC3_QINR4_RF_LEN                    _ADC_UL(1)

/* ADC3_QINR4_ENSI (w) */
#define ADC3_QINR4_ENSI_POS                  _ADC_UL(6)
#define ADC3_QINR4_ENSI_LEN                  _ADC_UL(1)

/* ADC3_QINR4_EXTR (w) */
#define ADC3_QINR4_EXTR_POS                  _ADC_UL(7)
#define ADC3_QINR4_EXTR_LEN                  _ADC_UL(1)

/* ADC3_LCBR_BOUNDARY (rw) */
#define ADC3_LCBR_BOUNDARY_POS               _ADC_UL(2)
#define ADC3_LCBR_BOUNDARY_LEN               _ADC_UL(10)

/* ADC3_CHCTR_BNDASEL (rw) */
#define ADC3_CHCTR_BNDASEL_POS               _ADC_UL(0)
#define ADC3_CHCTR_BNDASEL_LEN               _ADC_UL(2)

/* ADC3_CHCTR_BNDBSEL (rw) */
#define ADC3_CHCTR_BNDBSEL_POS               _ADC_UL(2)
#define ADC3_CHCTR_BNDBSEL_LEN               _ADC_UL(2)

/* ADC3_CHCTR_LCC (rw) */
#define ADC3_CHCTR_LCC_POS                   _ADC_UL(4)
#define ADC3_CHCTR_LCC_LEN                   _ADC_UL(3)

/* ADC3_CHCTR_SYNC (rw) */
#define ADC3_CHCTR_SYNC_POS                  _ADC_UL(7)
#define ADC3_CHCTR_SYNC_LEN                  _ADC_UL(1)

/* ADC3_CHCTR_REFSEL (rw) */
#define ADC3_CHCTR_REFSEL_POS                _ADC_UL(8)
#define ADC3_CHCTR_REFSEL_LEN                _ADC_UL(2)

/* ADC3_CHCTR_ICLSEL (rw) */
#define ADC3_CHCTR_ICLSEL_POS                _ADC_UL(10)
#define ADC3_CHCTR_ICLSEL_LEN                _ADC_UL(2)

/* ADC3_CHCTR_RESRSEL (rw) */
#define ADC3_CHCTR_RESRSEL_POS               _ADC_UL(12)
#define ADC3_CHCTR_RESRSEL_LEN               _ADC_UL(4)

/* ADC3_RCR_DRCTR (rw) */
#define ADC3_RCR_DRCTR_POS                   _ADC_UL(0)
#define ADC3_RCR_DRCTR_LEN                   _ADC_UL(3)

/* ADC3_RCR_ENRI (rw) */
#define ADC3_RCR_ENRI_POS                    _ADC_UL(4)
#define ADC3_RCR_ENRI_LEN                    _ADC_UL(1)

/* ADC3_RCR_FEN (rw) */
#define ADC3_RCR_FEN_POS                     _ADC_UL(5)
#define ADC3_RCR_FEN_LEN                     _ADC_UL(1)

/* ADC3_RCR_WFR (rw) */
#define ADC3_RCR_WFR_POS                     _ADC_UL(6)
#define ADC3_RCR_WFR_LEN                     _ADC_UL(1)

/* ADC3_RCR_RFCTR (rw) */
#define ADC3_RCR_RFCTR_POS                   _ADC_UL(8)
#define ADC3_RCR_RFCTR_LEN                   _ADC_UL(4)

/* ADC3_RESR_RESULT (rh) */
#define ADC3_RESR_RESULT_POS                 _ADC_UL(0)
#define ADC3_RESR_RESULT_LEN                 _ADC_UL(14)

/* ADC3_RESR_EMUX (rh) */
#define ADC3_RESR_EMUX_POS                   _ADC_UL(16)
#define ADC3_RESR_EMUX_LEN                   _ADC_UL(3)

/* ADC3_RESR_CRS (rh) */
#define ADC3_RESR_CRS_POS                    _ADC_UL(20)
#define ADC3_RESR_CRS_LEN                    _ADC_UL(3)

/* ADC3_RESR_CHNR (rh) */
#define ADC3_RESR_CHNR_POS                   _ADC_UL(24)
#define ADC3_RESR_CHNR_LEN                   _ADC_UL(4)

/* ADC3_RESR_DRC (rh) */
#define ADC3_RESR_DRC_POS                    _ADC_UL(29)
#define ADC3_RESR_DRC_LEN                    _ADC_UL(2)

/* ADC3_RESR_VF (rh) */
#define ADC3_RESR_VF_POS                     _ADC_UL(31)
#define ADC3_RESR_VF_LEN                     _ADC_UL(1)

/* ADC3_RESRD_RESULT (rh) */
#define ADC3_RESRD_RESULT_POS                _ADC_UL(0)
#define ADC3_RESRD_RESULT_LEN                _ADC_UL(14)

/* ADC3_RESRD_EMUX (rh) */
#define ADC3_RESRD_EMUX_POS                  _ADC_UL(16)
#define ADC3_RESRD_EMUX_LEN                  _ADC_UL(3)

/* ADC3_RESRD_CRS (rh) */
#define ADC3_RESRD_CRS_POS                   _ADC_UL(20)
#define ADC3_RESRD_CRS_LEN                   _ADC_UL(3)

/* ADC3_RESRD_CHNR (rh) */
#define ADC3_RESRD_CHNR_POS                  _ADC_UL(24)
#define ADC3_RESRD_CHNR_LEN                  _ADC_UL(4)

/* ADC3_RESRD_DRC (rh) */
#define ADC3_RESRD_DRC_POS                   _ADC_UL(29)
#define ADC3_RESRD_DRC_LEN                   _ADC_UL(2)

/* ADC3_RESRD_VF (rh) */
#define ADC3_RESRD_VF_POS                    _ADC_UL(31)
#define ADC3_RESRD_VF_LEN                    _ADC_UL(1)

/* ADC3_VFR_VF0 (rwh) */
#define ADC3_VFR_VF0_POS                     _ADC_UL(0)
#define ADC3_VFR_VF0_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF1 (rwh) */
#define ADC3_VFR_VF1_POS                     _ADC_UL(1)
#define ADC3_VFR_VF1_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF2 (rwh) */
#define ADC3_VFR_VF2_POS                     _ADC_UL(2)
#define ADC3_VFR_VF2_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF3 (rwh) */
#define ADC3_VFR_VF3_POS                     _ADC_UL(3)
#define ADC3_VFR_VF3_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF4 (rwh) */
#define ADC3_VFR_VF4_POS                     _ADC_UL(4)
#define ADC3_VFR_VF4_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF5 (rwh) */
#define ADC3_VFR_VF5_POS                     _ADC_UL(5)
#define ADC3_VFR_VF5_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF6 (rwh) */
#define ADC3_VFR_VF6_POS                     _ADC_UL(6)
#define ADC3_VFR_VF6_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF7 (rwh) */
#define ADC3_VFR_VF7_POS                     _ADC_UL(7)
#define ADC3_VFR_VF7_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF8 (rwh) */
#define ADC3_VFR_VF8_POS                     _ADC_UL(8)
#define ADC3_VFR_VF8_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF9 (rwh) */
#define ADC3_VFR_VF9_POS                     _ADC_UL(9)
#define ADC3_VFR_VF9_LEN                     _ADC_UL(1)

/* ADC3_VFR_VF10 (rwh) */
#define ADC3_VFR_VF10_POS                    _ADC_UL(10)
#define ADC3_VFR_VF10_LEN                    _ADC_UL(1)

/* ADC3_VFR_VF11 (rwh) */
#define ADC3_VFR_VF11_POS                    _ADC_UL(11)
#define ADC3_VFR_VF11_LEN                    _ADC_UL(1)

/* ADC3_VFR_VF12 (rwh) */
#define ADC3_VFR_VF12_POS                    _ADC_UL(12)
#define ADC3_VFR_VF12_LEN                    _ADC_UL(1)

/* ADC3_VFR_VF13 (rwh) */
#define ADC3_VFR_VF13_POS                    _ADC_UL(13)
#define ADC3_VFR_VF13_LEN                    _ADC_UL(1)

/* ADC3_VFR_VF14 (rwh) */
#define ADC3_VFR_VF14_POS                    _ADC_UL(14)
#define ADC3_VFR_VF14_LEN                    _ADC_UL(1)

/* ADC3_VFR_VF15 (rwh) */
#define ADC3_VFR_VF15_POS                    _ADC_UL(15)
#define ADC3_VFR_VF15_LEN                    _ADC_UL(1)

/* ADC3_INTR_SISR0 (w) */
#define ADC3_INTR_SISR0_POS                  _ADC_UL(0)
#define ADC3_INTR_SISR0_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR1 (w) */
#define ADC3_INTR_SISR1_POS                  _ADC_UL(1)
#define ADC3_INTR_SISR1_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR2 (w) */
#define ADC3_INTR_SISR2_POS                  _ADC_UL(2)
#define ADC3_INTR_SISR2_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR3 (w) */
#define ADC3_INTR_SISR3_POS                  _ADC_UL(3)
#define ADC3_INTR_SISR3_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR4 (w) */
#define ADC3_INTR_SISR4_POS                  _ADC_UL(4)
#define ADC3_INTR_SISR4_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR5 (w) */
#define ADC3_INTR_SISR5_POS                  _ADC_UL(5)
#define ADC3_INTR_SISR5_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR6 (w) */
#define ADC3_INTR_SISR6_POS                  _ADC_UL(6)
#define ADC3_INTR_SISR6_LEN                  _ADC_UL(1)

/* ADC3_INTR_SISR7 (w) */
#define ADC3_INTR_SISR7_POS                  _ADC_UL(7)
#define ADC3_INTR_SISR7_LEN                  _ADC_UL(1)

/* ADC3_RNPR0_RENP0 (rw) */
#define ADC3_RNPR0_RENP0_POS                 _ADC_UL(0)
#define ADC3_RNPR0_RENP0_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP1 (rw) */
#define ADC3_RNPR0_RENP1_POS                 _ADC_UL(4)
#define ADC3_RNPR0_RENP1_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP2 (rw) */
#define ADC3_RNPR0_RENP2_POS                 _ADC_UL(8)
#define ADC3_RNPR0_RENP2_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP3 (rw) */
#define ADC3_RNPR0_RENP3_POS                 _ADC_UL(12)
#define ADC3_RNPR0_RENP3_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP4 (rw) */
#define ADC3_RNPR0_RENP4_POS                 _ADC_UL(16)
#define ADC3_RNPR0_RENP4_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP5 (rw) */
#define ADC3_RNPR0_RENP5_POS                 _ADC_UL(20)
#define ADC3_RNPR0_RENP5_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP6 (rw) */
#define ADC3_RNPR0_RENP6_POS                 _ADC_UL(24)
#define ADC3_RNPR0_RENP6_LEN                 _ADC_UL(3)

/* ADC3_RNPR0_RENP7 (rw) */
#define ADC3_RNPR0_RENP7_POS                 _ADC_UL(28)
#define ADC3_RNPR0_RENP7_LEN                 _ADC_UL(3)

/* ADC3_RNPR8_RENP8 (rw) */
#define ADC3_RNPR8_RENP8_POS                 _ADC_UL(0)
#define ADC3_RNPR8_RENP8_LEN                 _ADC_UL(3)

/* ADC3_RNPR8_RENP9 (rw) */
#define ADC3_RNPR8_RENP9_POS                 _ADC_UL(4)
#define ADC3_RNPR8_RENP9_LEN                 _ADC_UL(3)

/* ADC3_RNPR8_RENP10 (rw) */
#define ADC3_RNPR8_RENP10_POS                _ADC_UL(8)
#define ADC3_RNPR8_RENP10_LEN                _ADC_UL(3)

/* ADC3_RNPR8_RENP11 (rw) */
#define ADC3_RNPR8_RENP11_POS                _ADC_UL(12)
#define ADC3_RNPR8_RENP11_LEN                _ADC_UL(3)

/* ADC3_RNPR8_RENP12 (rw) */
#define ADC3_RNPR8_RENP12_POS                _ADC_UL(16)
#define ADC3_RNPR8_RENP12_LEN                _ADC_UL(3)

/* ADC3_RNPR8_RENP13 (rw) */
#define ADC3_RNPR8_RENP13_POS                _ADC_UL(20)
#define ADC3_RNPR8_RENP13_LEN                _ADC_UL(3)

/* ADC3_RNPR8_RENP14 (rw) */
#define ADC3_RNPR8_RENP14_POS                _ADC_UL(24)
#define ADC3_RNPR8_RENP14_LEN                _ADC_UL(3)

/* ADC3_RNPR8_RENP15 (rw) */
#define ADC3_RNPR8_RENP15_POS                _ADC_UL(28)
#define ADC3_RNPR8_RENP15_LEN                _ADC_UL(3)

/* ADC3_ALR0_ALIAS0 (rw) */
#define ADC3_ALR0_ALIAS0_POS                 _ADC_UL(0)
#define ADC3_ALR0_ALIAS0_LEN                 _ADC_UL(4)

/* ADC3_ALR0_ALIAS1 (rw) */
#define ADC3_ALR0_ALIAS1_POS                 _ADC_UL(8)
#define ADC3_ALR0_ALIAS1_LEN                 _ADC_UL(4)

/* ADC3_APR_RG0 (rw) */
#define ADC3_APR_RG0_POS                     _ADC_UL(0)
#define ADC3_APR_RG0_LEN                     _ADC_UL(1)

/* ADC3_APR_RG1 (rw) */
#define ADC3_APR_RG1_POS                     _ADC_UL(1)
#define ADC3_APR_RG1_LEN                     _ADC_UL(1)

/* ADC3_APR_RG2 (rw) */
#define ADC3_APR_RG2_POS                     _ADC_UL(2)
#define ADC3_APR_RG2_LEN                     _ADC_UL(1)

/* ADC3_APR_RG3 (rw) */
#define ADC3_APR_RG3_POS                     _ADC_UL(3)
#define ADC3_APR_RG3_LEN                     _ADC_UL(1)

/* ADC3_APR_RG4 (rw) */
#define ADC3_APR_RG4_POS                     _ADC_UL(4)
#define ADC3_APR_RG4_LEN                     _ADC_UL(1)

/* ADC3_APR_RG5 (rw) */
#define ADC3_APR_RG5_POS                     _ADC_UL(5)
#define ADC3_APR_RG5_LEN                     _ADC_UL(1)

/* ADC3_APR_ACCERR (rwh) */
#define ADC3_APR_ACCERR_POS                  _ADC_UL(15)
#define ADC3_APR_ACCERR_LEN                  _ADC_UL(1)

/* ADC3_EMCTR_SETEMUX (rw) */
#define ADC3_EMCTR_SETEMUX_POS               _ADC_UL(0)
#define ADC3_EMCTR_SETEMUX_LEN               _ADC_UL(3)

/* ADC3_EMCTR_EMUX (rh) */
#define ADC3_EMCTR_EMUX_POS                  _ADC_UL(4)
#define ADC3_EMCTR_EMUX_LEN                  _ADC_UL(3)

/* ADC3_EMCTR_EMSAMPLE (rw) */
#define ADC3_EMCTR_EMSAMPLE_POS              _ADC_UL(8)
#define ADC3_EMCTR_EMSAMPLE_LEN              _ADC_UL(8)

/* ADC3_EMCTR_EMUXCHNR (rw) */
#define ADC3_EMCTR_EMUXCHNR_POS              _ADC_UL(16)
#define ADC3_EMCTR_EMUXCHNR_LEN              _ADC_UL(4)

/* ADC3_EMCTR_TROEN (rw) */
#define ADC3_EMCTR_TROEN_POS                 _ADC_UL(21)
#define ADC3_EMCTR_TROEN_LEN                 _ADC_UL(1)

/* ADC3_EMCTR_SCANEN (rw) */
#define ADC3_EMCTR_SCANEN_POS                _ADC_UL(22)
#define ADC3_EMCTR_SCANEN_LEN                _ADC_UL(1)

/* ADC3_EMCTR_EMUXEN (rw) */
#define ADC3_EMCTR_EMUXEN_POS                _ADC_UL(23)
#define ADC3_EMCTR_EMUXEN_LEN                _ADC_UL(1)

/* ADC3_BWDENR_EN0 (rw) */
#define ADC3_BWDENR_EN0_POS                  _ADC_UL(0)
#define ADC3_BWDENR_EN0_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN1 (rw) */
#define ADC3_BWDENR_EN1_POS                  _ADC_UL(1)
#define ADC3_BWDENR_EN1_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN2 (rw) */
#define ADC3_BWDENR_EN2_POS                  _ADC_UL(2)
#define ADC3_BWDENR_EN2_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN3 (rw) */
#define ADC3_BWDENR_EN3_POS                  _ADC_UL(3)
#define ADC3_BWDENR_EN3_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN4 (rw) */
#define ADC3_BWDENR_EN4_POS                  _ADC_UL(4)
#define ADC3_BWDENR_EN4_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN5 (rw) */
#define ADC3_BWDENR_EN5_POS                  _ADC_UL(5)
#define ADC3_BWDENR_EN5_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN6 (rw) */
#define ADC3_BWDENR_EN6_POS                  _ADC_UL(6)
#define ADC3_BWDENR_EN6_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN7 (rw) */
#define ADC3_BWDENR_EN7_POS                  _ADC_UL(7)
#define ADC3_BWDENR_EN7_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN8 (rw) */
#define ADC3_BWDENR_EN8_POS                  _ADC_UL(8)
#define ADC3_BWDENR_EN8_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN9 (rw) */
#define ADC3_BWDENR_EN9_POS                  _ADC_UL(9)
#define ADC3_BWDENR_EN9_LEN                  _ADC_UL(1)

/* ADC3_BWDENR_EN10 (rw) */
#define ADC3_BWDENR_EN10_POS                 _ADC_UL(10)
#define ADC3_BWDENR_EN10_LEN                 _ADC_UL(1)

/* ADC3_BWDENR_EN11 (rw) */
#define ADC3_BWDENR_EN11_POS                 _ADC_UL(11)
#define ADC3_BWDENR_EN11_LEN                 _ADC_UL(1)

/* ADC3_BWDENR_EN12 (rw) */
#define ADC3_BWDENR_EN12_POS                 _ADC_UL(12)
#define ADC3_BWDENR_EN12_LEN                 _ADC_UL(1)

/* ADC3_BWDENR_EN13 (rw) */
#define ADC3_BWDENR_EN13_POS                 _ADC_UL(13)
#define ADC3_BWDENR_EN13_LEN                 _ADC_UL(1)

/* ADC3_BWDENR_EN14 (rw) */
#define ADC3_BWDENR_EN14_POS                 _ADC_UL(14)
#define ADC3_BWDENR_EN14_LEN                 _ADC_UL(1)

/* ADC3_BWDENR_EN15 (rw) */
#define ADC3_BWDENR_EN15_POS                 _ADC_UL(15)
#define ADC3_BWDENR_EN15_LEN                 _ADC_UL(1)

/* ADC3_BWDCFGR_CHP (rw) */
#define ADC3_BWDCFGR_CHP_POS                 _ADC_UL(0)
#define ADC3_BWDCFGR_CHP_LEN                 _ADC_UL(5)
