 ...
 ***************************************************************************************************
 * \moduledescription
 *              Register definitions for peripheral module CBS on Metis
 *
 * \scope           [API]
 ***************************************************************************************************
*/
...
typedef struct {
    ...
    volatile uint32 MCDBBS;              // [0xF0000470] : Cerberus Break Bus Switch Configuration Register
...
/* CBS_OSTATE_EECEN (rh) */
#define CBS_OSTATE_EECEN_POS           _CBS_UL(6)
#define CBS_OSTATE_EECEN_LEN           _CBS_UL(1)
